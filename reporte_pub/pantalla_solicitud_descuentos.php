...
<div class="container">
    <div class="alert alert-info" role="alert">
        <h4 class="block">Solicitud de Descuentos</h4>
            ...
            <div class="col-sm-8">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td class="col-xs-3">Descuento</td>
                    </tr>
                    <tr>
                        ...
                        <td><select class="form-control" id="mes">
                        ...
                        <td><select class="form-control" id="ano">
...
$(document).ready(function() { 
    $("#imprimir").on("click", function(){
        ...
        ano=$("#ano").val();
        id=$("#id").val();
        tipo=$("#id_descuento_tipo").val();
        //alert(quincena+" "+mes+" "+ano+" "+id+" "+tipo);
        if(quincena=="")
            alert("Selecciones la quincena");
        else
        {
            window.open("../nomina/tcpdf/reportes/reporte_solicitud_descuentos.php?id="+id+"&quincena="+quincena+"&mes="+mes+"&ano="+ano+"&tipo="+tipo);
