...
// editar cargamos de mov_contraloria
    ...
    $detalle = $conn->fetchAssoc('SELECT * FROM mov_ajuste_planilla WHERE id_mov_contraloria = ?', array($id));
...
if ( !empty($_POST['guardar']) ){
    ...
    if ($action == 'add') {
        $conn->insert('mov_ajuste_planilla', $data2);
    } else {
        unset($data2['id_mov_contraloria']);
        $conn->update('mov_ajuste_planilla', $data2,  array('id_mov_contraloria' => $id));
    }
?>
<script>
            ...
            <div class="col-sm-12"><br>
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                        <input name="suesal" value="<?= $persona['suesal'] ?>" type="text" class="form-control"></td>
                        <td>
        ...
        <div class="form-group">
            <div class="col-sm-12"><br>
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>
                        <input name="operacion" id="operacion" value="<?= $ajuste['operacion'] ?>" type="text" class="form-control"></td>
                        <td>
                        <input name="tib" id="tib" value="<?= $ajuste['tib'] ?>" type="text" class="form-control"></td>
                        <td>
