...
<div class="container">
    <div class="alert alert-info" role="alert">
        <h4 class="block">Cambio o Modificación de Cédula</h4>
            ...
            <div class="col-sm-4">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="numero" name="numero" placeholder="0" required></td>
                    </tr>
                </table>
            </div>
        </div>
...
$(document).ready(function() { 
    $("#imprimir").on("click", function(){
        ...
        {
        window.open("../nomina/tcpdf/reportes/reporte_cambios_cedula.php?id="+id+"&quincena="+quincena+"&mes="+mes+"&ano="+ano+"&numero="+numero);
