...
// combo Cargo segun planilla
$cargos = array();
$car = $conn->fetchAll('SELECT cod_cargo, des_car FROM nomcargos ORDER BY des_car');
foreach ($car as $value){
    $cargos[$value['cod_cargo']] = $value['des_car'];
}
...
<div class="container" style="margin-top: 50px;">
    ...
    <form name="form1" method="post" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                <?= dropdown('nomposicion_id',$posiciones,$persona['nomposicion_id'], 'class="form-control"') ?>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-1">
                <input name="dias_pagar" value="<?= $persona['dias_pagar'] ?>" type="text" class="form-control">
            </div>
            <div class="col-sm-4">
                <table class="table table-bordered">
                    <tr>
            ...
            <div class="col-sm-5">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td class="col-xs-4"><input name="c001" value="<?= $persona['suesal'] ?>" type="text" class="form-control"></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>002</td>
            ...
            <div class="col-sm-5">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><?= dropdown('des_car_combo',$cargos,$persona['codcargo'], 'class="form-control" id="des_car_combo"') ?></td>
                    </tr>
                    <tr>
