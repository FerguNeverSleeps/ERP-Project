...
// echo "cedula_rhexpress " . $_SESSION['cedula_rhexpress'] . "<br>";
// exit;
...
if ($esjefe) {
    if ($jefes['IdJefe'] == $cedula) {
        ...
        $sql = "SELECT * 
                ...
                WHERE se.id_solicitudes_estatus = 1 AND dep.IdDepartamento IN ($valores_departamentos)
                ORDER BY sc.id_solicitudes_casos  DESC";
        //}       
    }
    else if ($jefes['uid_subjefe'] == $cedula) {
        // "es director";
        $sql = "SELECT * 
                FROM solicitudes_casos as sc 
                ...
                WHERE se.id_solicitudes_estatus = 1
                ORDER BY sc.id_solicitudes_casos  DESC";
    }
...
LEFT JOIN nompersonal as np on (sc.cedula = np.cedula)
LEFT JOIN departamento as dep on (dep.IdDepartamento = np.IdDepartamento)
WHERE se.id_solicitudes_estatus = 1 AND np.cedula = '{$cedula}'
ORDER BY sc.id_solicitudes_casos DESC";
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-blue bold uppercase">CASOS PENDIENTES</span>
                </div>
                <!-- <div class="actions">
            ...
            <div class="portlet-body">
                <div class="table-scrollable">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        $fecha_reg  = date('d-m-Y', strtotime($fila['fecha_registro'])) ; // resta 6 mes
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <?php
                                if ($esjefe) {
                                ?><td><a href="<?= $url ?>?id=<?= $fila['id_solicitudes_casos'] ?>"><i class="fa fa-edit" aria-hidden="true"></i></a></td><?php
                                }
                                else{
                                ?><td>&nbsp;</td><?php
                                }
