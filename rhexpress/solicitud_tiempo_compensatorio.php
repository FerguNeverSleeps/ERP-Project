...
if ($con == 1)
{
	...
	VALUES ('','".$_SESSION['cedula_rhexpress']."','3','".$persona['IdDepartamento']."',NOW(),'{$fecha_ini}','{$fecha_fini}','{$observacion}','1','{$tiempo_solicitado}','{$dias}','{$horas}','{$minutos}');";
	//echo $insertar,"<br>";
	...
	if ($insertado) 
  	{
    	//echo "<script>alert('SOLICITUD APROBADA');</script>";
     	echo "<script>alert('SOLICITUD DE TIEMPO COMPENSATORIO GUARDADA EXITOSAMENTE');location.href='rhexpress_bandeja_entrada.php';</script>";
 	}
  	else
  	{
					...
					<div class="portlet box blue">
			            ...
			            <div class="portlet-body">
							<div class="row">
								<div class="form-group">
									<label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
									col-md-3 col-lg-offset-2 col-lg-3 control-label">Días:</label>
									<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
										<input name="dias_disponibles" class="form-control input-circle" type="text" id="dias_disponibles" value="<?= $dias; ?>" disabled><p></p>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
										<input name="horas_disponibles" class="form-control input-circle" type="text" id="horas_disponibles" value="<?= $horas; ?>" disabled><p></p>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
										<input name="minutos_disponibles" class="form-control input-circle" type="text" id="minutos_disponibles" value="<?= $minutos; ?>" disabled><p></p>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="portlet-body">
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
										<input name="tiempo_solicitado" class="form-control input-circle" type="text" id="tiempo_solicitado"><p></p>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="portlet-body">
							<div class="row">
								<div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group date form_datetime2 bs-datetime">
                                            <input id="fecha_inicio" name="fecha_inicio" type="text" size="16" class="form-control input-circle-left">
                            ...
                            <div class="row">
								<div class="form-group">
                                    <label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
									col-md-3 col-lg-offset-2 col-lg-3 control-label">El tiempo se hará efectivo hasta el:</label>
                                    <div class="col-md-3">
                                        <div class="input-group date form_datetime2">
                                            <input id="fecha_fin" name="fecha_fin" type="text" size="16" class="form-control input-circle-left">
                                            <span class="input-group-btn">
                                            	<button class="btn default date-reset" type="button">
                                                    <i class="fa fa-times"></i>
                                                </button>
