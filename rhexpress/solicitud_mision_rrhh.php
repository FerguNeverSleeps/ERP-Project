...
if ($con == 1)
{
	...
	$fecha_registro        = date('Y-m-d', strtotime($fecha_aprobacion_rrhh)) ; // resta 6 mes
	...
	if ($aprobado == 1) 
	{
		...
		$tiempo_nuevo = (($dias * $horas_dia) + $hora + ($minutos / 60));
		...
		VALUES ('{$cedula}', '{$observacion_rrhh}', '{$fecha_aprobacion_rrhh}', '$cedula', '$hora','{$dias}', '$minutos','12', '39')";
		$conexion->query($qexp);
		//echo $qexp;
	}
	else
						...
						<div class="portlet-body">
							<div class="row">
								<div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input id="fecha_registro" name="fecha_registro" type="text" size="16" class="form-control input-circle" value="<?php  echo $caso['fecha_registro']; ?>" readonly>
						...
						<div class="portlet-body">
							<div class="row">
								<div class="form-group">
									...
									col-md-3 col-lg-offset-2 col-lg-3 control-label">Fecha:</label>
                                    <div class="col-md-3">
                                        <input id="fecha_aprobado_jefe" name="fecha_aprobado_jefe" type="text" size="16" class="form-control input-circle" value="<?php  echo $caso['fecha_aprobado_jefe']; ?>" readonly>
							...
							<div class="row">
								<div class="form-group">
									...
									col-md-3 col-lg-offset-2 col-lg-3 control-label">Observaciones</label>
									<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
										<textarea cols="5" rows="5" name="observacion_jefe"  class="form-control" type="text" id="observacion_jefe" value="<?php ?>" disabled><?php echo $caso['observacion_jefe']; ?></textarea>
									</div>
								</div>
							</div>
						</div>
                            ...
                            <div class="row">
								...
								<div class="col-md-3">
									<div class="input-group date date-picker">
										<input type="text" class="form-control input-circle-left" name="fecha_aprobacion_rrhh" id="fecha_aprobacion_rrhh" readonly="" value="<?= date('d-m-Y'); ?>">
