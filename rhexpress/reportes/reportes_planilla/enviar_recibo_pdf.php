...
try{
	...
	$sql2 = "select distinct(a.ficha),b.cedula,b.apenom,b.email from nom_movimientos_nomina a 
	left join nompersonal b on a.ficha=b.ficha where a.codnom = '$codnom' and a.tipnom='$codtip' order by a.ficha asc";
	...
	while($empleados=fetch_array($res2)){
		...
		if($email!='')
		{
			...
			$mail->From = "planillaamx@gmail.com";
				...
				<div class="portlet box blue">
					<div class="portlet-title">
						...
						<div class="pull-right">
							<a class="btn btn-primary" href="../../nominas/paginas/config_rpt_nomina_horizontal_modelo6.php?action=6">
