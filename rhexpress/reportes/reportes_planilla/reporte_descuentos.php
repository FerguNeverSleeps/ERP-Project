...
if(isset($_GET['codnom']) && isset($_GET['codtip']))
{
    ...
    {    
        ...
        {    
            ...
            $where = "a.codnom = '$codnom' and a.codcon='$codcon' and b.codnivel1='$codNivel1'";
