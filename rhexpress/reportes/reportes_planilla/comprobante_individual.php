<?php
//echo "estoy en comprobante";exit;
if (!isset($_SESSION)) {
  session_start();
}
...
class PDF extends FPDF
{
	...
	function datos($codnom,$codtip,$ficha,$boleta){
		...
		echo $consulta3="SELECT a.id,a.codnom,a.tipnom,a.ficha,b.apenom,b.cedula,c.codorg,c.descrip,a.valor,d.ccosto,a.numpre,e.nom_tipos_prestamos tipo,
...
// $sql2 = "select distinct(ficha) from nom_movimientos_nomina where codnom = '$codnom' and 
// tipnom='$codtip' and ficha= '$ficha_individual' order by ficha asc";
// $res2=query($sql2,$conexion);
// $boleta_pag = $boleta = 1;

$pdf->datos($codnom,$codtip,$ficha_individual,$boleta);
