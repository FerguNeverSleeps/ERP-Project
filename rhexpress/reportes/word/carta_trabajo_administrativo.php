...
if(isset($_GET['ficha_rhexpress']))
{
	...
	$sql = "SELECT  *                   
			FROM   nomempresa";
    $res_empresa         = $conexion->query($sql);
	$sql = "SELECT n.nombres, n.apellidos, n.cedula,n.seguro_social, c.des_car as cargo,
				   ...
				   n.suesal, n.hora_base, n.inicio_periodo, n.fin_periodo, n.seguro_social
			FROM   nompersonal n
	...
	$res_campo_adicional = $conexion->query($sql_campo_adicional);
    ...
    $templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor('plantillas/carta_trabajo_administrativo.docx');
	...
	$templateProcessor->setValue('fecing',            htmlspecialchars($fin_periodo));
