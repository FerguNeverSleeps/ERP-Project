...
$templateProcessor           = new \PhpOffice\PhpWord\TemplateProcessor('plantillas/tiempo_extraordinario.docx');
...
$templateProcessor->setValue('fechasolicitud', htmlspecialchars($fechasolicitud));
$templateProcessor->setValue('fechahoy', htmlspecialchars($fecha_hoy));
...
$templateProcessor->setValue('presidente', htmlspecialchars($director));
...
$filename = 'Solicitud Horas Extraordinarias '.$idcarajo.'.docx';
