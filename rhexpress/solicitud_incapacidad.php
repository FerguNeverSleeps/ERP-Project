...
WHERE cedula = '{$cedula}' AND tipo_justificacion = 6";
...
if ($con == 1)
{
	...
	VALUES ('','".$_SESSION['cedula_rhexpress']."','2','".$persona['IdDepartamento']."','{$fecha_registro}','{$fecha_ini}','{$fecha_fini}','{$observacion}','1','{$tiempo_solicitado}','{$dias}','{$horas}','{$minutos}');";
	//echo $insertar,"<br>";
