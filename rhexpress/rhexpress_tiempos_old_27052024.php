...
$sql2 = "SELECT fecha,tiempo,observacion,dias,horas,minutos FROM dias_incapacidad WHERE cedula='$cedula' AND tipo_justificacion= 7";
                                ...
                                <div class="portlet-body">
                                    <div class="table-container">
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                            ...
                                            <tbody>
                                                <?php if ($fila=mysqli_fetch_array($res2)): ?>
                                                    <tr>
