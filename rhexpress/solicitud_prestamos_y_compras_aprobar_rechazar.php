...
/////////////////////////////////////////////////////////////
$sql_datos="SELECT val.solicitudes_campos_id,cas.fecha_registro,cam.nombre,val.valores,cam.orden FROM solicitudes_valores as val
    ...
    WHERE solicitudes_casos_id='$id' ORDER by cam.orden ASC ";
...
////////////////////////////////////////////////////////////
$sql="SELECT id_tipo_solicitud FROM solicitudes_casos WHERE id_solicitudes_casos='$id'";
...
if ($con == 1)
{
	...
	$cod_departamento			   =(isset($_REQUEST['centro_costo'])) ? $_REQUEST['centro_costo'] : '' ;	
	//$precio		   =(isset($_REQUEST['precio'])) ? $_REQUEST['precio'] : '' ;	
	$fecha_aprobacion  = (isset($_REQUEST['fecha_aprobacion'])) ? $_REQUEST['fecha_aprobacion'] : '' ;
	$monto  = (isset($_REQUEST['monto'])) ? $_REQUEST['monto'] : '' ;
	$cuota  = (isset($_REQUEST['cuota'])) ? $_REQUEST['cuota'] : '' ;
	$precio  = (isset($_REQUEST['precio'])) ? $_REQUEST['precio'] : '' ;
	$explicacion  = (isset($_REQUEST['explicacion'])) ? $_REQUEST['explicacion'] : '' ;
	...
	if ($aprobado == 1) 
	{
		...
		$update = "UPDATE solicitudes_casos
			...
			$qexp ="INSERT INTO expediente (ajuste_discrecional,cedula,monto,numero_resolucion_anterior,monto_nuevo,descripcion,concepto, fecha, usuario, horas,dias, minutos, tipo,subtipo,nivel_actual,registro)
			VALUES ('{$precio}','{$cedula}','{$monto}','{$tip}','{$cuota}','{$explicacion}', '{$observacion_jefe}', '{$fecha_aprobacion}', '$cedula', '$hora','{$dias}', '$minutos','83', '110','{$cod_departamento}','{$id}')";
			$conexion->query($qexp);
			...
			<div class="portlet box blue">
				...
				<div class="portlet-body">
					<div class="row">
						<div class="form-group">
							<label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
							col-md-3 col-lg-offset-2 col-lg-3 control-label">Monto del prestamo:</label>
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
								<input name="monto" class="form-control input-circle" type="text" id="monto" value="<?php echo $datos['0']; ?>" readonly><p></p>
							</div>
						</div>
					</div>
					<?php
					if ($datos['2']>0) { ?>
						<div class="row">
							<div class="form-group">
								<label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
								col-md-3 col-lg-offset-2 col-lg-3 control-label">Tipo de objeto:</label>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="" <?php echo $varr = ($datos['2'] == '1') ? 'checked' : 'checked'; ?> value="<?php echo $datos['2'];?>">
									<?php $objeto = ($datos['2']=='1') ? $objeto="Joyeria" :$objeto="Articulo" ?>
									<label class="form-check-label" for="inlineRadio1"><?php echo $objeto ?></label>
								</div>
							</div>
						</div>	
					<?php } 
					...
					<div class="row">
						<div class="form-group">
							<label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
							col-md-3 col-lg-offset-2 col-lg-3 control-label">Cuota al 25%:</label>
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
								<input name="cuota" class="form-control input-circle" type="text" id="cuota" value="<?php echo round($datos['1'],2); ?>" readonly><p></p>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group">
							<label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
							col-md-3 col-lg-offset-2 col-lg-3 control-label">Explicacion por el cual solicita el prestamo:</label>
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
								<input name="explicacion" class="form-control input-circle" type="text" id="explicacion" value="<?php echo $datos['3']; ?>" readonly><p></p>
							</div>
						</div>
					</div>
					...
					<!-- <div class="row">
						<div class="form-group">
							<label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
							col-md-3 col-lg-offset-2 col-lg-3 control-label">Saldo:</label>
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
								<input name="saldo" class="form-control input-circle" type="text" id="saldo" value="<?php  echo ($datos['0']); ?>" disabled><p></p>
							</div>
						</div>
					</div> -->
				</div>
            ...
            <div class="portlet box blue">
				...
				<div class="portlet-body">
					<!-- <div class="row">
						<div class="form-group">
							<label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
							col-md-3 col-lg-offset-2 col-lg-3 control-label">Precio de venta al publico:</label>
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
								<input name="dias_solicitados" class="form-control input-circle" type="text" id="dias_solicitados" value="<?php echo $datos['9']; ?>" disabled><p></p>
							</div>
						</div>
					</div> -->
					...
					<div class="row">
						<div class="form-group">
							<label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
							col-md-3 col-lg-offset-2 col-lg-3 control-label">Descuento de articulos 20%:</label>
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
								<input name="horas_solicitadas" class="form-control input-circle" type="text" id="horas_solicitadas" value="<?php echo $datos['6']; ?>" readonly><p></p>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group">
							<label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
							col-md-3 col-lg-offset-2 col-lg-3 control-label">Descuento de joyeria 10%:</label>
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
								<input name="minutos_solicitados" class="form-control input-circle" type="text" id="minutos_solicitados" value="<?php echo $datos['8']; ?>" readonly><p></p>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group">
							<label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
							col-md-3 col-lg-offset-2 col-lg-3 control-label">Precio de venta al colaborardor (mas de 7% ITBMS):</label>
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
								<input name="precio" class="form-control input-circle" type="text" id="saldo" value="<?php  echo ($datos['10']); ?>" readonly><p></p>
							</div>
						</div>
					</div>
                    <div class="row">
						<div class="form-group">
							<label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
							col-md-3 col-lg-offset-2 col-lg-3 control-label">Referencia del articulo a comprar:</label>
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
								<input name="referencia" class="form-control input-circle" type="text" id="saldo" value="<?php  echo ($datos['9']); ?>" readonly><p></p>
							</div>
						</div>
					</div>
                    <div class="row">
						<div class="form-group">
							<label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
							col-md-3 col-lg-offset-2 col-lg-3 control-label">Marca:</label>
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
								<input name="saldo" class="form-control input-circle" type="text" id="saldo" value="<?php  echo ($datos['12']); ?>" readonly><p></p>
							</div>
						</div>
					</div>
                    <div class="row">
						<div class="form-group">
							<label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
							col-md-3 col-lg-offset-2 col-lg-3 control-label">Modelo:</label>
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
								<input name="saldo" class="form-control input-circle" type="text" id="saldo" value="<?php  echo ($datos['11']); ?>" readonly><p></p>
							</div>
						</div>
					</div>
                    <div class="row">
						<div class="form-group">
							<label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
							col-md-3 col-lg-offset-2 col-lg-3 control-label">Peso:</label>
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
								<input name="saldo" class="form-control input-circle" type="text" id="saldo" value="<?php  echo ($datos['13']); ?>" readonly><p></p>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="form-group">
							<label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
							col-md-3 col-lg-offset-2 col-lg-3 control-label">Serie:</label>
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
								<input name="saldo" class="form-control input-circle" type="text" id="saldo" value="<?php  echo ($datos['15']); ?>" readonly><p></p>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="form-group">
							<label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
							col-md-3 col-lg-offset-2 col-lg-3 control-label">Kilates:</label>
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
								<input name="saldo" class="form-control input-circle" type="text" id="saldo" value="<?php  echo ($datos['14']); ?>" readonly><p></p>
							</div>
						</div>
					</div>
                    <div class="row">
						<div class="form-group">
							<label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
							col-md-3 col-lg-offset-2 col-lg-3 control-label">Descripcion de la mercancia:</label>
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
								<input name="saldo" class="form-control input-circle" type="text" id="saldo" value="<?php  echo ($datos['5']); ?>" readonly><p></p>
							</div>
						</div>
					</div>
                    <!-- <div class="row">
						<div class="form-group">
							<label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
							col-md-3 col-lg-offset-2 col-lg-3 control-label">Tipo mercancia:</label>
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
				...
				<!-- <input name="btn_guardar" type="Hidden" id="op_tp" value="<?= $btn_guardar; ?>">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<input type="hidden" name="centro_costo" value="<?php echo $nivel1['numero_departamento']; ?>">
							<input type="hidden" name="tipo_compra_prestamo" value="<?php echo $tip; ?>">
						</div>
					</div>
					<!-- FIN USO TIEMPO -->
					<br>
