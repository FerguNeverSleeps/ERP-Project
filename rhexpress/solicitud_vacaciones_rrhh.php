...
if ($con == 1)
{
	...
	if ($aprobado == 1) 
	{
		...
		VALUES ('".$persona['nomposicion_id']."', '7', '{$fecha_aprobacion_rrhh}', '{$tiempo_nuevo}', '{$dias}',  '{$hora}','{$minutos}', '{$dias}',  '{$hora}','{$minutos}', '{$observacion_rrhh}','{$cedula}')";
		//echo $q,"<br>";
		$conexion->query($q);
		...
		VALUES ('{$cedula}', '{$observacion_rrhh}', '{$fecha_aprobacion_rrhh}', '$cedula', '$hora','{$dias}', '$minutos','11', '115')";
		$conexion->query($qexp);
		//echo $qexp;
	}
	else
						...
						<div class="portlet-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                	...
                                	<input id="aprobado" name="aprobado"  class="form-control input-circle" value="<?php echo ($caso['aprobado']==1) ? "SI" : "NO" ;?>" readonly>                                   	
                                    <p></p>
                                </div>      
                            </div>
