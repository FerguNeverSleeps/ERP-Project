...
echo '<link href="https://cdn.datatables.net/2.0.8/css/dataTables.dataTables.min.css">';
echo '<script src="https://cdn.datatables.net/2.0.8/js/dataTables.min.js"></script>';
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                <div class="table-scrollable">
                    <table class="table table-hover" id="vacaciones_acumuladas">
                        <thead>
                            <tr>
...
<script>
    $(document).ready(function() {
        $('#vacaciones_acumuladas').DataTable();
    });
</script>
