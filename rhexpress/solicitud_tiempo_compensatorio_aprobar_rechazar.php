...
if ($con == 1)
{
	...
	if ($aprobacion) 
	{
		...
		if ($aprobado) 
		{
			$asunto="SOLICITUD Nº: ".$id." APROBADA POR JEFE INMEDIATO";
		}
		else
		{
			$asunto="SOLICITUD Nº: ".$id." RECHAZADA POR JEFE INMEDIATO";
		}
								...
								<div class="form-group">
									...
									<div class="col-md-3">
										<div class="input-group date date-picker">
			                                <input name="fecha_aprobacion" id="fecha_aprobacion" type="text" class="form-control input-circle-left" readonly="" value="<?= date('d-m-Y') ?>">
