                    ...
                    <div class="page-title">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input name="fecha_nacimiento" value="<?= $fecha_nacimiento ?>" type="text" class="form-control" readonly>
                                </td>
                                <td>
                                    <input name="edad" id="edad" value="<?= $edad ?>" type="text" class="form-control" readonly>
                                </td>
                                <td>
                                    <input name="lugar_nacimiento" value="<?= $colaborador->lugarnac ?>" type="text" class="form-control" readonly>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input name="salario" value="<?= $colaborador->sueldopro ?>" type="text" class="form-control" readonly>
                                </td>
                                <td>
                                    <input name="direccion" value="<?= $colaborador->direccion ?>" type="text" class="form-control" readonly>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <input name="telefonos" value="<?= $colaborador->telefonos ?>" type="text" class="form-control" readonly>
                                </td>
                                <td>
                                    <input name="email" value="<?= $colaborador->email ?>" type="text" class="form-control" readonly>
                                </td>
                                <td>
                                    <input name="estado" value="<?= $colaborador->estado ?>" type="text" class="form-control" readonly>
                                </td>
                                <td>
                                    <input name="banco_colaborador" value="<?= $banco_colaborador ?>" type="text" class="form-control" readonly>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <input name="cuentacob" value="<?= $colaborador->cuentacob ?>" type="text" class="form-control" readonly>
                                </td>
                                <td>
                                    <input name="seguro_social" value="<?= $colaborador->seguro_social ?>" type="text" class="form-control" readonly>
                                </td>
                                <td>
                                    <input name="segurosocial_sipe" value="<?= $colaborador->segurosocial_sipe ?>" type="text" class="form-control" readonly>
                                </td>
                                <td>
