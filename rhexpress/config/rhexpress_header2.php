...
<body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-md">
    ...
    <div class="page-header navbar navbar-fixed-top">
        ...
        <div class="page-header-inner ">
            ...
            <div class="page-logo">
                <a href="index.html">
                    <img src="logo_cliente.jpg" alt="logo" class="logo-default" height="50" width="130" /> </a>
                ...
                <ul class="page-sidebar-menu   " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li class="nav-item">
                                <a href="rhexpress_ausencia_colaborador.php" class="nav-link ">
                                    <span class="title">Ausencias</span>
                                </a>
                            </li>
                            <!-- <li class="nav-item">
