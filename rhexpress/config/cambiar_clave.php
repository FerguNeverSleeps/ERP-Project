...
session_start();
//-------------------------------------------------
require_once "rhexpress_config.php";
...
require_once "../../nomina/header.php";
...
if (isset($_POST['nueva'] )){
    ...
    $result="SELECT * FROM nompersonal WHERE usuario_workflow='".$_SESSION['cedula_rhexpress']."' AND  usr_password='".hash('md5', $_POST['actual'])."' "; 
    
    $res1 = $conexion->query($result);
    ...
    if($fila['ficha'] == ""){
      ...
      $sql="UPDATE nompersonal SET usr_password='".hash('md5', $_POST['nueva'])."' WHERE usuario_workflow='".$_SESSION['cedula_rhexpress']."'";
			$cambio_clave=$conexion->query($sql);      
      $invalido = 0;
    }    
}
?>
...
<link href="../../includes/assets/css/themes/green.css" rel="stylesheet" type="text/css" id="style_color"/>
        ...
        <div class="col-md-6 ">
          ...
          <div class="portlet box green">
            <div class="portlet-body form">
              <form role="form" name="Editar"  action=<?php echo ($_SERVER["PHP_SELF"]); ?> method="post" onsubmit="return validar();">
                <div class="form-body">
                  <div class="form-group">
                    <label for="exampleInputPassword1">Clave Actual</label>
                    <div class="input-group">
                      <input type="password" class="form-control" name="actual" id="actual" placeholder="Password">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="password" class="form-control" name="nueva" id="nueva" placeholder="Password">
                      <span class="input-group-addon">
                        <i class="fa fa-user"></i>
                      </span>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="password" class="form-control" name="confirmar" id="confirmar" placeholder="Password">
                      <span class="input-group-addon">
                        <i class="fa fa-user"></i>
                      </span>
                    </div>
                ...
                <div class="form-actions">
                  <input name="Modificar" type="submit" id="Modificar" value='Modificar' type="submit" class="btn blue">
                </div>
              </form>
            </div>
          </div>
