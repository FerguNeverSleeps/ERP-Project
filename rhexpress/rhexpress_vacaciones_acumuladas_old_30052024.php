                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="<?php echo '../nomina/tcpdf/reportes/resumido_vacaciones.php?anio=' . $anio . '&ficha=' . $colaborador->ficha . '&cedula=' . $colaborador->cedula; ?>" title="Imprimir" target="_blank"><img src="../../includes/imagenes/icons/report.png" alt="Imprimir" width="16" height="16"></a><?php } ?>
                                    </td>
                                </tr>
                                <?php
