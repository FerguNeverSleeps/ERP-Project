...
$consulta_sql = "SELECT solicitudes_casos.*,nompersonal.*, departamento.*,nomnivel2.descrip as dpto_rhexpress
FROM solicitudes_casos 
LEFT JOIN nompersonal on (solicitudes_casos.cedula = nompersonal.cedula)
LEFT JOIN departamento  ON departamento.IdDepartamento = nompersonal.IdDepartamento
LEFT JOIN nomnivel1 ON nompersonal.codnivel1 = nomnivel1.codorg
LEFT JOIN nomnivel2 ON nompersonal.codnivel2 = nomnivel2.codorg
...
if ($con == 1)
{
	...
	$fecha_aprobacion_rrhh = (isset($_REQUEST['fecha_aprobacion_rrhh'])) ? $_REQUEST['fecha_aprobacion_rrhh'] : '' ;
	$aprobado              = (isset($caso['aprobado'])) ? $caso['aprobado'] : '' ;
	$observacion_rrhh      = (isset($_REQUEST['observacion_rrhh'])) ? $_REQUEST['observacion_rrhh'] : '' ;
	$fecha_aprobacion_rrhh = date('Y-m-d', strtotime($fecha_aprobacion_rrhh)) ; // resta 6 mes
	if ($aprobado == 1) 
	{
		$update = "UPDATE solicitudes_casos
		SET fecha_rrhh              = '{$fecha_aprobacion_rrhh}', 
		observacion_rrhh            = '{$observacion_rrhh}',
		id_solicitudes_casos_status = '4' 
		...
		VALUES ('".$persona['nomposicion_id']."', '3', '{$fecha_aprobacion_rrhh}', '{$tiempo_nuevo}', '{$dias}',  '{$hora}','{$minutos}', '{$dias}',  '{$hora}','{$minutos}', '{$observacion_rrhh}','{$cedula}')";
		//echo $q,"<br>";
		$conexion->query($q);
		$aprobacion = $conexion->query($update);

		$qexp ="INSERT INTO expediente (cedula, descripcion, fecha, usuario, horas,dias, minutos, tipo,subtipo)
		VALUES ('{$cedula}', '{$observacion_rrhh}', '{$fecha_aprobacion_rrhh}', '$cedula', '$hora','{$dias}', '$minutos','12', '38')";
		$conexion->query($qexp);
		//echo $qexp;
	}
	else
	...
	if ($aprobado) 
	{
		...
		if ($aprobado) 
		{
			$asunto="SOLICITUD Nº: ".$id." TRAMITADA POR RRHH";
		}
		else
		{
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet light bordered">
	            ...
	            <div class="portlet-body">
					...
					<div class="row">
						<div class="form-group">
							...
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
								<input name="unidad_administrativa"  class="form-control input-circle" type="text" id="unidad_administrativa" value="<?= $caso['dpto_rhexpress'] ?>" disabled><p></p>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group">
							...
							<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
								...
								value="<?= $caso['Descripcion'] ?>" disabled><p></p>
							</div>
						</div>
					</div>
			...
			<form action="" method="post" name="tiempo_compensatorio" id="tiempo_compensatorio" role="form" >
				...
				<div class="form-body">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							<div class="row">
								<div class="form-group">
                                    <label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
									col-md-3 col-lg-offset-2 col-lg-3 control-label">Fecha de Solicitud:</label>
                                    <div class="col-md-3">
                                            <input id="fecha_inicio" name="fecha_inicio" type="text" size="16" class="form-control input-circle" value="<?= date('d-m-Y',strtotime($caso['fecha_registro'])) ?>" readonly>
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<H4>Registro en Expediente RRHH</H4>
						</div>
						<div class="portlet-body">
								...
								<div class="form-group">
									...
									<div class="col-md-3">
										<div class="input-group date date-picker">
			                                <input name="fecha_aprobacion_rrhh" id="fecha_aprobacion_rrhh" type="text" class="form-control input-circle-left" readonly="" value="<?= date('d-m-Y') ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                	...
                                	<input id="aprobado" name="aprobado"  class="form-control input-circle" value="<?php echo ($caso['aprobado']==1) ? "SI" : "NO" ;?>" disabled>                                   	
                                    <p></p>
                                </div>      
                            </div>
							...
							<div class="row">
								...
								col-md-3 col-lg-offset-2 col-lg-3 control-label">Observaciones</label>
								<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
									<textarea cols="5" rows="5" name="observacion_rrhh"  class="form-control" type="text" id="observacion_rrhh" value="<?php ?>" required></textarea>
								</div>
								</div>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
							<a class="btn btn-danger" href="ca_situaciones.php"> Salir</a>
						</div>
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
						</div>
					</div>
