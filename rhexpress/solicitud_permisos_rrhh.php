...
WHERE departamento.IdJefe = '".$caso['cedula']."'";
...
if ($con == 1)
{
	...
	if ($aprobado == 1) 
	{
		...
		VALUES ('{$cedula}', '{$observacion_rrhh}', '{$fecha_aprobacion_rrhh}', '$cedula', '$hora','{$dias}', '$minutos','4', '39')";
		$conexion->query($qexp);
		//echo $qexp;
	}
	else
						...
						<div class="portlet-body">
							<div class="row">
								<div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-control input-circle">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							<div class="row">
                                ...
                                <div class="col-md-3">
                                    <input name="fecha_aprobacion_rrhh"  class="form-control input-circle" id="fecha_aprobacion_rrhh" value="<?php echo $caso['fecha_registro']; ?>" ><p></p>
                                </div>
                            </div>
                            <div class="row">
                                <label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
