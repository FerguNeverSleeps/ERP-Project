...
$modulo = "Control de Asistencia (del $enca_fecha_ini al $enca_fecha_fin)";
$tabla = "reloj_detalle";
...
$consulta = "SELECT " . $tabla . ".*,nompersonal.apenom,reloj_info.cod_dispositivo, reloj_info.nombre, nomturnos.descripcion as turno"
                        . " FROM " . $tabla . " "
