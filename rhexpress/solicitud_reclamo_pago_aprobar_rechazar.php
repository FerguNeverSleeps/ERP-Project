...
// $empresa               = "select * from nomempresa";
// $resultempresa         = $conexion->query($empresa);
// $emp                 = mysqli_fetch_assoc($resultempresa);

// $correo_rrhh         = $emp['correo_rrhh'];
// $correo_planilla     = $emp['correo_planilla'];
// $correo_sistemas     = $emp['correo_sistemas1'];
...
$sql_datos="SELECT val.solicitudes_campos_id,cas.fecha_registro,cam.nombre,val.valores FROM solicitudes_valores as val
    ...
    WHERE solicitudes_casos_id='$id' ORDER by orden ASC ";
...
if ($con == 1)
{
	...
	$quincena_reclama			   =(isset($_REQUEST['quincena_reclama'])) ? $_REQUEST['quincena_reclama'] : '' ;	
	...
	if ($aprobado == 1) 
	{
			...
			$qexp ="INSERT INTO expediente (cedula, descripcion, fecha, concepto, numero_resolucion_anterior,dias, minutos, tipo,subtipo,monto,nivel_actual,registro)
			VALUES ('{$cedula}', '{$observacion_jefe}', '{$fecha_aprobacion}','{$quincena_reclama}', '{$tipo}','{$dias}', '$minutos','82', '110',$monto,$cod_departamento,$id)";
			$conexion->query($qexp);

			//enviando correo al colaborador de solicitd aprobada
			$email=$correo_colab;
			$email2=$correo_usuario2;
			$email3=$correo_usuario3;
			$email4=$correo_usuario4;
			$correo_adicional1=($correo_adicional1!="") ? $correo_adicional1 : '';
			$mail = new PHPMailer();
			$mail->SMTPAuth = true;
			$mail->isSMTP();
			$mail->SMTPDebug = 0;
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-blue bold uppercase">SOLICITUD RECLAMO DE PAGO</span>
                </div>
                <div class="actions">
	            ...
	            <div class="portlet-body">
					...
					<div class="row">
						<div class="form-group">
							...
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
								<input name="posicion"  class="form-control input-circle" type="text" id="posicion" value="<?php echo $nivel1['centro_costo']; ?>" disabled><p></p>
							</div>
						</div>
					</div>
			...
			<div class="portlet box blue">
				...
				<div class="portlet-body">
					<div class="row">
						<div class="form-group">
							<label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
							col-md-3 col-lg-offset-2 col-lg-3 control-label">Tipo:</label>
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
								<input name="tipo" class="form-control input-circle" type="text" id="dias_solicitados" value="<?php echo $datos['0']; ?>" readonly><p></p>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="form-group">
							<label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
							col-md-3 col-lg-offset-2 col-lg-3 control-label">Quincena que reclama:</label>
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
								<input name="quincena_reclama" class="form-control input-circle" type="text" id="dias_solicitados" value="<?php echo $datos['1']; ?>" readonly><p></p>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group">
							...
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
								<input name="monto" class="form-control input-circle" type="text" id="monto" value="<?php echo $datos['2']; ?>" readonly><p></p>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group">
							<label class="text-right col-xs-offset-2 col-xs-3 col-sm-offset-2 col-sm-3 col-md-offset-2
							col-md-3 col-lg-offset-2 col-lg-3 control-label">Comentario:</label>
							<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
								<input name="comentario" class="form-control input-circle" type="text" id="comentario" value="<?php echo $datos['3']; ?>" disabled><p></p>
							</div>
						</div>
					</div>
