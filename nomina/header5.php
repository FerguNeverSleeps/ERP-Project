...
<script  language="JavaScript" type="text/javascript" src="../../lib/JSClases.js?<?php echo time(); ?>"></script>
<script  language="JavaScript" type="text/javascript" src="../../lib/JSMetodos.js?<?php echo time(); ?>"></script>
