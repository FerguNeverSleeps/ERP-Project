...
class bd {
    ...
    public function query2($sentencia) {
        $conexion = $this->connect();
        $resultado = $conexion->query($sentencia);
        $conexion->close();
        return $resultado;
...
function paginacion($pagina, $consulta,$LIMITE = 15) {
...
function check($name, $est) {
    ?>
    <input type="checkbox" name="<?php echo $name ?>" value="1" <?php if ($est == "1")
        echo "checked" ?>>
    <?php
}
...
function titulo_mejorada($nombre, $icono, $lista, $regresar) {
    ...
    <table class="tb-tit" cellspacing="0" cellpadding="1" border="0" width="100%">
        <tbody>
            <tr class="row-br">
    <?php if ($icono != "") { ?>
                    <td width="25"><img src="../imagenes/<?php echo $icono ?>" width="22" height="22" class="icon"></td>
    <?php } ?>
                <td><?php echo $nombre ?></td>
    <?php foreach ($botones as $boton) {
        if($boton!="") {?>
                    <td width="75" align="center"><?php eval($boton); ?></td>
    <?php }
			} ?>
    <?php if ($regresar != "") { ?>
                    <td width="75" align="right"><?php btn('back', $regresar); ?></td>
    <?php } ?>
            </tr>
        </tbody>
    </table>
...
new Ajax.Updater(\'' . $div . 'list\', \'' . $file . '?id_ma=<?php echo $id ?>\', { parameters: \'id=\'+id } );
}
...
function query2($consulta, $conexion) {
...
function datos_de_orden($var_nomemp, $var_direccion, $var_fecha, $var_nom_und, $var_monto_orden, $var_codigo, $var_dias_credito) {
    ?>
    <tr><td>SeÃÂ±or(es): <?php echo $var_nomemp ?></td></tr>
    <tr><td>Direccion: <?php echo $var_direccion ?></td></tr> 
...
function materiales_detalles($descripcion, $cantidad, $var_precio, $var_iva, $var_total, $var_total_gen) {
    ...
    <td><?php echo $descripcion; ?>
        <div align="center"></div></td><td><?php echo $cantidad; ?>
    <td>
        <div align="center"></div></td>
    <td><?php echo $var_precio; ?>
        <div align="center"></div></td>
    <td><?php echo $var_iva; ?>
        <div align="center"></div></td>
    <td><?php echo $var_total; ?>
        <div align="center"></div></td>
...
function partidas_presupuestarias($var_sector, $var_programa, $var_actividad, $var_partida, $var_descripcion, $var_monto3) {
    ...
    <table width="749" border="1" align="center" cellpadding="2" cellspacing="2" class="">
        ...
        <td><?php echo $var_sector . "." . $var_programa . "." . $var_actividad; ?>
            <div align="center"></div></td>
        <td><?php echo $var_partida; ?>
        <td><?php echo $var_descripcion; ?>
            <div align="center"></div></td>
        <td><?php echo $var_monto3; ?>
            <div align="center"></div></td>
    </table>
...
function materiales_detalles2($var_cod_prod, $var_descripcion, $var_cantidad, $var_cantidad_des) {
    ...
    <td><?php echo $var_cod_prod; ?>
        <div align="center"></div></td>
    <td><?php echo $var_descripcion; ?>
        <div align="center"></div>
    <td><?php echo $var_cantidad ?>
        <div align="center"></div></td>
    <td><?php echo $var_cantidad_des; ?>
        <div align="center"></div></td>
...
<table class="tb-head" width="100%">
  <tr>
    ...
    <td><?php btn('show_all',$url.".php?".$parametros); ?></td>
