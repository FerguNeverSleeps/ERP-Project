...
class bd{
	...
	public function create_database($bdnueva){
		$conexion= new mysqli($this->servidor,$this->usuario,$this->clave,null,$this->puerto);
		if (mysqli_connect_errno()) {
 		   printf("Connect failed: %s\n", mysqli_connect_error());
		   return;
		}
...
//if($config[bd]=="mysql"){
	$host = DB_HOST;
  	...
  	$clave = DB_CLAVE; 
  	$puerto = DB_PUERTO;
	$conexion= mysqli_connect($host.":".$puerto, $usuario, $clave, $_SESSION['bd']);
	return $conexion;
//}else{
...
function conexion_publica() {
    ...
    if ($config[bd] == "mysql") {
        ...
        $clave = DB_CLAVE;
        $puerto = DB_PUERTO;
        $conexion = mysqli_connect($host.":".$puerto, $usuario, $clave, DB_SELECTRA_DEFAULT);
        return $conexion;
    } else {
        echo "No se ha implementado en postgres";
    }
...
//if($config[bd]=="mysql"){
	...
	$clave=DB_CLAVE;
	$puerto = DB_PUERTO;
	$conexion= mysqli_connect($host.":".$puerto,$usuario,$clave,DB_SELECTRA_CONF);
	return $conexion;
//}else{
	//echo "No se ha implementado en postgres";
//}
...
//if($config[bd]=="mysql"){
	...
	$clave=DB_CLAVE;
	$puerto=DB_PUERTO;
	$conexion= mysqli_connect($host.":".$puerto,$usuario,$clave,DB_SELECTRA_FAC);
	return $conexion;
//}else{
	//echo "No se ha implementado en postgres";
//}
...
$resultado=mysqli_query($consulta,$conexion) or die("No se puede realizar la consulta  ".mysqli_error($conexion));
	return $resultado;
//}else{
	//echo "No se ha implementado en postgres";
//}
