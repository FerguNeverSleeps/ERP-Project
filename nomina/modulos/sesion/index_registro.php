                    ...
                    <div class="portlet portlet-login">
                        <div class="portlet-title">
                            ...
                            <div class="caption" class="cuadro_imagen">
                                ...
                                <img src="<?php echo LOGO; ?>" alt="logo" class="img-responsive" style="height: auto; width: 95%;  margin: 5px auto;" />
                            <!--
                        ...
                        <div class="portlet-body form">
                            <span id="form_registro">

                            <form role="form" class="reg-form" action="#" method="post" id ="reg-form" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div id="mensaje_registro" class="alert alert-danger">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-icon">
                                            ...
                                            <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Usuario" name="txtUser" id="txtUser" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-icon">
                                            ...
                                            <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="txtPass" id="txtPass" class="required" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-icon">
                                            <i class="fa fa-lock"></i>
                                            <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Repita su Password" name="txtRepeat" id="txtRepeat" class="required" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-icon">
                                            ...
                                            <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Empresa" name="txtEmpresa" id="txtEmpresa" />
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <!-- <i class="fa fa-check"></i> -->
                                        <label class="control-label visible-ie8 visible-ie9">RUC</label>
                                        <div class="input-icon">
                                            <i class="fa fa-briefcase"></i>
                                            <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="RUC" name="txtRuc" id="txtRuc" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-icon">
                                            ...
                                            <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Dirección" name="txtDireccion" id="txtDireccion" /></div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-icon">
                                            ...
                                            <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Teléfono" name="txtTlf" id="txtTlf" /></div>
                                    </div>

                                    <div class="form-group">
                                        <!-- <i class="fa fa-check"></i> -->
                                        <label class="control-label visible-ie8 visible-ie9">Página</label>
                                        <div class="input-icon">
                                            <i class="fa fa-file"></i>
                                            <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Página" name="txtWeb" id="txtWeb" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-icon">
                                            ...
                                            <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Correo Electrónico" name="txtEmail" id="txtEmail" />
                                        </div>
                                    </div>
                                    
                                    <div class="form-actions right">
                                        <button  type="button" id="btnReg" class="btn blue pull-right">
                                        Registrese
                                        </button>
                                    </div>    
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label text-center"><a id="volver">Volver</a></label>
                                    </div>                          
                                </div>
                            </form>
                            </span>
...
<script src="../../../includes/assets/plugins/bootstrap-fileinput/bootstrap-fileinput.js"></script>
<!--
...
<script src="../../../includes/assets/scripts/custom/registro-soft-tpl.js" type="text/javascript"></script>
