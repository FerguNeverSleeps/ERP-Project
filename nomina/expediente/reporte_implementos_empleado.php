...
//            alert(f1);
//            alert(f2);
            AbrirVentana('pdf/reporte_implementos_empleado_pdf.php?fecha_inicio='+f1+'&fecha_fin='+f2,660,800,0);
...
//    exit;2016-01-01&fecha_fin=2016-02-30
    window.open("pdf/reporte_implementos_empleado_pdf.php?fecha_inicio=2016-01-01&fecha_fin=2016-02-30");
				...
				<div class="col-md-12">
                                    ...
                                    <div class="portlet box blue">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                Asignación de Implementos / Herramientas - Empleado
                                            </div>
                                        </div>
