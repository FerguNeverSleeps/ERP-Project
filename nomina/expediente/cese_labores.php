    ...
    <div class="form-group">                             
        <label class="col-md-2 control-label" for="txtcodigo">Número Resuelto: </label>                                
        <div class="col-md-3">
    ...
    <div class="form-group">                            
        ...
        <label class="col-md-2 control-label" for="txtcodigo">Fecha Efectividad:</label>                                
        <div class="col-md-3">
            <div class="input-group date date-picker" data-provide="datepicker"  data-date-format="dd/mm/yyyy" >
                 <input type="text" name="fecha" class="form-control" id="fecha" placeholder="(dd/mm/aaaa)" size="10" value="<?if(isset($fetch33['fecha_efectividad'])) echo fecha($fetch33['fecha_efectividad']);?>" maxlength="10"/>
                <span class="input-group-btn">
                    <button class="btn default" type="button" style="height: 34px;"><i class="fa fa-calendar"></i></button>
                </span>
            </div>
