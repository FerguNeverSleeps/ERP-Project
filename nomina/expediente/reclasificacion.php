...
<div class="form-group">
    ...
    <div class="col-md-3">
        <div class="input-group date date-picker" data-provide="datepicker" data-date-format="dd/mm/yyyy">
            <input size="10" class="form-control" placeholder="(dd/mm/aaaa)" type="text" name="fecha_reclasificacion" id="fecha_reclasificacion" readonly="readonly" value="<?if(isset($fetch33['fecha'])) echo fecha($fetch33['fecha']);?>">
...
<div class="form-group">
    ...
    <div class="col-md-3">
        <div class="input-group date date-picker" data-provide="datepicker" data-date-format="dd/mm/yyyy">
            <input size="10" type="text" name="fecha_decreto" id="fecha_decreto" class="form-control" readonly="readonly" placeholder="(dd/mm/aaaa)" value="<?if(isset($fetch33['fecha_decreto'])) echo fecha($fetch33['fecha_decreto']);?>">
            <span class="input-group-btn">
                <button class="btn default" type="button" style="height: 34px;"><i class="fa fa-calendar"></i></button>
            </span>    
        </div>
