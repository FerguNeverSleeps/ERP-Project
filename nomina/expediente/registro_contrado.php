...
<div class="form-group">                                
    ...
    <div class="col-md-3">
        <input type="text" name="ficha" class="form-control" id="ficha" readonly="true" <? if (isset($ficha)) echo "value='$cedula'"?> size="70"/>
    </div>        
...
<div class="form-group">
    <label class="col-md-2 control-label" for="txtcodigo">Centro de costo: </label>
    <div class="col-md-7">                               
            ...
            <select name="proyecto_nuevo" class="form-control" id="proyecto_nuevo">
                ...
                <?php                     
                     ...
                     $consulta_proyecto="select codorg,descrip,markar,ee from nomnivel1";
                    ...
                    while($fila_proyecto=fetch_array($resultado_proyecto))
                    {
                        ...
                        if ($codigo=='')
                        {
                            if(!$fetch2['proyecto'])
                            {?>
                                <option  value="<?=$fila_proyecto['codorg'];?>"><?=utf8_encode($fila_proyecto['descrip']);?></option>
                            <?}
                            else
                            { 
                               if($fetch2['proyecto']==$fila_proyecto['codorg'])
                               {?>
                                    <option  value="<?=$fila_proyecto['codorg'];?>" selected><?=utf8_encode($fila_proyecto['descrip']);?></option> 
                               <?}
                               else
                               {?>
                                    <option  value="<?=$fila_proyecto['codorg'];?>"><?=utf8_encode($fila_proyecto['descrip']);?></option>
                        ...
                        {
                            if($fetch33['proyecto']==$fila_proyecto['codorg'])
                            {?>
                                 <option  value="<?=$fila_proyecto['codorg'];?>" selected><?=utf8_encode($fila_proyecto['descrip']);?></option> 
                            <?}
                            else
...
<div class="form-group">
    <label class="col-md-2 control-label" for="txtcodigo">Locacion: </label>
    <div class="col-md-7">                               
