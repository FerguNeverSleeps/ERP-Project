...
<div class="form-group">                                
    <label class="col-md-2 control-label" for="txtcodigo">Nombres: </label>                                
    <div class="col-md-7">
        <input type="text" name="nombres_nuevo" class="form-control" id="nombres_nuevo" <? if (isset($fetch33['nombres_nuevo'])) echo "value='$fetch33[nombres_nuevo]'"?> size="70"/>
    </div>   
</div>

<div class="form-group">                                
    <label class="col-md-2 control-label" for="txtcodigo">Apellido Paterno: </label>                                
    <div class="col-md-3">
        <input type="text" name="apellido_paterno_nuevo" class="form-control" id="apellido_paterno_nuevo" <? if (isset($fetch33['apellido_paterno_nuevo'])) echo "value='$fetch33[apellido_paterno_nuevo]'"?> size="70"/>
    </div>
    <label class="col-md-2 control-label" for="txtcodigo">Apellido Materno: </label>                                
    <div class="col-md-3">
        <input type="text" name="apellido_materno_nuevo" class="form-control" id="apellido_materno_nuevo" <? if (isset($fetch33['apellido_materno_nuevo'])) echo "value='$fetch33[apellido_materno_nuevo]'"?> size="70"/>
    </div>
</div>
    
<div class="form-group">                                
    <label class="col-md-2 control-label" for="txtcodigo">Apellido Casada: </label>                                
    <div class="col-md-7">
        <input type="text" name="apellido_casada_nuevo" class="form-control" id="apellido_casada_nuevo" <? if (isset($fetch33['apellido_casada_nuevo'])) echo "value='$fetch33[apellido_casada_nuevo]'"?> size="70"/>
    </div>
