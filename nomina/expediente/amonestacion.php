...
<fieldset>
    ...
    <div class="form-group">                            
        ...
        <div class="col-md-7" id="sandbox-container">
            <div class="input-group date date-picker" data-provide="datepicker" data-date-format="dd/mm/yyyy" >
                <input type="text" name="fecha_amonestacion" class="form-control" autocomplete="off" id="fecha_amonestacion" placeholder="(dd/mm/aaaa)" size="10" value="<?if(isset($fetch33['fecha'])) echo fecha($fetch33['fecha']);?>" maxlength="10"/>
                <span class="input-group-btn">
                    <button class="btn default" type="button" style="height: 34px;"><i class="fa fa-calendar"></i></button>
                </span>
            </div>

            <!--<input type="text" class="form-control" id="fecha_amonestacion" name="fecha_amonestacion" placeholder="(dd/mm/aaaa)" size="10" value="<?if(isset($fetch33['fecha'])) echo fecha($fetch33['fecha']);?>" maxlength="10">                                    -->
        </div>
    </div>
    <div class="form-group">
                    ...
                    <?php                        
                       $consulta_falta="SELECT * FROM tipos_faltas";
                        ...
                        while($fila=fetch_array($resultado_falta))
                        {
                                ...
                                {?>
                                     <option  value="<?=$fila['id'];?>" selected><?=utf8_encode($fila['articulo'])." - ".utf8_encode($fila['numeral'])." - ".utf8_encode($fila['descripcion']);?></option> 
                                <?}
                                else
                                {?>
                                     <option  value="<?=$fila['id'];?>"><?=utf8_encode($fila['articulo'])." - ".utf8_encode($fila['numeral'])." - ".utf8_encode($fila['descripcion']);?></option>
                                <?}         
    ...
    <div class="form-group">
       ...
       <div class="col-md-7">
            <textarea name="numeral_descripcion" id="numeral_descripcion" readonly class="form-control" rows="3" style="resize:vertical;"><?php if (isset($fetch33['numeral_descripcion'])) echo utf8_encode($fetch33['numeral_descripcion']); ?></textarea>
       </div>
   </div>  
    <div class="form-group">
