...
//    echo $codigo;
	...
	$templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor('plantillas/acreditacion_migratoria_especial.docx');
	...
	$filename = 'acreditacion_migratoria_especial_'.$codigo.'.docx';
