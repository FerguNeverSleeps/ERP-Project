...
//    echo $codigo;
	...
	$templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor('plantillas/amonestacion_suspension_amx.docx');
	...
	$templateProcessor->setValue('numeral_descripcion', htmlspecialchars($numeral_descripcion));
	$templateProcessor->setValue('motivo', htmlspecialchars($motivo));
