...
//    echo $codigo;
	...
	$expediente = $res2->fetch_object();
        $fecha_resolucion = $expediente ->cm_fecha_resolucion;
	...
	$templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor('plantillas/acreditacion_migratoria_ordinario.docx');
	...
	$filename = 'acreditacion_migratoria_ordinario_'.$codigo.'.docx';
