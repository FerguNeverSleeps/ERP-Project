...
<fieldset>
    <legend >Misión Oficial</legend>


<div class="form-group">
    <label class="col-md-2 control-label" for="txtcodigo">Fecha/Hora Inicio:</label>                                
    <div class="col-md-2">
        <div class="form-group">
            <div class="input-group date" id="fecha_hora_inicio">                                                                                                                        
                <input type="text" name="fecha_hora_inicio" class="form-control" placeholder="(DD/MM/AAAA HH:MM)" id="div_fecha_hora_inicio" onchange="calcular_dias_horas();" value="<?if(isset($fetch33['fecha_hora_inicio'])) echo $fetch33['fecha_hora_inicio'];?>" />
    ...
    <label class="col-md-2 control-label" for="txtcodigo">Fecha/hora Fin: </label>                                
    <div class="col-md-2"> 
        <div class="form-group">
            <div class="input-group date" id="fecha_hora_fin">                                                                                                                                                                
                <input  type="text" name="fecha_hora_fin" class="form-control" placeholder="(DD/MM/AAAA HH:MM)" id="div_fecha_hora_fin"  onchange="calcular_dias_horas();" value="<?if(isset($fetch33['fecha_hora_fin'])) echo $fetch33['fecha_hora_fin'];?>" />
                <span class="input-group-btn">
                <button class="btn default" type="button" style="height: 34px;"><i class="fa fa-calendar"></i></button>
            </span>
            </div>  
...
<div class="form-group">                             
    ...
    <div class="col-md-2">
        <input type="text" class="form-control"  name="dias" id="dias" readonly maxlength="2" <? if (isset($fetch33['dias'])){ echo "value='$fetch33[dias]'";} else{ echo "value=''";}?>/>                                
    </div>    
    <label class="col-md-2 control-label" for="txtcodigo">Horas</label>
    
    <div class="col-md-2">
        <input type="text" class="form-control" size="3" name="horas" id="horas" readonly maxlength="2" <? if (isset($fetch33['horas'])) echo "value='$fetch33[horas]'"?>/>
    </div>
...
<div class="form-group">
        ...
        <label class="col-md-2 control-label" for="txtcodigo">Lugar: </label>                               
       <div class="col-md-7">
            <textarea name="localidad" id="localidad" class="form-control" rows="1" style="resize:vertical;"><?php if (isset($fetch33['lugar'])) echo "$fetch33[lugar]"?></textarea>
       </div>
   </div>    
