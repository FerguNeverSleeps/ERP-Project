...
$fechaInicio=strtotime("2017-07-25");
//$fechaFin=strtotime(date('Y-m-d'));
$fechaFin=strtotime("+31 days", strtotime(date('Y-m-d')));
...
for($i=$fechaInicio; $i<=$fechaFin; $i+=86400)
{
    ...
    $fecha_acreditacion = date("Y-m-d", $i);
    $dias = $restante = 30;
    $horas = $minutos = 0;
    ...
    $consulta_personal="SELECT personal_id, cedula, estado, inicio_periodo, fin_periodo, apenom, tipnom, nomposicion_id, fecha_permanencia, useruid, usuario_workflow "
    ...
    {          
        ...
        if($acumula==1)
        {
            ...
            if($cantidad==0)
            {
                ...
                echo " - FECHA INICIO PERIODO: "; echo $fecha_inicio_periodo;
                echo " - FECHA FIN PERIODO: "; echo $fecha_fin_periodo;
    ...
    //            echo " - CANTIDAD DIAS MES INGRESO: "; echo $cantidad_dias_mes;
                ...
                $consulta_expediente="INSERT INTO expediente
                            ...
                            . "'{$fecha_acreditacion}','{$dias}','{$restante}','{$tipo}','{$subtipo}','{$estatus}','{$fecha_creacion}','{$usuario}')";
        ...
        //        echo "<br>";
                ...
                $consulta_vacaciones="INSERT INTO periodos_vacaciones
                        ...
                        . "'{$dias}', '{$restante}', '{$fecha_inicio_periodo}','{$fecha_acreditacion}','{$usuario}','{$ultimo_id_incapacidad}',"
