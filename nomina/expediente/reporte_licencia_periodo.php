...
//            alert(f1);
//            alert(f2);
            AbrirVentana('pdf/reporte_licencia_periodo_pdf.php?fecha_inicio='+f1+'&fecha_fin='+f2,660,800,0);
...
//    exit;2016-01-01&fecha_fin=2016-02-30
    window.open("pdf/reporte_licencia_periodo_pdf.php?fecha_inicio=2016-01-01&fecha_fin=2016-02-30");
                                            ...
                                            <FORM name="formulario1" id="formulario1" class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-2">
                                                                <?php boton_metronic('ok',"confirmar_reporte('\u00BFDesea Generar Reporte de Licencias?');",2); ?>
                                                        </div>                    
                                                        <div class="col-md-4">                            
                                                        </div>
