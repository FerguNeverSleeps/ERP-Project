...
<div class="form-group">                                
    <label class="col-md-2 control-label" for="txtcodigo">Motivo Jubilación: </label>                                
    <div class="col-md-7">
        <input type="text" name="motivo_jubilacion" class="form-control" id="motivo_jubilacion" <? if (isset($fetch33['motivo_jubilacion'])) echo "value='$fetch33[motivo_jubilacion]'"?> size="70"/>
    </div>   
</div>

<div class="form-group">                                
    <label class="col-md-2 control-label" for="txtcodigo">Fecha Jubilación: </label>                                
    <div class="col-md-3">
