...
<div class="form-group">                                
    ...
    <div class="form-group">                                
    <label class="col-md-2 control-label" for="txtcodigo">Monto: </label>                                
    <div class="col-md-3">
        <input type="text" name="monto" class="form-control" id="monto" <? if (isset($fetch33['monto'])) echo "value='$fetch33[monto]'"?> size="70"/>
    </div>
</div>
