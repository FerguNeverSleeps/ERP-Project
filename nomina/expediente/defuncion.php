...
<div class="form-group">                                
    <label class="col-md-2 control-label" for="txtcodigo">Causa Defunción: </label>                                
    <div class="col-md-7">
        <input type="text" name="causa_defuncion" class="form-control" id="causa_defuncion" <? if (isset($fetch33['causa_defuncion'])) echo "value='$fetch33[causa_defuncion]'"?> size="70"/>
    </div>   
</div>

<div class="form-group">                                
    <label class="col-md-2 control-label" for="txtcodigo">Fecha Defunción: </label>                                
    <div class="col-md-3">
