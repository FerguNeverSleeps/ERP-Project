    ...
    <div class="col-md-7">
        ...
        <div class="radio-list">
            <label class="radio-inline">
                <input type="radio" name="tipo_ajuste" id="aumenta" value="1" onclick="cargar_select_periodo_vacacion_ajuste_tiempo();" <?=$aumenta?>> Aumenta</label>
            <label class="radio-inline">
            <input type="radio" name="tipo_ajuste" id="disminuye" value="2" onclick="cargar_select_periodo_vacacion_ajuste_tiempo();" <?=$disminuye?>> Disminuye / Accion de Personal</label>
        </div>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-2">
        <div class="input-group">
            <input type="text" name="fecha_inicio_periodo" readonly class="form-control" id="fecha_inicio_periodo" placeholder="(dd/mm/aaaa)" size="10" value="<?if(isset($fetch33['fecha_inicio_periodo'])) echo fecha($fetch33['fecha_inicio_periodo']);?>" maxlength="10"/>                                        
    ...
    <div class="col-md-2">
        <div class="input-group">
            <input type="text" name="fecha_fin_periodo" readonly class="form-control" id="fecha_fin_periodo" placeholder="(dd/mm/aaaa)" size="10" value="<?if(isset($fetch33['fecha_fin_periodo'])) echo fecha($fetch33['fecha_fin_periodo']);?>" maxlength="10"/>                                                                                
            <span class="input-group-btn">
                <button class="btn default" type="button" style="height: 34px;"><i class="fa fa-calendar"></i></button>
            </span>
        </div>
...
<div class="form-group">                             
     <label class="col-md-2 control-label" for="txtcodigo">Días Ajuste:</label>                               
    <div class="col-md-2">
        <input type="text" class="form-control"  name="dias" id="dias" readonly maxlength="2" <? if (isset($fetch33['dias'])){ echo "value='$fetch33[dias]'";} else{ echo "value='30'";}?>/>                                
    </div>
    <label class="col-md-2 control-label" for="txtcodigo">Saldo:</label>                               
    <div class="col-md-2">
        <input type="text" class="form-control"  name="restante" id="restante" readonly maxlength="2" <? if (isset($fetch33['restante'])){ echo "value='$fetch33[restante]'";} else { echo "value='30'";}?>/>                                
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-2">
        <input type="text" class="form-control" size="3" name="horas" id="horas" maxlength="2" <? if (isset($fetch33['horas'])) echo "value='$fetch33[horas]'"?>/>
    </div>
