...
<div class="form-group">                                
    ...
    <div class="col-md-3">
        <input type="text" name="numero_decreto_ingreso" class="form-control" id="numero_decreto_ingreso" readonly="true" value="<?if(isset($numero_decreto_ingreso)) echo $numero_decreto_ingreso;?>" size="70"/>
    </div>
    <label for="txtcodigo" class="col-md-2 control-label">Fecha Decreto (Ingreso): </label>                                    
    <div class="col-md-2">
        <input class="form-control" type="text" name="fecha_decreto_ingreso" id="fecha_decreto_ingreso" readonly="true" value="<?if(isset($fecha_decreto_ingreso)) echo fecha($fecha_decreto_ingreso);?>" size="70" /> 
    </div>
</div>
<div class="form-group">                                
    <label class="col-md-2 control-label" for="txtcodigo">Número Resuelto (Baja): </label>                                
    <div class="col-md-3">
        <input type="text" name="numero_resuelto_baja" class="form-control" id="numero_resuelto_baja" readonly="true" value="<?if(isset($numero_resuelto_baja)) echo $numero_resuelto_baja;?>" size="70"/>
    </div>
    <label for="txtcodigo" class="col-md-2 control-label">Fecha Resuelto (Baja): </label>                                    
    <div class="col-md-2">
        <input class="form-control" type="text" name="fecha_resuelto_baja" id="fecha_resuelto_baja" readonly="true"  value="<?if(isset($fecha_resuelto_baja)) echo fecha($fecha_resuelto_baja);?>"  size="70" /> 
    </div>
</div>
<div class="form-group">                                
    <label class="col-md-2 control-label" for="txtcodigo">Causal Baja: </label>                                
    <div class="col-md-3">
        <input type="text" name="causal_baja" class="form-control" id="causal_baja" readonly="true" value="<?if(isset($causal_baja)) echo $causal_baja;?>" size="70"/>
    </div>
...
<fieldset>
    <legend >Reintegro</legend>
<div class="form-group">
    <label class="col-md-2 control-label" for="txtcodigo">Fecha Reintegro:</label>
    <div class="col-md-3">
        <div class="input-group date date-picker" data-provide="datepicker" data-date-format="dd/mm/yyyy">
            <input size="10" class="form-control" placeholder="(dd/mm/aaaa)" type="text" name="fecha_reintegro" id="fecha_reintegro" readonly="readonly" value="<?if(isset($fetch33['fecha'])){ if($fetch33['fecha']!="0000-00-00") {echo fecha($fetch33['fecha']);} else{echo date("d/m/Y");} }?>">
    ...
    <div class="col-md-3">
        <div class="input-group date date-picker" data-provide="datepicker" data-date-format="dd/mm/yyyy">
            <input size="10" type="text" class="form-control" placeholder="(dd/mm/aaaa)" name="fecha_fin" id="fecha_fin" readonly="readonly" value="<?if(isset($fetch33['fecha_fin'])){ if($fetch33['fecha_fin']!="0000-00-00") {echo fecha($fetch33['fecha_fin']);} else{echo date("d/m/Y");} }?>">
            <span class="input-group-btn">
                <button class="btn default" type="button" style="height: 34px;"><i class="fa fa-calendar"></i></button>
            </span> 
        </div>
...
<div class="form-group">
    <label class="col-md-2 control-label" for="txtcodigo">Numero de Decreto:</label>
    <div class="col-md-3">
         <input type="text" name="numero_decreto" class="form-control" id="numero_decreto" <? if (isset($fetch33['numero_decreto'])) echo "value='$fetch33[numero_decreto]'"?> size="30"/> 

    </div>

    <label class="col-md-1 control-label" for="txtcodigo">Fecha Decreto:</label>
    <div class="col-md-3">
        <div class="input-group date date-picker" data-provide="datepicker" data-date-format="dd/mm/yyyy">
            <input size="10" type="text" name="fecha_decreto" id="fecha_decreto" class="form-control" readonly="readonly" placeholder="(dd/mm/aaaa)" value="<?if(isset($fetch33['fecha_decreto_ingreso_nuevo'])){ if($fetch33['fecha_decreto_ingreso_nuevo']!="0000-00-00") {echo fecha($fetch33['fecha_decreto_ingreso_nuevo']);} else{echo date("d/m/Y");} }?>">
            <span class="input-group-btn">
                <button class="btn default" type="button" style="height: 34px;"><i class="fa fa-calendar"></i></button>
            </span>    
        </div>
...
<div class="form-group">
    ...
    <div class="col-md-3">
        <div class="input-group date date-picker" data-provide="datepicker" data-date-format="dd/mm/yyyy">
            <input size="10" type="text" class="form-control" placeholder="(dd/mm/aaaa)" name="fecha_notificacion" id="fecha_notificacion" readonly="readonly" value="<?if(isset($fetch33['fecha_notificacion'])){ if($fetch33['fecha_notificacion']!="0000-00-00") {echo fecha($fetch33['fecha_notificacion']);} else{echo date("d/m/Y");} }?>">
            <span class="input-group-btn">
                <button class="btn default" type="button" style="height: 34px;"><i class="fa fa-calendar"></i></button>
            </span> 
        </div>
            ...
            <select name="gerencia_ant" class="form-control" id="gerencia_ant" disabled>
                ...
                <?php                     
                    ...
                    while($fila_gerencia=fetch_array($resultado_gerencia))
                    {
                            ...
                            if($fetch33['gerencia_anterior']==$fila_gerencia['codorg'])
                            {?>
...
<div class="form-group">
    <label class="col-md-2 control-label" for="txtcodigo">Sección Nueva: </label>
    <div class="col-md-7">                               
            ...
            <select name="planilla_ant" class="form-control" id="planilla_ant"disabled>
                ...
                <?php                     
                    ...
                    while($fila_planilla=fetch_array($resultado_planilla))
                    {
                            ...
                            if($fetch33['planilla_anterior']==$fila_planilla['codtip'])
                            {?>
...
<div class="form-group">
   ...
   <label class="col-md-2 control-label" for="txtcodigo">Estatus Anterior:</label>                                
   <div class="col-md-7">
       <select name="situacion_ant" id="situacion_ant" class="form-control" disabled>
           <option value="">Seleccione</option>
           <?
           $consulta_estatus="SELECT codigo,situacion FROM nomsituaciones";
           $resultado_estatus=sql_ejecutar($consulta_estatus);
           while($fila_estatus=fetch_array($resultado_estatus))
            {
                
                if(!$fetch33['situacion_anterior'])
                {?>
                    <option  value="<?=$fila_estatus['codigo'];?>"><?=utf8_encode($fila_estatus['situacion']);?></option>
                <?}
                else
                { 
                   if($fetch33['situacion_anterior']==$fila_estatus['codigo'])
                   {?>
...
<div class="form-group">
   ...
   <label class="col-md-2 control-label" for="txtcodigo">Estatus Nuevo:</label>                                
   <div class="col-md-7">
