...
<div class="form-group">
    <label class="col-md-2 control-label" for="txtcodigo">Ausencia Justificada por Motivo De:</label>
    <div class="col-md-7">                               
            <div  id="tipo_tipo">
...
<fieldset>
    <legend >Reincorporación</legend>
    
<div class="form-group">                                
    <label class="col-md-2 control-label" for="txtcodigo">Fecha Reincorporación: </label>                                
    <div class="col-md-3">
...
<div class="form-group">                                
    <label class="col-md-2 control-label" for="txtcodigo">Fecha Enterado (Superior Inmediato): </label>                                
    <div class="col-md-3">
        <div class="input-group date date-picker" data-provide="datepicker" data-date-format="dd/mm/yyyy" >
            <input type="text" name="fecha_enterado" class="form-control" id="fecha_enterado" placeholder="(dd/mm/aaaa)" size="10" value="<?if(isset($fetch33['fecha_enterado'])) echo fecha($fetch33['fecha_enterado']);?>" maxlength="10"/>
            <span class="input-group-btn">
                    <button class="btn default" type="button" style="height: 34px;"><i class="fa fa-calendar"></i></button>
            </span>
        </div>
...
<div class="form-group">                                
    <label class="col-md-2 control-label" for="txtcodigo">Fecha Enterado (Jefe): </label>                                
    <div class="col-md-3">
        <div class="input-group date date-picker" data-provide="datepicker" data-date-format="dd/mm/yyyy" >
            <input type="text" name="fecha_enterado_jefe" class="form-control" id="fecha_enterado_jefe" placeholder="(dd/mm/aaaa)" size="10" value="<?if(isset($fetch33['fecha_enterado_jefe'])) echo fecha($fetch33['fecha_enterado_jefe']);?>" maxlength="10"/>
            <span class="input-group-btn">
                    <button class="btn default" type="button" style="height: 34px;"><i class="fa fa-calendar"></i></button>
            </span>
        </div>
