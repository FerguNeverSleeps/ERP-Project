...
{		
        ...
        // Title
        //$this->Cell(80);
        //$this->Cell(280,6,'SERVICIO NACIONAL DE MIGRACION',0,0,'C');
        $this->Ln(2);
        $this->Cell(280,12,'UNIDAD RECURSOS HUMANOS',0,0,'C');
        $this->Ln(2);
        $this->cell(280,18,'REPORTE DE LICENCIAS - PERIODO: '.$fecha_inicio.' / '.$fecha_fin,0,0,'C');
        $this->Ln();
...
//        $this->Ln();
        ...
        $this->Row(array('NOMBRE', utf8_decode('CÉDULA'), 'PLAN.', 'POS','CARGO','SAL.',utf8_decode('UBICACIÓN'),'TIEMPO','PERIODO','TIPO DE LIC.','RESOL.','MOTIVO'));
        // Carga de datos  
