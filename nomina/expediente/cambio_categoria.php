...
<div class="form-group">                                
    <label class="col-md-2 control-label" for="txtcodigo">Categoría Actual: </label>                                
    <div class="col-md-7">
        <input type="text" name="categoria_actual" class="form-control" id="categoria_actual" <? if (isset($fetch33['categoria_actual'])) echo "value='$fetch33[categoria_actual]'"?> size="70"/>
    </div>
...
<div class="form-group">                                
    <label class="col-md-2 control-label" for="txtcodigo">Categoría Nueva: </label>                                
    <div class="col-md-7">
        <input type="text" name="categoria_nueva" class="form-control" id="categoria_nueva" <? if (isset($fetch33['categoria_nueva'])) echo "value='$fetch33[categoria_nueva]'"?> size="70"/>
    </div>
