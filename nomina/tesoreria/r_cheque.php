...
while($fila3=fetch_array($resultado3))
{
	...
	<TD align="left" > <?php echo $dia.$mes.$ano.' 01'; ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $ficha.'&nbsp;'.$sueldo.'&nbsp;'.$ss.'&nbsp;'.$islr.'&nbsp;'.$se; ?></TD>
	</TR>
	<TR>
	<TD align="left" width='500px'><strong> <?php echo $cedula; ?></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>
	<TD align="left" > <?php echo $nombreContribuyente; ?></TD>
	</TR>
	...
	<TD align="left" > <?php echo $cedula; ?>&nbsp;&nbsp;&nbsp; <?php echo $seguro_social?>&nbsp;&nbsp;&nbsp; <?php echo $totald?>&nbsp;&nbsp;&nbsp; <?php echo $monto?></TD>
	</TR>
