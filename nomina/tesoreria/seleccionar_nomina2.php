...
$consulta="select np.*, nt.descrip as nominas from ".$tabla." np join nomtipos_nomina nt  on np.codtip=nt.codtip where status='C' and (status_acreedores='1' or status_cheques='1')  order by codtip asc, codnom desc";
                                ...
                                <?
                            		if($num_paginas!=0)
                            		{
                            			...
                            			while($fila=mysqli_fetch_array($resultado))
                            			{
                            				...
                            				$codigo=$fila['codnom'];
                            				$tipnom=$fila['codtip'];
                            				if($fila[status_acreedores]==1)
                            					iconoNuevo("r_cheque_acreedores.php?nomina=$codigo", "Impresion de Cheques a acreedores por lote", "ico_print.gif");
                            				else
                            					echo "<td></td>";
                            				if($fila[status_cheques]==1)
                            				{
                            					iconoNuevo("r_cheque.php?nomina=$codigo", "Impresion de Cheques a empleados por lote (Opcion 1)", "ico_print.gif");
                            					iconoNuevo("r_cheque.php?nomina=$codigo", "Impresion de Cheques a empleados por lote (Opcion 2)" , "ico_print.gif");
                            				}
                            				else
                            					echo "<td></td>";
                            		    		echo "</tr>";
