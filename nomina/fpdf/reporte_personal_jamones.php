...
function detalle($gerencia,$nomina){
	...
	$conexion=conexion();
	$consulta="select * from nompersonal AS np INNER JOIN nomcampos_adic_personal as nc ON np.ficha=nc.ficha and nc.id=50 and nc.valor='SI'  $cadenaselect  ORDER BY  np.ficha,tipnom,codnivel4,apenom ";
