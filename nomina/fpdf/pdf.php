...
function liquidacion2($pdf){
	...
	$pdf->Cell(66,5,'ELABORADO POR','LT',0,"C");
	$pdf->Cell(66,5,'REVISADO POR','LT',0,"C");
	$pdf->Cell(66,5,'CONFORMADO POR','LTR',1,"C");
	
	$pdf->Cell(66,5,'','L',0,"C");
	$pdf->Cell(66,5,'','L',0,"C");
	$pdf->Cell(66,5,'','LR',1,"C");
	
	$pdf->Cell(66,5,'LIZETTY REINA','L',0,"C");
	$pdf->Cell(66,5,utf8_decode('JOSÉ SERRANO'),'L',0,"C");
	$pdf->Cell(66,5,'OSCAR VALE CADIERES','LR',1,"C");
	...
	$pdf->Setancho(array(5,5,5));
        $pdf->Row(array('COORDINADOR DE RECURSOS HUMANOS',utf8_decode('DIRECTOR DE ADMINISTRACION Y PRESUPUESTO'),'PRESIDENTE'));
