...
// 			$this->Cell(188,5,$cantidad_registros,0,1);
			...
			$this->Row(array($fila['ficha'],utf8_decode($fila['apenom']),$fila['cedula'],utf8_decode($fetchcargo['des_car']),date("d/m/Y",strtotime($fila['fecing'])),$anos,utf8_decode($fetchprof['descrip']),'',utf8_decode($fila['direccion'])));
			$conexion=conexion();
