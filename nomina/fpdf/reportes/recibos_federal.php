...
class PDF extends FPDF
{
    ...
    function personas($nomina_id,$codtp){
        ...
        AND (mn.codcon >=300 AND mn.codcon <=399)";
        ...
        while ($fila=fetch_array($result_lote))
        {
            ...
            $this->SetWidths(array(10,10));  $query="SELECT cod_car,des_car from nomcargos where cod_car='".$fila[codcargo]."'";
            $result=query($query,$conexion);
...
*/
            ...
            $this->Cell(46,4,number_format($sub_total_asig-$sub_total_dedu,2,',','.'),2,1,'R');
