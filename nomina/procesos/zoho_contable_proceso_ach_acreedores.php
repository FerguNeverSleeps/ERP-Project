...
$sql_fallidas = "SELECT *
        FROM   zoho_contable_cabecera
        WHERE  estatus=0 AND tipo=3
	ORDER BY fecha_creacion DESC";

$sql_procesadas = "SELECT *
        FROM   zoho_contable_cabecera
        WHERE  estatus=1 AND tipo=3
	ORDER BY fecha_creacion DESC";
		
$sql_anuladas = "SELECT *
        FROM   zoho_contable_cabecera
        WHERE  estatus=2 AND tipo=3
	ORDER BY fecha_creacion DESC";
											...
											<?php
												...
												?>
													<td style="text-align: center; width: 22px !important; white-space: nowrap !important; text-decoration: none;">
														...
														<a href="zoho_contable/index.php?codnom=<?php echo $fila_pendientes['codnom'];?>&codtip=<?php echo $fila_pendientes['codtip'];?>" target="_blank" title="Enviar">
											...
											<?php
												...
												?>
													<td style="text-align: center; width: 22px !important; white-space: nowrap !important; text-decoration: none;">
														...
														<a href="zoho_contable/index.php?codnom=<?php echo $fila_fallidas['cod_planilla'];?>&codtip=<?php echo $fila_fallidas['tipo_planilla'];?>&id_zoho_contable_cabecera=<?php echo $fila_fallidas['id'];?>" target="_blank" title="Reenviar">
															<img src="../../includes/imagenes/icons/lightning.png" width="16" height="16">
														</a>
														&nbsp;
											...
											<?php
												...
												?>
													<td style="text-align: center; width: 22px !important; white-space: nowrap !important; text-decoration: none;">
														...
														<a href="zoho_contable_proceso_detalle.php?id=<?php echo $fila_procesadas['id']; ?>" title="Ver">
															<img src="../../includes/imagenes/icons/pencil.png" width="16" height="16">
														</a>
														&nbsp;
														<a href="zoho_contable/index.php?accion=eliminar&id_zoho_contable_cabecera=<?php echo $fila_procesadas['id']; ?>" title="Anular" target="_blank">
															<img src="../imagenes/delete.gif" alt="Anular" width="16" height="16">
														</a>
													</td>
												<?php
										...
										<tr class="odd gradeX" id="num" opcion="<?php echo $fila_anuladas['id'];?>">
											...
											<?php
												...
												?>
													...
													<a href="zoho_contable_proceso_detalle.php?id=<?php echo $fila['id']; ?>" title="Editar">
