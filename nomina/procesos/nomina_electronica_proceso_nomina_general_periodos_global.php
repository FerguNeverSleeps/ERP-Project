...
{	
	$consulta = "DELETE 
	             FROM   nomina_electronica_detalle 
	...
	activar_pagina("nomina_electronica_proceso.php");	 
}   
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
							  <img src="../imagenes/21.png" width="20" height="20" class="icon"> Nomina Electronica / Nomina General - Global
							</div>
							<div class="actions">
								
								<a class="btn btn-sm blue"  onclick="javascript: window.location='nomina_electronica_proceso_nomina_general_periodos_global_procesar.php'">
											...
											<?php
												...
												?>
													<td style="text-align: center; width: 22px !important; white-space: nowrap !important; text-decoration: none;">
														...
														<a href="nomina_electronica_proceso_nomina_general_periodos_global_detalle.php?id_cabecera=<?php echo $fila_pendientes['id_cabecera']; ?>" title="Ver"><img src="../../includes/imagenes/icons/eye.png" width="16" height="16"></a>
														&nbsp;
														<a href="#" title="Anular"><img src="../../includes/imagenes/icons/delete.png" alt="Anular" width="16" height="16" onclick="onAnular('nomina_electronica/index.php?accion=anular&id_cabecera=<?php echo $fila_pendientes['id_cabecera']; ?>')"></a>
													</td>
												<?php
												}
											...
											<?php
												...
												?>
													<td style="text-align: center; width: 22px !important; white-space: nowrap !important; text-decoration: none;">
														...
														<a href="nomina_electronica_proceso_nomina_general_periodos_global_detalle.php?id_cabecera=<?php echo $fila_procesadas['id_cabecera']; ?>" title="Ver"><img src="../../includes/imagenes/icons/eye.png" width="16" height="16"></a>
														&nbsp;
										...
										<tr class="odd gradeX" id="num" opcion="<?php echo $fila_anuladas['id'];?>">
											...
											<?php
												...
												?>
													...
													<a href="nomina_electronica_proceso_nomina_general_periodos_global_detalle_anulados.php?id_cabecera=<?php echo $fila_anuladas['id_cabecera']; ?>" title="Ver"><img src="../../includes/imagenes/icons/eye.png" width="16" height="16"></a>
													</td>
	...
	function onAnular(url){
		if(confirm("Proceso de anulación de los registros asociados a la nómina.\n¿Desea continuar?")){
	        ...
	        $("#cargar_contendio").load( url, function() {
			 	...
			 	window.location.href="nomina_electronica_proceso_nomina_general_periodos_global.php?tab_active=anulados";
			});
