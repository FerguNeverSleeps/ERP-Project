          ...
          <div class="portlet box blue">
            <div class="portlet-title">
              ...
              <div class="actions">
                ...
                <a class="btn btn-sm blue" onclick="enviar(<?php echo(5); ?>,<?php echo $id;?>,'','','','');">
                  <i class="fa fa-pencil"></i>
                      Generar Excel (Encabezado)
                  </a>
              </div>
            </div>
...
//      document.frmPrincipal.action="excel_sipe_css.php";
//      document.frmPrincipal.submit(); 
      location.href ="excel_sipe_css_encabezado.php?id="+id;
    }   
  }
}
