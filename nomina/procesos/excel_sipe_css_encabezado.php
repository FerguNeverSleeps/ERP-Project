...
$objPHPExcel->getActiveSheet()->getStyle('A4:Y4')->applyFromArray($borders);
$objPHPExcel->getActiveSheet()->SetCellValue('A4', "TIPO DOCUMENTO");
$objPHPExcel->getActiveSheet()->SetCellValue('B4', "NUMERO DOCUMENTO");
$objPHPExcel->getActiveSheet()->SetCellValue('C4', "NUMERO SEGURO SOCIAL");
$objPHPExcel->getActiveSheet()->SetCellValue('D4', "NOMBRE");
$objPHPExcel->getActiveSheet()->SetCellValue('E4', "APELLIDO");
$objPHPExcel->getActiveSheet()->SetCellValue('F4', "SUELDO");
$objPHPExcel->getActiveSheet()->SetCellValue('G4', "HORAS EXTRAS");
$objPHPExcel->getActiveSheet()->SetCellValue('H4', "ISR.");
$objPHPExcel->getActiveSheet()->SetCellValue('I4', "XIII");
$objPHPExcel->getActiveSheet()->SetCellValue('J4', "VACACIONES");
$objPHPExcel->getActiveSheet()->SetCellValue('K4', "COMISIONES");
$objPHPExcel->getActiveSheet()->SetCellValue('L4', "BONIFICACIONES");
$objPHPExcel->getActiveSheet()->SetCellValue('M4', "COMBUSTIBLE");
$objPHPExcel->getActiveSheet()->SetCellValue('N4', "DIETA");
$objPHPExcel->getActiveSheet()->SetCellValue('O4', "SALARIO EN ESPECIA");
$objPHPExcel->getActiveSheet()->SetCellValue('P4', "VIÁTICOS");
$objPHPExcel->getActiveSheet()->SetCellValue('Q4', "GASTOS DE REPRESENTACIÓN");
$objPHPExcel->getActiveSheet()->SetCellValue('R4', "ISR GASTOS DE REPRESENTACIÓN");
$objPHPExcel->getActiveSheet()->SetCellValue('S4', "XIII GASTOS DE REPRESENTACIÓN");
$objPHPExcel->getActiveSheet()->SetCellValue('T4', "PRIMAS PRODUCCIÓN");
$objPHPExcel->getActiveSheet()->SetCellValue('U4', "DIVIDENDOS");
$objPHPExcel->getActiveSheet()->SetCellValue('V4', "PART. BENEF. INGR.");
$objPHPExcel->getActiveSheet()->SetCellValue('W4', "GRATIFICACION AGUINALDO");
$objPHPExcel->getActiveSheet()->SetCellValue('X4', "PREAVISO");
$objPHPExcel->getActiveSheet()->SetCellValue('Y4', "INDEMNIZACIÓN");
