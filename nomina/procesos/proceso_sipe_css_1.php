...
//                    WHERE YEAR(periodo_fin) = '{$anio}' AND MONTH(periodo_fin) = '{$mes}'";
    ...
    $con_sueldo="90,100,110,115,140,169,159,160,161,162,171";
    $con_horas_extras="105,106,107,108,109,111,112,113,116,120,121,122,123,124,125,126,127,128,129,130,131,132,133,134,135,136,137,"
            . "138,139,142,143,144,149,150,151,152,153,154,155,163,164,165,166,167,168,172,174";
    $con_impuesto_renta="202,211,213,214,215";
    $con_decimo_tercer_mes="92,102";
    $con_vacaciones="91,114";
