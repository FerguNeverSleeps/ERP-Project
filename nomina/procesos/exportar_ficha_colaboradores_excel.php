...
$sql = "SELECT e.nivel1 FROM nomempresa e";
$res = $db->query($sql);
				...
				<div class="col-md-9">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								Exportar ficha de colaboradores a excel
							</div>
						</div>
						<div class="portlet-body form" id="blockui_portlet_body">

							<form action="xls_exportar_ficha_colaboradores.php" class="form-horizontal" id="form_excel" name="form_excel" method="post" enctype="multipart/form-data">
								<div class="form-body">
...
$(document).ready(function(){
	...
	$("#btn-exportar").click(function(){
	    ...
	    $.post( "xls_exportar_ficha_colaboradores.php", { codnivel1: codnivel1 }, function(file) {

		    window.setTimeout(function () {
	            App.unblockUI('#blockui_portlet_body');
	            $("#codnivel1").select2("val", "");
	            location.href = 'exportar_ficha_colaboradores_excel.php?download&filename='+file;
	        }, 2000, file); 
