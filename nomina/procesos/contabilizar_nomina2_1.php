...
while($j<$k)
{
	...
	$consulta="SELECT codnom, descrip, periodo_ini, periodo_fin, fecha_pago "
	...
	$consulta="insert into {$_SESSION['bdc']}.cwconhco (Numcom,Codtipo,Fecha,Descrip,Estado) "
        . "values ('".$numCom."','3','".$fecham."','Contabilizacion de Planilla/Nomina ".$fetchnom['descrip']."','1')";
...
$update_nomina="UPDATE nom_nominas_pago SET contabilizada=1 WHERE codnom=$nomina AND tipnom=$_SESSION[codigo_nomina]";
