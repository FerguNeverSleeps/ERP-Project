<?php
function generar_planilla_xls($codnom,$codtip){
	include_once('../../lib/common.php');
	include_once('../../paginas/lib/php_excel.php');
	include_once( '../../paginas/phpexcel/Classes/PHPExcel.php');
	...
	//$objPHPExcel = PHPExcel_IOFactory::load("../../paginas/plantillas/planilla_mmd.xlsx");
	...
	$gdImage = imagecreatefromjpeg( "../../../includes/imagenes/".$logo );//"../../imagenes/logo_MMD.jpg"
	...
	$objPHPExcel->getActiveSheet()->getStyle('A2:B5')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
	$objPHPExcel->getActiveSheet()->getStyle('A2:B5')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
	...
	while($row=$res->fetch_array())
	{
		...
		$sql2= "SELECT mn.ficha, CONCAT_WS(' ', np.nombres, np.apellidos) as nombre,
				...
				LEFT JOIN nompersonal np ON np.ficha=mn.ficha
				WHERE  mn.codnom=".$codnom." AND mn.codnivel1=".$codorg." AND mn.tipnom=".$codtip."
				GROUP BY mn.ficha ORDER  BY mn.ficha";
