        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue">
            <div class="portlet-title">
              <div class="caption">
               <?php echo $_SESSION["nomina"].' '; ?> - ACH BAC 
              </div>
			  <div class="actions">
            ...
            <div class="portlet-body">
                <form action="txt_ach_bac.php" method="get" name="frmPrincipal" id="frmPrincipal">
                                                        ...
                                                        <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                        <select name="codnom" id="codnom" class="form-control">
                                                                                ...
                                                                                <?php 
                                                                                        $sentencia = "SELECT codnom, descrip, codtip FROM   nom_nominas_pago WHERE codtip='".$_SESSION['codigo_nomina']."' ORDER BY fechapago DESC";
