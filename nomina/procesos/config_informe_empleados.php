				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								INFORME EMPLEADOR - ARCHIVO EMPLEADOS
							</div>
							<div class="actions">
								<a class="btn btn-sm blue"  onclick="javascript: window.location='menu_informe_empleador.php';">
...
$(document).ready(function()
{
	...
	$("#btn-exportar").click(function(){
		...
		var anio = $("#anio").val();
                ...
                location.href ="excel_informe_empleados.php?anio="+anio+"&opcion="+opcion;
	});
