				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<?php echo $_SESSION["nomina"].' '; ?> - ACH BANCO GENERAL - AHORROS MENSUAL (MMD-SI)
							</div>
							<div class="actions">
						...
						<div class="portlet-body form" id="blockui_portlet_body">
							...
							<form class="form-horizontal" id="form_ach_ahorros_mmdsi_mensual" name="form_ach_ahorros_mmdsi_mensual" method="post">
								<div class="row">&nbsp;</div>
								<div class="row">
...
$(document).ready(function()
{
        $("#anio").select2();
	$("#mes").select2();
	$("#form_ach_ahorros_mmdsi_mensual").validate({
		rules: {
			anio: { required: true},
			mes: { required: true}
		},
	...
	$("#btn-exportar").click(function(){
		...
		var mes    = $("#mes").val();
                ...
                location.href ="txt_ach_ahorros_mmdsi_mensual.php?anio="+anio+"&mes="+mes;
	});
