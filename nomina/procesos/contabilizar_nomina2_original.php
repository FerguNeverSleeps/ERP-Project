...
while($j<$k)
{
	...
	$consulta="SELECT descrip, periodo_fin FROM nom_nominas_pago WHERE codnom='".$codigos[$j][0]."' AND tipnom='".$codigos[$j][1]."'";	
	...
	$consulta="insert into {$_SESSION['bdc']}.cwconhco (Numcom,Codtipo,Fecha,Descrip,Estado) values ('".$numCom."','3','".$fecham."','Contabilizacion de Planilla/Nomina ".$fetchnom['descrip']."','1')";
