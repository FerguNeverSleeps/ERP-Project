				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
							  <img src="../imagenes/21.png" width="20" height="20" class="icon"> NOMINA ELECTRONICA / Proceso Nomina General - Periodos Individual
							</div>
							<div class="actions">
...
<!--								<a class="btn btn-sm blue"  onclick="javascript: window.location='proceso_marvin_agregar.php'">
						...
						<ul class="nav nav-tabs">
                                                                <li class="active"><a href="#tab_procesadas" id="tab-procesadas" data-toggle="tab">Procesados</a></li>                                              
								<li><a href="#tab_anuladas" id="tab-anuladas" data-toggle="tab">Anulados</a></li>
										...
										<tr class="odd gradeX" id="num" opcion="<?php echo $fila_anuladas['id'];?>">
											...
											<?php
												...
												?>
													...
													<a href="nomina_electronica_proceso_detalle.php?id=<?php echo $fila['id']; ?>&tipo_comprobante=1" title="Editar">
