				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								COMPROBANTE CONTABLE / REPORTES DE INCIDENTES DE COLABORADORES
							</div>
							<div class="actions">
...
$(document).ready(function()
{
	...
	$("#btn-exportar").click(function(){
        ...
        location.href ="peachtree_contable_incidentes_colaboradores_csv.php?anio="+anio+"&mes="+mes+"&fecha_inicio="+fecha_inicio+"&fecha_fin="+fecha_fin+"&codcon="+codcon+"&nomnivel1="+nomnivel1;
	});
