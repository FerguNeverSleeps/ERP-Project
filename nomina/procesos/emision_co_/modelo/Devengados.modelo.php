...
class Devengados
{
    ...
    function setVacacionesComunes($datos)
    {
    ...
    function setVacaciones($datos)
    {
        ...
        return array(
            "comunes"  => $Vacaciones->setVacacionesComunes(),
            "compensadas" => $Vacaciones->setVacacionesCompensadas()
        );
    }
    function setIncapacidades($datos)
    {
        $Incapacidades = new Incapacidades();
        $Incapacidades->setPago($datos["pago"]);
        $Incapacidades->setFechaInicio($datos["fecha_inicio"]);
        $Incapacidades->setFechaFin($datos["fecha_fin"]);
        $Incapacidades->setCantidad($datos["cantidad"]);
        
        return array(
            "fecha_inicio" => $Incapacidades->getFechaInicio(),
            "fecha_fin" => $Incapacidades->getFechaFin(),
            "cantidad" => $Incapacidades->getCantidad()
        );
    }
