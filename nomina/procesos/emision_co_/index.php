				...
				<div class="row">
					...
					<div class="col-md-2 text-center">
                        <a href="parametros.php">
                            ...
                            <div class="tile-body">
                            <img style="float: none !important;margin-right: 0;" src="../../img_sis/menu/logo_emision.png" width ="90%" height ="75%" />
                                <h5>PARÁMETROS</h5>                            
                            </div>
                            </div>
                        </a>
					...
					<div class="col-md-2 text-center">
					<a href="nomina_individual.php">
						<div class="tile bg-blue">
						<div class="tile-body">
							<img style="float: none !important;margin-right: 0;" src="../../img_sis/menu/logo_emision.png" width ="90%" height ="75%" />
							<h5>NOMINA INDIVIDUAL</h5>                            
						</div>
						</div>
					</a>
					</div>
