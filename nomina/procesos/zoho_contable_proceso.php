...
{	
	...
	activar_pagina("zoho_contable_proceso.php");	 
}   
...
$sql_pendientes = "
    ...
    FROM nom_nominas_pago as nnp
    	LEFT JOIN zoho_contable_cabecera as zcc ON (nnp.codnom=zcc.cod_planilla AND nnp.codtip=zcc.tipo_planilla AND zcc.tipo=1 AND zcc.estatus!=2)
    WHERE  
    	status='C' AND
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
							  <img src="../imagenes/21.png" width="20" height="20" class="icon"> ZOHO CONTABLE - Proceso
							</div>
							<div class="actions">
											...
											<?php
												...
												?>
													<td style="text-align: center; width: 22px !important; white-space: nowrap !important; text-decoration: none;">
														...
														<a href="zoho_contable/index.php?codnom=<?php echo $fila_pendientes['codnom'];?>&codtip=<?php echo $fila_pendientes['codtip'];?>&tipo_comprobante=1" target="_blank" title="Enviar">
											...
											<?php
												...
												?>
													<td style="text-align: center; width: 22px !important; white-space: nowrap !important; text-decoration: none;">
														...
														<a href="zoho_contable/index.php?codnom=<?php echo $fila_fallidas['cod_planilla'];?>&codtip=<?php echo $fila_fallidas['tipo_planilla'];?>&id_zoho_contable_cabecera=<?php echo $fila_fallidas['id'];?>&tipo_comprobante=1" target="_blank" title="Reenviar">
															<img src="../../includes/imagenes/icons/lightning.png" width="16" height="16">
														</a>
														&nbsp;
														<a href="zoho_contable_proceso_detalle.php?id=<?php echo $fila_fallidas['id']; ?>&tipo_comprobante=1" title="Ver">
											...
											<?php
												...
												?>
													<td style="text-align: center; width: 22px !important; white-space: nowrap !important; text-decoration: none;">
														...
														<a href="zoho_contable_proceso_detalle.php?id=<?php echo $fila_procesadas['id']; ?>&tipo_comprobante=1" title="Ver">
															<img src="../../includes/imagenes/icons/pencil.png" width="16" height="16">
														</a>
														&nbsp;
														<a href="zoho_contable/index.php?accion=eliminar&id_zoho_contable_cabecera=<?php echo $fila_procesadas['id']; ?>&tipo_comprobante=1" title="Anular" target="_blank">
															<img src="../imagenes/delete.gif" alt="Anular" width="16" height="16">
														</a>
													</td>
												<?php
										...
										<tr class="odd gradeX" id="num" opcion="<?php echo $fila_anuladas['id'];?>">
											...
											<?php
												...
												?>
													...
													<a href="zoho_contable_proceso_detalle.php?id=<?php echo $fila['id']; ?>&tipo_comprobante=1" title="Editar">
