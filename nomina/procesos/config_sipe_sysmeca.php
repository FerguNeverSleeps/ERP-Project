				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body form" id="blockui_portlet_body">
							...
							<form class="form-horizontal" id="form_sysmeca" name="form_sysmeca" method="post">
								<div class="row">&nbsp;</div>
								<div class="row">
...
$(document).ready(function()
{
	...
	$("#btn-exportar").click(function(){
		...
		var mes    = $("#mes").val();
                ...
                location.href ="proceso_sipe_sysmeca.php?anio="+anio+"&mes="+mes+"&opcion="+opcion;
	});
