...
if(mkdir($directorio)){
$ruta=$directorio."/ach_ahorros_banco_general_mensual.txt";
...
readfile($ruta); 
header('Content-Disposition: attachment; filename="ach_ahorros_banco_general_mensual.txt"');
