        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue">
            <div class="portlet-title">
              <div class="caption">
               <?php echo $_SESSION["nomina"].' '; ?> - PEACHTREE Contable
              </div>
			  <div class="actions">
            ...
            <div class="portlet-body">
                <form action="peachtree_contable_csv.php" method="get" name="frmPrincipal" id="frmPrincipal">
                                                        ...
                                                        <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                        <select name="codnom" id="codnom" class="form-control">
                                                                                ...
                                                                                <?php 
                                                                                        $sentencia = "SELECT codnom, descrip, codtip FROM  nom_nominas_pago "
                                                                                                    . "WHERE codtip='".$_SESSION['codigo_nomina']."' "
                                                                                                    . "ORDER BY codnom DESC";
                                                                                        $resultado = $db->query($sentencia);
                                                                                        while ($filas = $resultado->fetch_object()) 
                                                                                        {
                                                                                                echo "<option value='".$filas->codnom."'>".$filas->codnom."-".$filas->descrip."</option>";
                                                                                        }
