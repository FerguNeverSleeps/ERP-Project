				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								CSV COMPROBANTE CONTABLE
							</div>
							<div class="actions">
								<a class="btn btn-sm blue"  onclick="javascript: window.location='netsuite_menu.php';">
...
$(document).ready(function()
{
	...
	$("#btn-exportar").click(function(){
        ...
        location.href ="netsuite_csv.php?anio="+anio+"&mes="+mes+"&fecha_inicio="+fecha_inicio+"&fecha_fin="+fecha_fin;
	});
