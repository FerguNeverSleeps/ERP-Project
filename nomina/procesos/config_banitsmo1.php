        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue">
            <div class="portlet-title">
              <div class="caption">
               <?php echo $_SESSION["nomina"].' '; ?> - BANITSMO 1
              </div>
			  <div class="actions">
            ...
            <div class="portlet-body">
                <form action="xls_banitsmo1.php" method="get" name="frmPrincipal" id="frmPrincipal">
					...
					<div class="form-group">
						...
						<div class="row">
							<label class="col-md-3 control-label" for="txtcodigo"></label>
							<div class="col-md-6">
								<div class="input-group">
...
{ 
  let tipo = "2";
  let tip_nom = $("#codtip").val();
  //if (tipo === tip_nom)
  //{
    $("#bt_filtra").show();
	$.get("../paginas/ajax/obtenerPlanillaCerrada.php",{tipo:tip_nom},function(res)
    {
        $("#id_nomina").empty();
