				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								COMPROBANTE CONTABLE / DISTRIBUCIÓN OTROS BENEFICIOS - OPERATIVOS
							</div>
							<div class="actions">
...
$(document).ready(function()
{
	...
	$("#btn-exportar").click(function(){
        ...
        location.href ="peachtree_contable_distribucion_beneficios_centro_costo_csv.php?anio="+anio+"&mes="+mes+"&fecha_inicio="+fecha_inicio+"&fecha_fin="+fecha_fin;
	});
