...
$query1      ="SELECT * FROM emision_col_configuracion "
...
if ($op_tp == 2) 
{
    ...
    while ( $inputs = mysqli_fetch_array($result2) ) {
        ...
        $q = "UPDATE emision_col_configuracion set conceptos ='$conceptos' $add_update WHERE id_configuracion=$id";
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          ...
          <div class="portlet box blue">
            ...
            <form action="configuracion.php" enctype="multipart/form-data" method="post" name="frmEmpresas" id="frmEmpresas" role="form">
