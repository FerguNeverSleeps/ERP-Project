          ...
          <div class="portlet box blue">
            ...
            <form action="" enctype="multipart/form-data" method="post" name="formParametros" id="formParametros" role="form">
                ...
                <div class="form-body">
                    ...
                    <div class="row">  
                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                            <label for="txtnombre">Ambiente:</label>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                            <input class="form-control" name="ambiente" type="text" id="ambiente" value="<?php echo $ambiente; ?>">
                        </div>       
                    </div>
                    <BR>
                    <div class="row">  
                   ...
                   <div class="row">
                        ...
                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">                            
                                 ...
                                 <button type="button" class="btn green active" id="guardar" onClick="Enviar(); document.formParametros.submit();">Guardar</button>
                        </div>                    
