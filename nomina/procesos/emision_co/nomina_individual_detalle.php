...
$consulta_tabla= "SELECT a.*, b.*,c.* , COALESCE(c.esvalidoDIAN ,0 ) esvalido_DIAN
                    ...
                    WHERE a.id_cabecera='$id_cabecera'  AND c.id_detalle_response is not null and b.id_detalle_request not in (32)
                  ...
                  <tbody style="font-size: 12px; ">                    
                      <?php
                          ...
                          while ($fila_tabla=fetch_array($resultado_tabla,$conexion))
                          {
                            ...
                            $folder_xml = "./xml/";
                            $archivo_xml = $folder_xml.$fila_tabla['codigo'].".xml";

                            $data_cune = "";
                            
                            $esValidoDian = $fila_tabla["esvalido_DIAN"];
                            ...
                            if($esValidoDian == 0){
                              ...
                              if($api_mensaje_result["IsValid"] == true){
                                ...
                                {
                                  $pdf = $data["xml_base64_bytes"];
                                  $base_xml = base64_decode($pdf);
                                  file_put_contents($archivo_xml, $base_xml);
                                }
                            ...
                            $data_response[]=[
                              ...
                              "reglasRechazoDIAN"               => td_decode($reglasRechazoDIAN),
                          ...
                          ?>
                            <tr id="<?php echo $fila_tabla['id_detalle_request'];?>" style="<?php print $add_cls;?>">
                              ...
                              <td style="text-align: right;"><?php echo number_format($fila_tabla['totalComprobante'],2,".",""); ?></td>
                              ...
                              <td>
                                <div align="center">
                                    <font size="2" face="Arial, Helvetica, sans-serif">
                                        ...
                                        if($esValidoDian==1):
                                          ?>
                                        <a target="_blank" href="https://catalogo-vpfe.dian.gov.co/document/searchqr?documentkey=<?php echo $cune; ?>" title="DIAN"><img src="../../../includes/imagenes/icons/favicon_dian.ico" width="16" height="16"></a>
                                        &nbsp;
                                        <a target="_blank" href="<?= $archivo ?>" title="PDF"><img src="../../../includes/imagenes/icons/bar-code-16.png" width="16" height="16"></a>
                                        <?php else: ?>
                                        <a onclick="reenviar(<?php echo $fila_tabla['id_cabecera'] ?>,<?php echo $fila_tabla['id_detalle_request'] ?>);"><i class="fa fa-refresh"></i></a>
...
function reenviar(id_cabecera, id_detalle){
    ...
    datos.append("reenviarNominaIndividual","yes");
    datos.append("id_cabecera",id_cabecera);
    ...
    $.ajax({
        ...
        success: function(respuesta){
            ...
            alert("Nomina reenviada con éxito");
            $("#modal_ver").modal("hide");
            location.href = "nomina_individual_detalle.php?id_cabecera="+id_cabecera;
        }
    });
}
