				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								Importar Salarios mínimos desde Excel
							</div>
						</div>
						<div class="portlet-body form" id="blockui_portlet_body">

							<form action="xls_salarios_minimos.php" class="form-horizontal" id="form_excel" name="form_excel" method="post" enctype="multipart/form-data">
								<div class="form-body">
