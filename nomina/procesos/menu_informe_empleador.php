        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue">
            <div class="portlet-title">
                ...
                <div class="actions">
                      <a class="btn btn-sm blue"  onclick="javascript: window.location='menu_informes.php?modulo=395';">
            ...
            <div class="portlet-body">
              <div class="row">
                ...
                <div class="col-md-2 text-center">
                    <a href="config_informe_empresas.php">
                    <div class="tile bg-blue">
                      <div class="tile-body">
                      <i class="fa fa-cog"></i>
                          <h5>ARCHIVO PATRONO</h5>                            
                      </div>
                    </div>
                  </a>
                </div>
                ...
                <div class="col-md-2 text-center">
                    <a href="config_informe_empleados.php">
                    <div class="tile bg-blue">
                      <div class="tile-body">
                      <i class="fa fa-cog"></i>
                          <h5>ARCHIVO EMPLEADOS</h5>                            
                      </div>
                    </div>
                  </a>
                </div>
