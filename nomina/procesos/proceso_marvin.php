						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab_0">
								...
								<?php								
									...
									{ 	
									?>
										<tr class="odd gradeX" id="num" opcion="<?php echo $fila['id'];?>">
											...
											<?php
												...
												?>
													...
													<a href="proceso_marvin_editar.php?id=<?php echo $fila['id']; ?>" title="Editar">
													<img src="../../includes/imagenes/icons/pencil.png" width="16" height="16"></a>
													</td>
													
													<td style="text-align: center; width: 22px !important">
														<a href="proceso_marvin_eliminar.php?id=<?php echo $fila['id']; ?>" title="Eliminar">
							...
							<form action="" method="post" name="frmPrincipal2" id="frmPrincipal2">
								...
								<?php								
									...
									{ 	
									?>
										<tr class="odd gradeX" id="num" opcion="<?php echo $fila2['id'];?>">
											<td><?php echo $fila2['id'];?></td>
											<td><?php echo $fila2['fecha'];?></td>
											<td><?php echo $fila2['fecha_inicio'];?></td>
											...
											<?php
												...
												?>
													<td style="text-align: center; width: 22px !important">
													<a href="proceso_marvin_editar.php?id=<?php echo $fila2['id']; ?>" title="Editar">
													<img src="../../includes/imagenes/icons/pencil.png" width="16" height="16"></a>
													</td>
													
													<td style="text-align: center; width: 22px !important">
														<a href="proceso_marvin_eliminar.php?id=<?php echo $fila2['id']; ?>" title="Eliminar">
														<img src="../imagenes/delete.gif" alt="Eliminar" width="16" height="16"></a>
													</td>
												<?php
												}
