				...
				<div class="col-md-9">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								Importar Salarios Acumulados desde Excel
							</div>
						</div>
						<div class="portlet-body form" id="blockui_portlet_body">

							<form action="xls_salarios_acumulados.php" class="form-horizontal" id="form_excel" name="form_excel" method="post" enctype="multipart/form-data">
								<div class="form-body">
...
$(document).ready(function(){
	...
	$("#btn-exportar").click(function(){
		location.href = "../../plantillas/Plantilla_Importar_Salarios_Acumulados.xlsx";
	});
	...
	$("#btn-cargar").click(function(){
        ...
        $.ajax({
        	url:  'xls_salarios_acumulados.php',
        	type: 'POST',
        	data: formData,
        	contentType: false,
   		    processData: false,
