...
//                exit;
        ...
        {	
                ...
                if($codcon==100 || $codcon==103 || $codcon==169 || $codcon==170 || $codcon==171  || $codcon==177 || $codcon==178 || $codcon==604)
                {                               
...
//                                     $deducciones=$deducciones+$suma;
        ...
        if($bandera==1)
        {
            //Aquí se genera el total del salario
            //echo "A$pos", $fechapago.","."0001"."#333".$codcon_salario."-".$fechapago.",".",".$cont.",".$ctacon_salario.",".$cuenta_contable_salario.",".number_format($salario, 2, '.', '').","."".","."FALSE".","."23".","."8".","."FALSE".","."0".","."0"."";exit;
...
//                                    $deducciones=$deducciones+$suma;
                 ...
                 if($codcon!=100 && $codcon!=103 && $codcon!=169 && $codcon!=170 && $codcon!=171  && $codcon!=178 && $codcon!=604
                   && $codcon!=184 && $codcon!=185 && $codcon!=187 && $codcon!=190 && $codcon!=198 && $codcon!=199)
                {
                    $i++;
                }
