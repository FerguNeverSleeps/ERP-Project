				...
				<div class="col-md-9">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body form" id="blockui_portlet_body">
							...
							<form action="proceso_marvin_importar.php" class="form-horizontal" id="form_excel" name="form_excel" method="post" enctype="multipart/form-data">
								<div class="form-body">
									...
									<div class="form-group" style="margin-top: 20px">
										<label class="control-label col-md-2">Archivo Marvin (Estandar):</label>
										<div class="col-md-9">
									...
									<div class="form-actions fluid">
										<div class="row">
													...
													<button type="button" class="btn blue active" id="btn-cargar" name="btn-cargar"><i class="fa fa-upload"></i>&nbsp;Procesar</button>
											</div>
											<div class="col-md-offset-3 col-md-3">
...
$(document).ready(function(){
	...
	$("#btn-exportar").click(function(){
		location.href = "../../plantillas/FormatoExportacionEstandar.txt";
	});
	...
	$("#btn-cargar").click(function(){
        ...
        $.ajax({
        	url:  'proceso_marvin_importar.php',
        	type: 'POST',
        	data: formData,
        	contentType: false,
   		    processData: false,
