...
$sql1 = "select * from config_reportes_planilla where id = 11";
...
if(!isset($configReporte['id'])){
	print "config_reportes_planilla id=11 no encontrado (el comprobante depende del query definido en id=11)";
	exit;
}
...
//print_r($data);exit;
//NOTA - OBSERVACION 
//REALIZAR ACA LAS MISMA OPERACION QUE SE HACEN EN EL EXCEL DEL REPORTE ID=11 PARA EL CALCULO DEL TOTAL
$monto_total=0;
...
$objPHPExcel->getProperties()->setCreator("AMAXONIA")
							 ...
							 ->setTitle("Comprobante Otros Beneficios Administrativo");
...
//	$sheet->setCellValue("F{$ln}", "");
	...
	$objPHPExcel->getActiveSheet()->setCellValueExplicit("A$ln", $ffecha.","."0001"."#333CXC - ".trim($row["descrip"],"- ")."-".$ffecha.",".",".$cont.",".$row["ctacon"].",".trim($row["descrip"],"- ").",".$monto.","."".","."FALSE".","."23".","."8".","."FALSE".","."0".","."0"."", PHPExcel_Cell_DataType::TYPE_STRING);
	$ln++;
}
...
$filename = "peachtree-sage-csv_distribucion_beneficios_administrativo_".$anio."_".$mes;
...
//	$sheet->setCellValue("F{$ln}", "");
	...
	$objPHPExcel->getActiveSheet()->setCellValueExplicit("A$ln", $ffecha.","."0001"."#333GASTO POR REEMBOLSO - ".$centro_costo[$i]["descrip"]."-".$ffecha.",".",".$cont.",".$ctacon_detalle_debito.",".$ctacon_detalle_debito_descrip.",".$centro_costo[$i]["monto"].","."".","."FALSE".","."23".","."8".","."FALSE".","."0".","."0"."", PHPExcel_Cell_DataType::TYPE_STRING);
        $ln++;
...
//	$sheet->setCellValue("F{$ln}", $centro_costo[$i]["monto"]);	
	...
	$objPHPExcel->getActiveSheet()->setCellValueExplicit("A$ln", $ffecha.","."0001"."#333CXP - ".$centro_costo[$i]["descrip"]."-".$ffecha.",".",".$cont.",".$ctacon_detalle_credito.",".$ctacon_detalle_credito_descrip.",".(-1)*$centro_costo[$i]["monto"].","."".","."FALSE".","."23".","."8".","."FALSE".","."0".","."0"."", PHPExcel_Cell_DataType::TYPE_STRING);
