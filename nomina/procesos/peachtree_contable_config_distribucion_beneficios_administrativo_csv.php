				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								COMPROBANTE CONTABLE / DISTRIBUCIÓN OTROS BENEFICIOS - ADMINISTRATIVOS
							</div>
							<div class="actions">
								<a class="btn btn-sm blue"  onclick="javascript: window.location='peachtree_contable_menu.php';">
						...
						<div class="portlet-body form" id="blockui_portlet_body">
							...
							<form class="form-horizontal" id="form_reporte" name="form_reporte" method="post">
								<div class="row">&nbsp;</div>
								<div class="row">
...
$(document).ready(function()
{
	...
	$("#btn-exportar").click(function(){
        ...
        location.href ="peachtree_contable_distribucion_beneficios_administrativo_csv.php?anio="+anio+"&mes="+mes+"&fecha_inicio="+fecha_inicio+"&fecha_fin="+fecha_fin;
	});
