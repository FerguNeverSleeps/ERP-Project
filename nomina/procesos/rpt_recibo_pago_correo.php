...
<tr>
<td align='left' valign='top'><img src='http://localhost/pyme/nomina/imagenes/".$var_imagen_izq."' alt='Sisalud' width='100' height='70' /></td>
<td><p align='left'><strong>ASys C.A.</strong></p></td>
</tr>
</table>";
...
if($email!='')
{
	$nombre_origen    = "RRHH ASYS";
	$email_origen     = "jmpulgar@asys.com.ve";
	$email_copia      = "jmpulgar@asys.com.ve";
	$email_ocultos    = "jmpulgar@asys.com.ve";
	$email_destino    = $email;
