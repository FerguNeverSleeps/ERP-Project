...
where nnn.codnom='".$_GET['codigo_nomina']."' and nnn.tipnom='".$_SESSION['codigo_nomina']."' and nnn.codcon='".$_GET['concepto']."' 
group by nnn.codnom,nnn.tipnom,nnn.codcon";
...
readfile($ruta); 
header('Content-Disposition: attachment; filename="GASTOS.txt"');
