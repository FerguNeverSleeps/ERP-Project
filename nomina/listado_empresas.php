...
<body class="fondo" style='background:white; -moz-border-radius:20px'>
...
<td height="12" id="<?echo $fila['codigo']?>"  onclick="seleccionar(this.id)"><div align="left"><span><?echo $fila['nombre']?></span></div></td>
</tr>
<?}
