...
class MYPDF extends TCPDF {
	...
	public function Header() 
	{
		...
		$YMax              =260;
		$altura            =21;
		$membrete          ="<br><b>".$var_encabezado1."<br>Planilla de Vacaciones <br> Periodo desde ".$this->CambiarFecha($fechames11)." hasta ".$this->CambiarFecha($cabecera['periodo_fin'])."</b>";
	...
	public function CuerpoTablaHtml()
	{
		...
		$this->Cell(27,5,utf8_decode('CEDULA'),1,0);
		...
		$this->Cell(30,5,utf8_decode($rc['des_car']),0,0);

	
		$this->Cell(30,5,utf8_decode($fechavac),0,0);
		$this->Cell(30,5,utf8_decode($fechareivac),0,0);
