...
pBuscarProveedores.main = {
    ...
    init:function(){
        ...
        this.gridProveedoress = new Ext.grid.GridPanel({
            ...
            columns:[
                ...
                {header:'', hidden:true, width:150, sortable: true, menuDisabled:true, dataIndex:'id'},
                {header:'Código', width:150, sortable: true, menuDisabled:true, dataIndex:'codigo'},
                {header:'Nombre', width:400, sortable: true, menuDisabled:true, dataIndex:'descripcion'}
            ],
    ...
    limpiarFiltroProveedores:function(){
        ...
        pBuscarProveedores.main.storeProveedoress.baseParams.opt = 'caja_egreso_persona_terceros';
    ...
    getLista: function(){
        this.store = new Ext.data.JsonStore({
            ...
            params:{
                opt:'caja_egreso_persona_terceros'
            },
            root:'data',
            fields:[
                { name: 'id'},
