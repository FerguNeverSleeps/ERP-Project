        ...
        if (data.productoSeleccionado.cod_item_forma == "1") { // Si es un Producto
            $.ajax({
                ...
                complete: function(xhr){
                    ...
                    html += "<td style='text-align: right; padding-right: 20px;' class='cantidad_bultos_totales' rel='"+cantidad_bultos_totales+"' id='td_cantidad_bulto_tot"+codigo+"'>"+cantidad_bultos_totales+"</td>";
