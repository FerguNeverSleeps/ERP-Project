$(function(){
    ...
    $.totalizarFactura = function(){
        ...
        if(listo==false){
            ...
            total_ = (parseFloat(tmp_subtotal)+parseFloat(tmp_iva))-parseFloat(tmp_descuento);
             
            totalizar_total_general = redondear_monto(total_);
            $("#totalizar_total_general").val(totalizar_total_general);
            //alert("TOTALIZANDO!!"+totalizar_total_general);
            //$("input[name='totalizar_monto_cancelar']").val($("input[name='totalizar_total_general']").val());
            $("#monto_total_pagar_2").val(totalizar_total_general);
            $("#monto_total_pagar").val(totalizar_total_general);
            //$("#monto_total_saldo_restante").val(totalizar_total_general);
    ...
    var selectores = "input[name='totalizar_monto_efectivo'], input[name='totalizar_monto_cheque'], input[name='totalizar_nro_cheque'], input[name='totalizar_monto_tarjeta'], input[name='totalizar_nro_tarjeta'],input[name='totalizar_monto_deposito'], input[name='totalizar_nro_deposito']";
    $(document).delegate(selectores, "change", function(){
        valor = $(this).val();
        if(valor==""){
            $(this).val("0");
            return false;
