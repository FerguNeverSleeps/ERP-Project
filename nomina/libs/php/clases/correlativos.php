    ...
    function getUltimoCorrelativo($campo, $increment = 0, $formatear = "no", $cadena = "") {
        ...
        switch ($campo) {
            ...
            case "cod_devolucion": $c = "cod_devolucion";
              break;
            case "cod_caja_ingr_cobranza": $c = "cod_caja_ingr_cobranza";
              break;            
            case "caja_secuencia_cheque": $c = "caja_secuencia_cheque";
              break;
            case "cod_ccheques": $c = "cod_ccheques";
              break;
            case "cod_egresos_pago_proveedores": $c = "cod_egresos_pago_proveedores";
              break;
            case "cod_oingresos": $c = "cod_oingresos";
              break;
            case "cod_ingr_mercancia_stock": $c = "cod_ingr_mercancia_stock";
              break;
            case "cod_caja_egreso_otros": $c = "cod_caja_egreso_otros";
              break;
            case "cod_factura_concepto" : $c = "cod_factura_concepto";
              break;
            case "cod_factura_detal": $c = "cod_factura_detal";
              break;
            default: $c = -1;
              break;
        }
