  ...
  SELECT
    ...
    ";
        ...
        <span style='color:red;padding-left:30px;'><img src=\"../../libs/imagenes/ico_note.gif\"> Consulta SQL: " . $sql . "</span><br>
            ...
            $pagina .= "<hr><br><br><a style=\"text-decoration:none;\" href='?iframe&opt_menu=" . $_GET["opt_menu"] . "&opt_seccion=" . $_GET["opt_seccion"] . "'><img style=\"border:none;\" src=\"../../libs/imagenes/ico_back.gif\"> Volver</a>";
            $pagina .= "</div>";
            $pagina .= "</body>";
            $pagina .= "</html>";
    ...
    function connectDb(){
        return $this->db->Connect(SERVIDOR, USUARIO, CLAVE, BASEDEDATOS);
    }
