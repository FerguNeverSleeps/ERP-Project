...
$SQL = "SELECT a.id, c.Denominacion, c.CodCue,a.MontoInicial,a.Comprometido,a.Disponible,a.anio,a.Enero,a.Febrero,a.Marzo,
a.Abril,a.Mayo,a.Junio,a.Julio,a.Agosto,a.Septiembre,a.Octubre,a.Noviembre,a.Diciembre, c.id as id_cue, c.Denominacion, c.CodCue
FROM  presupuesto as a, nomnivel".$nivel." as b, cwprecue as c 
where a.id_cuenta=c.id and a.id_nomnivel=b.codorg and a.id=".$id;
//echo $sql,"<br>";
				...
				<!-- BEGIN EXAMPLE TABLE PORTLET-->
					<div class="portlet box blue">
						<div class="portlet-title">
							...
							<div class="actions">
								<?php 
								echo '<a class="btn btn-sm blue"  href="presupuesto_cuentas_add.php?codigo='.$codigo.'">'; ?>
						...
						<div class="portlet-body">
							<div class="row">
								<div class="form-group">
									...
									?>
										...
										<?php 
										echo "<option value='".$fila["id_cue"]."'>".$fila["CodCue"]." ".$fila["Denominacion"]."</option>";
										
										while($filas=mysqli_fetch_array($resultado)){
										echo "<option value='".$filas["id"]."'>".$filas["CodCue"]." ".$filas["Denominacion"]."</option>";}
										?>
										</select>
									</div>
								</div>
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-3">
										<input name="anio" id="anio" type="text" class="text-right" value="<?php echo $fila[anio];?>">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-9">
									<input class="text-right" id="monto_inicial" value="<?php echo $fila[MontoInicial];?>">
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-9">
									<input class="text-right" id="Enero" value="<?php echo $fila[Enero];?>">
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-9">
									<input class="text-right" id="Febrero" value="<?php echo $fila[Febrero];?>">
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-9">
									<input class="text-right" id="Marzo" value="<?php echo $fila[Marzo];?>">
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-9">
									<input class="text-right" id="Abril" value="<?php echo $fila[Abril];?>">
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-9">
									<input class="text-right" id="Mayo" value="<?php echo $fila[Mayo];?>">
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-9">
									<input class="text-right" id="Junio" value="<?php echo $fila[Junio];?>">
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-9">
									<input class="text-right" id="Julio" value="<?php echo $fila[Julio];?>">
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-9">
									<input class="text-right" id="Agosto" value="<?php echo $fila[Agosto];?>">
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-9">
									<input class="text-right" id="Septiembre" value="<?php echo $fila[Septiembre];?>">
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-9">
									<input class="text-right" id="Octubre" value="<?php echo $fila[Octubre];?>">
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-9">
									<input class="text-right" id="Noviembre" value="<?php echo $fila[Noviembre];?>">
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-9">
									<input class="text-right" id="Diciembre" value="<?php echo $fila[Diciembre];?>">
							...
							<div>
								<div class="form-actions text-center">
									<a id="sig1" class="btn blue button-next">MODIFICAR</a>
								</div>
							</div>
						</div>
					</div>
...
window.scrollTo(0,0);
   ...
   $("#sig1").on("click", function()
   {
		...
		{
			location.href="presupuestar_edit.php?id="+id+"&cuenta="+cuenta+"&monto_inicial="+monto_inicial+"&Enero="+Enero+"&Febrero="+Febrero+"&Marzo="+Marzo+
			"&Abril="+Abril+"&Mayo="+Mayo+"&Junio="+Junio+"&Julio="+Julio+"&Agosto="+Agosto+"&Septiembre="+Septiembre+"&Octubre="+Octubre+
			"&Noviembre="+Noviembre+"&Diciembre="+Diciembre+"&anio="+anio+"&codigo="+codigo;
		}
   });
