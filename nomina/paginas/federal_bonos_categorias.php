...
if($_REQUEST["accion"]=="ajax"):
    ...
    $sql="select * from `federal_bonos_categorias` WHERE $add ";
    $return=[];
    $return["aaData"]=[];
              ...
              <table class="table table-striped table-bordered table-hover" id="table_datatable">
                <thead>
                  ...
                  <tr role="row" class="filter" style="background: white;">
                    ...
                    <td><input type="text" class="form-control form-filter input-sm" id="buscar_Tipo"></td>
                    <td><input type="text" class="form-control form-filter input-sm" id="buscar_Descripcion">
