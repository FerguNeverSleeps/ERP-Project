...
function horizontal_nomina_xls()
{
	...
	if(codnom==''){
		...
		//location.href='horizontal_nomina_xls_resumido.php?codnom='+codnom+'&codtip='+codtip; 
		location.href='horizontal_nomina_xls_resumido_nuevo.php?codnom='+codnom+'&codtip='+codtip; 
	}
