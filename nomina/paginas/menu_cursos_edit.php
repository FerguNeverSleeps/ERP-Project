						...
						<div class="portlet-body">
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-6">
										<input type="text" id="codigo_curso" class="form-control" value="<?php echo  utf8_encode($fila[cod_curso]); ?>">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-6">
										<input type="text" id="capitulos_curso" class="form-control" value="<?php echo  utf8_encode($fila[capitulo_curso]); ?>">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-6">
										<input type="text" id="area_curso" class="form-control" value="<?php echo  utf8_encode($fila[area_curso]); ?>">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-6">
										<input type="text" id="cliente_curso" class="form-control" value="<?php echo  utf8_encode($fila[id_cliente_curso]); ?>">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-6">
										<input type="text" id="modulo_curso" class="form-control" value="<?php echo  utf8_encode($fila[modulo_curso]); ?>">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-6">
										<input id="duracion_curso" type="text" class="form-control form-control-inline input-medium" value="<?php echo $fila[duracion_curso]; ?>"> horas
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-6">
										<input id="teorica_curso" type="text" class="form-control form-control-inline input-medium" value="<?php echo $fila[duracion_teorica_curso]; ?>"> horas
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-6">
										<input id="practica_curso" type="text" class="form-control form-control-inline input-medium" value="<?php echo $duracion_practica_curso; ?>"> horas
									</div>
								</div>
							</div>
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-6">
										<textarea class="form-control" id="estrategia_curso" cols="3"><?php echo  utf8_encode($fila[estrategia_curso]); ?></textarea>
									</div>
								</div>
							</div>	
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-6">
										<input type="text" id="instructor_curso" class="form-control" value="<?php echo  utf8_encode($fila[instructor_curso]); ?>">
									</div>
								</div>
							</div>
