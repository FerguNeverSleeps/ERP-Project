...

{
    ...
    if ($seleccion==1){
            ...
            ///activar_pagina("seleccionar_nomina2.php");
    }
    //echo "nomina: ".$_SESSION['codigo_nomina']." - ".$_SESSION['nomina'];exit;
        $bValidPwd = false;
        ...
        $result = $sSql->query("select bd_nomina,bd_contabilidad,nombre nom_emp from ".$config['bdnombre'].".nomempresa where bd_nomina = '".$_SESSION['bd_nomina']."'");
...
<link href="../../includes/assets/css/fonts-metronic.css" rel="stylesheet" type="text/css"/>
...
function VerificarSeleccion()
{
    ...
    else
    {
        ...
        document.location.href = "seleccionar_nomina2.php?parentreload&seleccion_nomina="+seleccion_nomina+"&opt="+opt;
    }
}
<?php if(isset($_GET['parentreload'])){ ?>
    parent.recarga();
<?php } ?>
</script>
</body>
