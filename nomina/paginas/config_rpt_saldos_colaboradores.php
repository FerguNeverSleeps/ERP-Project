				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<?php echo $_SESSION["nomina"].' '; ?> - SALDOS DE COLABORADORES DE CUENTAS POR COBRAR
							</div>
							<div class="actions">
						...
						<div class="portlet-body form" id="blockui_portlet_body">
							...
							<form class="form-horizontal" id="formulario" name="formulario" method="post">
								...
								<div class="row">
									<div class="form-group">
										<label class="text-right col-xs-offset-1 col-xs-3 col-sm-offset-1 col-sm-3 col-md-offset-1 col-md-3 col-lg-offset-1 col-lg-3 control-label">Saldo a la Fecha:</label>
                                        <div class="col-md-3">
                                            <div class="input-group date date-picker" data-provide="datepicker" data-date-end-date="0d" data-date-format="dd/mm/yyyy"> 
								...
								<div class="row">
									<div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                        	...
                                        	<?php
														$sql = "select sql_reporte from config_reportes_planilla where id=9";	
														$res = $db->query($sql);
														...
														if(isset($sql_reporte->sql_reporte)){
															...
															print "config_reportes_planilla id=9 no encontrado";
														}
													?>
...
$(document).ready(function()
{
	...
	$("#btn-exportar").click(function(){
        ...
        location.href ="rpt_saldo_colaboradores.php?anio="+anio+"&mes="+mes+"&fecha_inicio="+fecha_inicio+"&fecha_fin="+fecha_fin+"&codcon="+codcon+"&nomnivel1="+nomnivel1;
	});
