...
{ 
  ...
  $strsql= "SELECT * FROM nominstruccion ORDER BY codigo,descripcion";
        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue">
            <div class="portlet-title">
              ...
              <div class="actions">
                <a class="btn btn-sm blue"  onclick="javascript: window.location='ag_instruccion.php'">
            ...
            <div class="portlet-body">
              ...
              <tr>
                <th>C&oacute;digo</th>
                <th>Descripci&oacute;n del grado de instrucci&oacute;n</th>
                <th>&nbsp;</th>
                <th>&nbsp;</th>
              </tr>
              </thead>
