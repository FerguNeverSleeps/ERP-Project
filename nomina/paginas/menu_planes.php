				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							...
							<div class="actions">
								<a class="btn btn-sm blue"  onclick="javascript: window.location='planes_list.php'">
						...
						<div class="portlet-body">
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-6">
										<input type="text" id="codigo_plan" class="form-control" placeholder="Código...">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-6">
										<input type="text" id="capitulo_plan" class="form-control" placeholder="Capitulo...">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-6">
										<input type="text" id="modulo_plan" class="form-control" placeholder="Módulo...">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-6">
										<input type="text" id="duracion_plan" class="form-control" placeholder="Duración...">
									</div>
								</div>
							</div>
							<div class="row">
...
window.scrollTo(0,0);
   ...
   $("#sig1").on("click", function()
   {
		...
		{
			location.href="poblacion_entrenamiento_add.php?id="+id+"&codigo_plan="+codigo_plan+"&capitulo_plan="+capitulo_plan+"&modulo_plan="+modulo_plan+"&id_plan_dist="+id_plan_dist;
