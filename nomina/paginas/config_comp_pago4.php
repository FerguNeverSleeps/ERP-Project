...
function Recibos()
{
    AbrirVentana('../fpdf/reportes/recibos_federal.php?nomina_id='+document.form1.cboTipoNomina.value+'&codt='+document.form1.codt.value,660,800,0);
}
</script>
				...
				<div class=" col-md-offset-2 col-md-8">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								Reporte Recibos de Pago Planilla
							</div>
							<div class="actions">
						...
						<div class="portlet-body">
							<div class="row"><br>
		                        <div class="col-md-3 text-right">Planilla
		                        </div>   
...
include ("../footer4.php");
 ...
 $(document).ready(function()
 {
	 ...
	 $("#buscar").on('click',function(){
		 ...
		 {
			 var url = "../fpdf/reportes/recibos_federal.php?nomina_id="+document.form1.cboTipoNomina.value+"&codt="+document.form1.codt.value+"&ficha_buscar="+ficha_buscar;
			 window.open(url);
		 }
		 else
		 {
