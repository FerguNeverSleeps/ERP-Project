...
$result = "";
$strsql= "SELECT nompersonal.apenom, nompersonal.cedula, nompersonal.ficha, nom_control_marcaciones.*
        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue">
            ...
            <div class="portlet-body">
                <form action="" method="post" name="frmPrincipal" id="frmPrincipal" target="_self">
                    <div class="row">
                        <div class="col-md-10">                        
                    ...
                    if($result)
                    {
                      ...
                      ?>
                            <tr class="odd gradeX">
                                <td><?php echo $fila['id_control_marcaciones']; ?></td>
                                <td><?php echo $fila['cedula']; ?></td>
                                <td><?php echo $fila['id_millenium']; ?></td>
                                <td><?php echo $fila['apenom']; ?></td>
                                <td><?php echo $fila['fecha']; ?></td>
                                <td><?php echo $fila['horas_trabajadas']; ?></td>
                                <td><?php echo $fila['horas_extras']; ?></td>
                                <td><?php echo $fila['tipo_dia']; ?></td>
                            </tr>
                        <?php                 
                        }
                    }
...
{ 
    ...
    $.get("ajax/getEmpleadosListAsistencia.php",function(res)
    {
...
//    alert(fecha_fin);
//    alert(fecha_inicio);
   window.open("../../reportes/excel/excel_relacion_marcaciones_control.php?id_empleado="+id_empleado+"&fecha_fin="+fecha_fin+"&fecha_inicio="+fecha_inicio,'_blank');
   $("#frmPrincipal").submit();
  return false;
