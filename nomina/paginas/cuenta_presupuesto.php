...
{	
	$query  = "DELETE FROM cwprecue WHERE id=$registro_id";			
	$result = sql_ejecutar($query);
	activar_pagina("cuenta_presupuesto.php");		 
}   
$sql = "SELECT id, CodCue, Denominacion FROM cwprecue";
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								Cat&aacute;logo Cuentas Presupuestaria
							</div>
							<div class="actions">
								<a class="btn btn-sm blue"  onclick="javascript: window.location='ag_cuenta_presupuesto.php'">
						...
						<div class="portlet-body">
							...
							<?php
								...
								?>
									<tr class="odd gradeX">
										<td><?php echo $fila['CodCue']; ?></td>
										<td><?php echo $fila['Denominacion']; ?></td>
										<td style="text-align: center">
									      <a href="ag_cuenta_presupuesto.php?edit&id=<?php echo $fila['id']; ?>" title="Editar">
