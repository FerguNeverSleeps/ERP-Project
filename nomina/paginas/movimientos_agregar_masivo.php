							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="input-group">
										<input type="text" name="ficha" id="ficha" class="form-control input-sm" onblur="cargar_nombre();" placeholder="Buscar colaborador">
										<span class="input-group-addon">
											<i class="fa fa-search"></i>
										</span>
									</div>
								</div>
								<div class="col-md-3"><div id="nombre"></div></div>
							</div>
							<div class="row">
								<div class="col-md-2">Concepto</div>
								<div class="col-md-3">
								<div class="input-group">
										<input type="text" name="codcon" id="codcon" class="form-control input-sm" onblur="cargar_concepto();" placeholder="Buscar concepto">
										<span class="input-group-addon">
											<i class="fa fa-search"></i>
										</span>
									</div>
								</div>
								<div class="col-md-3"><div id="concepto"></div></div>
							</div>
							<div class="row">
								<div class="col-md-2">
									Valor
