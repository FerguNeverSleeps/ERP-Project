...
ORDER BY a.ficha,a.fecha DESC") or die(mysqli_error($conexion));
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-sm blue" href="procesar_registros.php">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="table_datatable">
                        <thead>
                            <tr>
                                ...
                                <th>Ausencia</th>
                                <th>H. Ausencia</th>
                                <!--<th>Con Aprobacion</th>
                                <th>Sin Aprobacion</th>-->
                                <th>Estado</th>
                                <th>Opciones</th>
                            </tr>
                        </thead>
                        ...
                        <?php $i=0;while ($fila = mysqli_fetch_array($datos)){ ?>
                        	<tr>
                                <?php /*
                                $aprobado = "";
                                $aprobado .= ( ($fila['aprob_tar'] == 1) && ($fila['tardanza'] !="00:00:00") ) ? "Tar " : "";
                                $aprobado .= ( ($fila['aprob_ext'] == 1) && ($fila['h_extra'] !="00:00:00") ) ? "Ext " : "";
                                $aprobado .= ( ($fila['aprob_25'] == 1) && ($fila['recargo_25'] !="00:00:00") ) ? "Reg 25 " : "";
                                $aprobado .= ( ($fila['aprob_50'] == 1) && ($fila['recargo_50'] !="00:00:00") ) ? "Reg 50" : "";
                                $falta_probar = "";
                                $falta_probar .= ( ($fila['aprob_tar'] == 0) && ($fila['tardanza'] !="00:00:00") ) ? "Tar " : "";
                                $falta_probar .= ( ($fila['aprob_ext'] == 0) && ($fila['h_extra'] !="00:00:00") ) ? "Ext " : "";
                                $falta_probar .= ( ($fila['aprob_25'] == 0) && ($fila['recargo_25'] !="00:00:00") ) ? "Reg 25 " : "";
                                $falta_probar .= ( ($fila['aprob_50'] == 0) && ($fila['recargo_50'] !="00:00:00") ) ? "Reg 50" : "";*/
                                ?>
                                <td><?php echo $i+1; ?></td>
                                ...
                                <td><?php echo ($fila['h_ausencia'] !="00:00:00")? "<strong>".$fila['h_ausencia']."</strong>":$fila['h_ausencia'] ; ?></td>
                                <!--<th><?php echo $aprobado;?></th>
                                <th><?php echo $falta_probar;?></th>-->
...
<script>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="mes" id="mes" class="form-control">
                            ...
                            <option value="2017-01-15">Enero</option>
                            <option value="2017-02-15">Febrero</option>
                            <option value="2017-03-15">Marzo</option>
                            <option value="2017-04-15">Abril</option>
                            <option value="2017-05-15">Mayo</option>
                            <option value="2017-06-15">Junio</option>
                            <option value="2017-07-15">Julio</option>
                            <option value="2017-08-15">Agosto</option>
                            <option value="2017-09-15">Septiembre</option>
                            <option value="2017-10-15">Octubre</option>
                            <option value="2017-11-15">Noviembre</option>
                            <option value="2017-12-15">Diciembre</option>
                        </select>
                    </div>
                </div>
    ...
    $(document).ready(function(){
        ...
        $("#filtro").click(function(event){
            window.location.href = "resumen_asistencias.php?ficha="+$('#ficha').val()+"&&mes="+$('#mes').val();
        });
    });
    </script>