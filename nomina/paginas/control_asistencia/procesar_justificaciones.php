...
//--------------------------------------------------------
if ($nivel2 != "0") {
    $empleado = $conexion->query("SELECT * FROM nompersonal WHERE codnivel1 = '".$nivel1."' AND codnivel2 = '".$nivel2."' AND estado != 'Egresado' AND estado != 'De Baja' ORDER BY ficha ASC") or die(mysqli_error($conexion));
}else{
    $empleado = $conexion->query("SELECT * FROM nompersonal WHERE codnivel1 = '".$nivel1."' AND estado != 'Egresado' AND estado != 'De Baja' ORDER BY ficha ASC") or die(mysqli_error($conexion));
}
//--------------------------------------------------------
                    ...
                    <table class="table table-striped table-bordered table-hover" id="table_datatable">
                        ...
                        <?php $i=0;while ($fila = mysqli_fetch_array($empleado)){ ?>
                        	<tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="list_justificaciones.php?ficha=<?php echo $fila['ficha'] ?>" title="Justificar Incidencias">
