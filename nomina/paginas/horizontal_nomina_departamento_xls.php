...
$objPHPExcel->getActiveSheet()->setCellValue('P'.$letra_td.$i, $total_deducir);
...
header('Content-Disposition: attachment;filename="Reporte_Horizontal_PLANILLA_Departamentos.xls"');
