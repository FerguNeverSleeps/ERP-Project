    ...
    <tr>
      <td width="489" class="ewTableAltRow"><table width="454" border="0">
        <tr>
          ...
          <td width="110" align="center" valign="middle" ><div align="center"><a href="submenu_reportes.php?modulo=45"><img src="../img_sis/icons/3.png" alt="Niveles funcionales que posee su empresa" width="32" height="32" border="0" align="absmiddle" class="icon" /></a></div></td>
