...
$sql = "SELECT id, Cuenta, Descrip, id_interno, COALESCE(Tipo, '-') as Tipo FROM cwconcue";
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								Cat&aacute;logo Cuentas Contables
							</div>
							<div class="actions">
								<a class="btn btn-sm blue"  onclick="javascript: window.location='ag_cuenta_contable.php'">
								...
								?>
									...
									<td><?php echo $fila['Tipo']; ?></td>
										<td style="text-align: center">
									      <a href="ag_cuenta_contable.php?edit&id=<?php echo $fila['id']; ?>" title="Editar">
