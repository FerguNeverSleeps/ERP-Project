...
{ 
  $query  = "DELETE FROM tipos_faltas WHERE id='{$registro_id}'";      
  $result = sql_ejecutar($query);
  activar_pagina("tipos_faltas.php");   
}     
$strsql= "SELECT * FROM tipos_faltas";
...
function enviar(op,id){
  if (op==1){   // Opcion de Agregar
    ...
    document.frmPrincipal.action="ag_tipos_faltas.php";
        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue">
            <div class="portlet-title">
              ...
              <div class="actions">
                <a class="btn btn-sm blue"  onclick="javascript: window.location='ag_tipos_faltas.php'">
              ...
              <?php
                ...
                ?>
                  <tr class="odd gradeX">
                    ...
                    <td><?php echo $fila['numeral']; ?></td>
                    <td>
                        <?php 
                        $caracter="<br>";
                        $descrip = wordwrap($fila['descripcion'], 35, $caracter, false);
                        echo $descrip; ?>
                    </td>
