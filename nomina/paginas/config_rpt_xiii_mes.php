							...
							<form class="form-horizontal" id="form_excel" name="form_excel" method="post">
								<div class="form-body">
									<div class="form-group margin-top-20">
										<label class="col-md-2 control-label">Planilla de inicio</label>
										<div class="col-md-9">
											<?php 
												$sql = "SELECT codnom, descrip
														FROM   nom_nominas_pago 
														WHERE  frecuencia=3 AND MONTH(periodo_ini) IN (4, 8, 12)
...
$(document).ready(function(){
	...
	$("#btn-exportar").click(function(){
	    ...
	    $.post( "xls_reporte_xiii_mes.php", { codnom: codnom }, function(file) {
