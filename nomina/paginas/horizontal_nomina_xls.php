...
$sql = "SELECT DISTINCT nm.ficha, nm.cedula, np.apenom as nombre, np.suesal as sueldo
		FROM   nom_movimientos_nomina nm LEFT JOIN nompersonal np ON (nm.cedula=np.cedula and nm.ficha=np.ficha)
