						...
						<div class="portlet-body">
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="text" id="curso" class="form-control" placeholder="Nombre del curso...">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-9">
										<div class="input-group input-medium date  date-picker" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
											<input id="fecha" class="form-control form-control-inline input-medium" size="16" type="text" value="" readonly>
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="text" id="instructor" class="form-control" placeholder="Nombre del Instructor...">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-9">
										<textarea class="form-control" id="descripcion" cols="3" placeholder="Descripción del curso..."></textarea>
									</div>
								</div>
							</div>	
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-9">
										<input id="duracion" type="text" class="form-control form-control-inline input-medium" placeholder="Duración del curso..."> horas
									</div>
								</div>
							</div>
			...
			else
			{
				...
				{	
					...
					{	
						...
						{
							location.href="cursos_add.php?fecha="+fecha+"&curso="+curso+"&instructor="+instructor+"&descripcion="+descripcion+"&duracion="+duracion;
						}
					}
				}
			}
