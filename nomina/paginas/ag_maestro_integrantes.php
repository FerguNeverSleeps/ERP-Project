...
".(($_POST["cboTurno"]=="")?"NULL":"'".$_POST["cboTurno"]."'").",
'".$_POST['txtsegurosocial']."',
'".$_POST['txthorabase']."',
'".$_POST['txtsegurosocialsipe']."',
'".$_POST['txtdv']."')";
		//echo $query;exit;
        $result = sql_ejecutar($query);
...
<form action="ag_maestro_integrantes.php" method="post" name="frmAgregarIntegrantes" id="frmAgregarIntegrantes" enctype="multipart/form-data">
    ...
    <table align="left" width="700" border="0" class="">
        ...
        <tr >
            <td width="200"><font size="2" face="Arial, Helvetica, sans-serif">Apellidos: <font color ="#FF2D2D">(*)</font></td>
        ...
        <tr >
            ...
            <td ><font size="2" face="Arial, Helvetica, sans-serif">
                <input name="txtcedula" type="text" id="txtcedula" style="width:100px" value="<?= $_POST['txtcedula'] ?>" maxlength="20">
                </font></td>
        </tr>
        <tr>
 ...
 <input name="optNacionalidad" type="radio" value="2"
                       <?php if ($row[nacionalidad] == 2) { ?> checked= "true" <?php } ?>>
     ...
     <!--   <tr bgcolor="">
	  ...
	  Deposito F.A.L.</option>
        ...
        <tr bgcolor="">
            ...
            <td  ><font size="2" face="Arial, Helvetica, sans-serif">
                <input name="txtsegurosocial" type="text" id="txtsegurosocial" style="width:200px" value="<? echo $_POST['txtsegurosocial'] ?>" maxlength="20">
                </font><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;</font><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
        ...
        <tr bgcolor="">
            ...
            <td  ><font size="2" face="Arial, Helvetica, sans-serif">
                <input name="txthorabase" type="text" id="txthorabase" style="width:200px" value="<? echo $_POST['txthorabase'] ?>" maxlength="20">
                </font><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;</font><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
		...
		<tr bgcolor="">
            ...
            <td  ><font size="2" face="Arial, Helvetica, sans-serif">
                <input name="txtsegurosocialsipe" type="text" id="txtsegurosocialsipe" style="width:200px" value="<? echo $_POST['txtsegurosocialsipe'] ?>" maxlength="20">
                </font><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;</font><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
        ...
        <tr bgcolor="">
            ...
            <td  ><font size="2" face="Arial, Helvetica, sans-serif"><? if ($termino != "Planilla") { ?>
                    <select name="cbobancoaux" id="select4" style="width:200px">
                        <option>Seleccione un banco de Auxiliar</option>
                        <?php
                        $query = "select cod_ban,des_ban from nombancos";
                        $result = sql_ejecutar($query);
                        //ciclo para mostrar los datos
 ...
 <option value="">--Sin-Turno ------------------------------------------------------</option>
        ...
        <tr>
            <td><font size="2" face="Arial, Helvetica, sans-serif">Salario:  <font color ="#FF2D2D">(*)</font></font></td>
            <td>
                <font size="2" face="Arial, Helvetica, sans-serif">
