...
$(document).ready(function(){
	...
	{
		$.get("procesos2.php",{nombre:nombre,concepto:concepto},function(resp){
			if (resp=!'') {
				$("#concepto").empty();
				$("#concepto").append(resp);
			}
		});
	}
});
						...
						<div class="portlet-body">
							<FORM name="frmPrincipal" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" target="_self">
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="input-group">
											<input type="text" name="codcon" id="codcon" class="form-control input-sm" onblur="javascript:cargar_concepto();" placeholder="Buscar concepto">
								...
								<div class="row">
									...
									<div class="col-md-3">
										<input type="text" name="referencia" id="referencia" class="form-control input-sm" placeholder="Escriba el valor a cargar">
									</div>
								...
								<div class="row">
									...
									<div class="col-md-1 text-center">
										<button type="button" class="btn btn-sm red active" onclick="javascript:window.close();"><i class="fa fa-cancel"></i>Salir</button>&nbsp;
									</div>
								</div>
								<div class="row">&nbsp;</div>
								<div class="row">
									<div class="col-md-12">
										...
										while($fila=fetch_array($result))
										{
											...
											foreach($indices as $campo)
											{
												...
												if($campo=='apenom')
													echo "<td><INPUT size=\"50\" type=\"hidden\" name=\"apenom[]\" value=\"$var\">".utf8_encode ($var)."</td>";		
											}
											?>
