...
<div class="logo">
	<a href="index.php">
		<img src="../../includes/assets/img/logox.png" alt=""/>
	</a>
</div>
								...
								<div class="col-md-12">
											<div class="pricing hover-effect">
												<div class="pricing-head">
													<h3>Seleccion un tipo de <?php echo $config['termino']; ?><br></br>
													</h3>
												</div>
												...
												<div class="pricing-footer">
													<div class="form-actions fluid">
														<div class="col-md-offset-3 col-md-9">
															<button onClick="javascript:VerificarSeleccion();" type="submit" class="btn green">Aceptar</button>
														</div>
													</div>
												</div>
											</div>
