...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('E7', 'RESUMEN DE PLANILLA 3')
...
$sql="SELECT DISTINCT nm.codcon, nm.descrip as descripcion, nm.tipcon 
	  ...
	  WHERE nm.codnom=".$codnom." AND nm.tipnom=".$codtip." AND nm.monto >= 0 AND (nm.codcon >=300 AND nm.codcon <=399) 
...
header('Content-Disposition: attachment;filename="Reporte_PLANILLA3.xls"');
