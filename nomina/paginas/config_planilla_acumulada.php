...
function desglose()
{
    ...
    window.open('../tcpdf/reportes/planilla_acumulada.php?nomina_id='+codnom+'&codt='+codtip,  '_blank');
}
</script>
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<div class="row">
		                        ...
		                        <div class="col-md-1">                            
                                	<div  class="btn blue button-next" onClick="javascript:desglose()">Generar</div>
		                        </div>                    
