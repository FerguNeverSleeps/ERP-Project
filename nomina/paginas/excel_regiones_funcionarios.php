...
$fecha_inicio = (empty($_GET['fecha_inicio'])) ? 0 : $_GET['fecha_inicio'];
$fecha_fin = (empty($_GET['fecha_fin'])) ? 0 : $_GET['fecha_fin'];
//$fecha2 = (empty($_GET['fecha2'])) ? 0 : $_GET['fecha2'];

$inicio = date("Y-m-d",strtotime($fecha_inicio));
$final = date("Y-m-d",strtotime($fecha_fin));

$objPHPExcel = new PHPExcel();
$objPHPExcel = PHPExcel_IOFactory::load("../../reportes/excel/plantillas/excel_regiones_funcionarios.xlsx");
//------------------------------------------------------------
...
$objPHPExcel->getActiveSheet()->setTitle('Listado de funcionarios');

header('Content-Type: application/vnd.openxmlformats-   officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment;filename="excel_regiones_funcionarios.xlsx"');
