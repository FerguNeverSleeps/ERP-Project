            ...
            <div class="portlet-body">
              <div class="row">
                ...
                <div class="col-md-2 text-center">
                  <a href="cartas_trabajo/configuracion_general.php">
                    <div class="tile bg-blue">
                      <div class="tile-body">
                      <i class="fa fa-cog"></i>
                          <h5>Configuraci&oacute;n General</h5>                            
                      </div>
                    </div>
                  </a>
                </div>
                ...
                <div class="col-md-2 text-center">
                  <a href="cartas_trabajo/listado_modelos_constancias.php">
                    <div class="tile bg-blue">
                      <div class="tile-body">
                      <i class="fa fa-th"></i>
                          <h5>Modelos de Constancias</h5>                            
                      </div>
                    </div>
                  </a>
                </div>
