...
function desglose()
{
	var fecha = document.form1.fecha.value; // PK nomtipos_nomina
	if(fecha=='')
	{
	...
	{
		AbrirVentana('../../reportes/pdf/pdf_estimado_liquidaciones.php?fecha='+document.form1.fecha.value,660,800,0);
	}
				...
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								Reporte de Estimado de Liquidacion
							</div>
							<div class="actions">
						...
						<div class="portlet-body">
							...
							<div class="row">
								<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-right">Fecha</div>
								<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 text-center">
									<div class="input-group date date-picker" data-provide="datepicker" data-date-end-date="0d" data-date-format="dd-mm-yyyy"> 
				                         <input name="fecha" type="text" id="fecha" class="form-control" value="" maxlength="60">
