                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                Movimientos Planilla - Recalcular <?php echo " / Nombre ".$_GET['nombre']." 
                                ...
                                <div class="form-body">
                                    <div class="form-group margin-top-20">
                                        <div class="col-md-12 text-center">
                                            <strong>Presione para Recalcular Conceptos</strong> 
                                            <br> <br>     
                                            INFO: ESTA ACCIÓN RECALCULA TODOS LOS CONCEPTOS CALCULADOS DE SALARIOS
                                        </div>
                                ...
                                <div class="form-actions fluid">
                                    <div class="row">
                                        <div class="col-md-1 col-md-offset-5 text-center">
                                            <button type="button" class="btn btn-sm blue active" id="btn-generar">Recalcular</button>&nbsp;
...
$(document).ready(function(){
    ...
    $("#btn-generar").click(function(){
        ...
        $.get( "recalcular_movimientos_nomina.php", { codnom: codnom, nomina:nomina, ficha:ficha,continua_laborando:continua_laborando,ultimo_ingreso:ultimo_ingreso }, function(file) {
