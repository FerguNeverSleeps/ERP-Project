...
$sql = "SELECT * FROM nomcursos as a";
					  		...
					  		<div class="tab-pane active" id="tab_0">
								...
								<div class="portlet box blue">
									<div class="portlet-title">
										...
										<div class="actions">
											<a class="btn btn-sm blue"  onclick="javascript: window.location='cursos.php'">
									...
									<div class="portlet-body">
										<div class="table-toolbar" style="display: none">
											...
											<div class="btn-group pull-right">
												<button class="btn btn-sm blue" onclick="javascript: window.location='cursos.php'">
												<i class="fa fa-plus"></i>
												Agregar
												</button>
								...
								<div class="portlet box blue">
									...
									<div class="portlet-body">
										...
										<table class="table table-striped table-bordered table-hover" id="table_datatable">
											...
											<tbody>
											<?php
												$consulta= "SELECT id_personal
												FROM nomcursos_personal
												GROUP BY id_personal";
												$resultado = query($consulta,$conexion);
												while ($rows = fetch_array($resultado)) {

													$id=$rows['id_personal'];
													$SQL = "SELECT nomcursos_personal.id as personal_curso_id, nompersonal.apenom,nomcursos.id as curso_id , nomcursos.nombre_curso, nompersonal.cedula
													FROM nomcursos_personal , nomcursos, nompersonal
													WHERE nomcursos_personal.id_personal = nompersonal.personal_id
													AND nomcursos_personal.id_curso = nomcursos.id AND nomcursos_personal.id_personal=".$id;
													$res = query($SQL, $conexion);
													$codigo=$rows['curso_id'];

													$filas=fetch_array($res);
													...
													<tr class="odd gradeX">
														...
														<td style="text-align: center">
															...
															<?php 
																echo "<a  href='capacitacion_add_curso.php?codigo=".$filas['curso_id']."&id=".$id."' title='Agregar integrantes'>"; ?>
															<i class="fa fa-plus"></i>
															</a>
														</td>
													</tr>
