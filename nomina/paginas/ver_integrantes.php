										...
										<div class="row">
											<div class="col-md-9">
												<div class="form-group">
													...
													<div class="col-md-9">
														<?php 
															...
															$res = $db->query($sql);
														?>
														<select name="tipnom" id="tipnom" class="form-control select2" disabled>
															<?php
																if($res->num_rows==0)
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<input type="text" name="ficha" id="ficha" class="form-control" value="<?php echo $ficha_actual; ?>" disabled> 
													</div>
												...
												<div class="form-group">
													<label class="control-label col-md-3">Apellidos <span class="required">*</span></label>
													<div class="col-md-9">
														<input type="text" name="apellidos" id="apellidos" class="form-control" value="<?php  echo (isset($integrante)) ? $integrante->apellidos : ''; ?>"  disabled>
													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-md-3">Nombres <span class="required">*</span></label>
													<div class="col-md-9">
														<input type="text" name="nombres" id="nombres" class="form-control" value="<?php  echo (isset($integrante)) ? $integrante->nombres : ''; ?>"  disabled>
													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-md-3"><?php echo $identificacion_personal; ?><span class="required">*</span></label>
													<div class="col-md-9">
														<input type="text" name="cedula" id="cedula" class="form-control" value="<?php  echo (isset($integrante)) ? $integrante->cedula : ''; ?>" disabled>
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<input type="file" id="imagen_cedula" name="imagen_cedula" disabled>
													</div>
												</div>
												<div class="form-group">
													<?php
													...
													<div class="col-md-9">
														<div class="radio-list">
															...
															<input type="radio" name="nacionalidad" id="nacionalidad1" value="1" <?php echo $nacionalidad1; ?> disabled> <?php echo $gentilicio;?></label>
															<label class="radio-inline">
															<input type="radio" name="nacionalidad" id="nacionalidad2" value="2" <?php echo $nacionalidad2; ?> disabled> Extranjero</label>
															<label class="radio-inline">
															<input type="radio" name="nacionalidad" id="nacionalidad3" value="3" <?php echo $nacionalidad3; ?> disabled> Nacionalizado</label>
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-9">
														<div class="radio-list">
															<label class="radio-inline">
															<input type="radio" name="sexo" id="sexo1" value="Masculino" <?php echo $sexo1; ?> disabled> Masculino</label>
															<label class="radio-inline">
															<input type="radio" name="sexo" id="sexo2" value="Femenino"  <?php echo $sexo2; ?> disabled> Femenino</label>
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-9">
														<select name="estado_civil" id="estado_civil" class="form-control select2" disabled>
															<?php
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<div class="input-group date date-picker" data-provide="datepicker" data-date-end-date="0d">
															<input type="text" class="form-control" name="fecnac" id="fecnac" value="<?php echo (isset($fecha_nacimiento)) ? $fecha_nacimiento : ''; ?>" disabled>
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<input type="text" name="lugarnac" id="lugarnac" class="form-control" value="<?php  echo (isset($integrante)) ? $integrante->lugarnac : ''; ?>" disabled>
													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-md-3">Profesi&oacute;n <?php if($empresa->tipo_empresa != 1){ ?><span class="required" disabled>*</span><?php } ?></label>
													<div class="col-md-9">
														<?php 
															...
															$res = $db->query($sql);
														?>
														<select name="codpro" id="codpro" class="form-control select2" disabled>
															<?php
																if($operacion=='agregar')
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<textarea name="direccion" id="direccion" class="form-control" rows="3" style="resize:vertical;" disabled><?php echo (isset($integrante)) ? $integrante->direccion : ''; ?></textarea>
													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-md-3">Tel&eacute;fonos <?php if($empresa->tipo_empresa != 1){ ?><span class="required">*</span><?php } ?></label>
													<div class="col-md-9">
														<input type="text" name="telefonos" id="telefonos" class="form-control" placeholder="xxxx-xxxx" value="<?php  echo (isset($integrante)) ? $integrante->telefonos : ''; ?>" disabled>	
													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-md-3">E-mail Sugerido</label>
													<div class="col-md-9">
														<input type="text" name="email" id="email" class="form-control" value="<?php  echo (isset($integrante)) ? $integrante->email : ''; ?>" disabled>
													</div>
												</div>
													...
													<div class="col-md-9">
														 <?php 
                                                                                                                    ...
                                                                                                                    $res = $db->query($sql);
                                                                                                                ?>
														<select name="estado" id="estado" class="form-control select2"  disabled>                                                                                                                        
															<?php
																if($operacion=='agregar')
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<input type="text" name="dv" id="dv" class="form-control" value="<?php  echo (isset($integrante)) ? $integrante->dv : ''; ?>" disabled>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<input type="text" name="siacap" id="siacap" class="form-control" value="<?php  echo (isset($integrante)) ? $integrante->siacap : ''; ?>" disabled>
													</div>
												</div>
                                                                                                <?php } ?>
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<select name="forcob" id="forcob" class="form-control select2" disabled>
															<?php
												...
												<div class="form-group forma-pago" style="<?php echo $display_forma_pago; ?>">
													...
													<div class="col-md-9">
														<?php 
															...
															$res = $db->query($sql);
														?>
														<select name="codbancob" id="codbancob" class="form-control select2me" disabled>
															<?php
																//if($operacion=='agregar')
												...
												<div class="form-group forma-pago" style="<?php echo $display_forma_pago; ?>">
													...
													<div class="col-md-9">
														<input type="text" name="cuentacob" id="cuentacob" class="form-control" value="<?php echo (isset($integrante)) ? $integrante->cuentacob : ''; ?>" disabled>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<input type="text" name="seguro_social" id="seguro_social" class="form-control" value="<?php echo (isset($integrante)) ? $integrante->seguro_social : ''; ?>" disabled>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<input type="text" name="segurosocial_sipe" id="segurosocial_sipe" class="form-control" value="<?php echo (isset($integrante)) ? $integrante->segurosocial_sipe : ''; ?>" disabled>
													</div>
												</div>
                                                                                                <div class="form-group">
													<label class="control-label col-md-3">Clave I/R</label>
													<div class="col-md-9">
														<input type="text" name="clave_ir" id="clave_ir" class="form-control" value="<?php echo (isset($integrante)) ? $integrante->clave_ir : ''; ?>" disabled>
													</div>
												</div>
                                                                                                <?php } ?>
													...
													<div class="col-md-9">
														<div class="input-group date date-picker" data-provide="datepicker">
															<input type="text" class="form-control" name="fecing" id="fecing" value="<?php echo (isset($fecha_ingreso)) ? $fecha_ingreso : ''; ?>" disabled>
															<span class="input-group-btn">
																<button class="btn default" type="button" style="height: 34px;"><i class="fa fa-calendar"></i></button>
															</span>
														</div>
												...
												?>
													...
													<div class="col-md-9">
														<div class="input-group date date-picker" data-provide="datepicker">
															<input type="text" class="form-control" name="fecfin" id="fecfin" value="<?php echo (isset($fecha_egreso)) ? $fecha_egreso : ''; ?>" disabled>
															<span class="input-group-btn">
																<button class="btn default" type="button" style="height: 34px;"><i class="fa fa-calendar"></i></button>
															</span>
														</div>
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<div class="radio-list">
															<label class="radio-inline">
															<input type="radio" name="tipemp" id="tipemp1" value="Fijo" <?php echo $tipemp1; ?>> <span class="tipo_contrato" disabled>Contrato Indefinido</span></label>
															<label class="radio-inline">
															<input type="radio" name="tipemp" id="tipemp2" value="Contratado Transitorio" <?php echo $tipemp2; ?> disabled> Contrato Obra Determinada</label>
														</div>	
														<div class="radio-list">
															<label class="radio-inline">
															<input type="radio" name="tipemp" id="tipemp3" value="Contratado Contingente" <?php echo $tipemp3; ?> disabled> <span class="tipo_contrato">Servicios Profesionales</span></label>
															<label class="radio-inline">
															<input type="radio" name="tipemp" id="tipemp4" value="Contratado Servicios" <?php echo $tipemp4; ?> disabled> Contrato Definido </label>
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-md-9">
														<div class="row">
															...
															<div class="col-md-5" style="padding-right: 0px">
																<div class="input-group date date-picker" data-provide="datepicker">	
																	<input type="text" class="form-control" name="inicio_periodo" id="inicio_periodo" value="<?php echo (isset($inicio_periodo)) ? $inicio_periodo : ''; ?>" <?php echo $disabled_periodo; ?> disabled>
																	<span class="input-group-btn">
																		<button class="btn default" type="button" style="height: 34px;"><i class="fa fa-calendar"></i></button>
																	</span>
																</div>
														...
														<div class="row" style="margin-top: 10px">
															...
															<div class="col-md-5" style="padding-right: 0px">
																<div class="input-group date date-picker" data-provide="datepicker">	
																	<input type="text" class="form-control" name="fin_periodo" id="fin_periodo" value="<?php echo (isset($fin_periodo)) ? $fin_periodo : ''; ?>" <?php echo $disabled_periodo; ?> disabled>
																	<span class="input-group-btn">
																		<button class="btn default" type="button" style="height: 34px;"><i class="fa fa-calendar"></i></button>
																	</span>
																</div>
															...
															<div class="col-md-5" style="padding-right: 0px">
																<div class="input-group date date-picker" data-provide="datepicker">	
																	<input type="text" class="form-control" name="fin_probatorio" id="fin_probatorio" value="<?php echo (isset($fin_probatorio)) ? $fin_probatorio : ''; ?>"disabled >
																	<span class="input-group-btn">
																		<button class="btn default" type="button" style="height: 34px;"><i class="fa fa-calendar"></i></button>
																	</span>
																</div>
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<?php 
															...
															$res = $db->query($sql);
														?>
														<select name="turno_id" id="turno_id" class="form-control select2" disabled>
															<?php
																//if($operacion=='agregar')
													...
													?>
														<div class="form-group">
															...
															<div class="col-md-9">
																...
																?>
																<select name="nomposicion_id" id="nomposicion_id" class="form-control select2" disabled>
																	<?php
																		//if($operacion=='agregar')
												...
												?>
													...
													<div class="col-md-9">
														<?php 
															...
															$res = $db->query($sql);
														?>
														<select name="codcargo" id="codcargo" class="form-control select2" disabled>
															<?php
																//if($operacion=='agregar')
													...
													<div class="col-md-9">
														<?php 
															...
															$res = $db->query($sql);
														?>
														<select name="codcat" id="codcat" class="form-control select2" disabled>
															<?php
																//if($operacion=='agregar')
													...
													<div class="col-md-9">
														<?php 
															...
															$res = $db->query($sql);
														?>
														<select name="proyecto" id="proyecto" class="form-control select2" disabled>
															<?php
																//if($operacion=='agregar')
												...
												<div class="form-group" style="display: <?php echo $display_acceso; ?>">
													...
													<div class="col-md-9">
														<input type="<?php echo $type_acceso; ?>" name="suesal" id="suesal" class="form-control" value="<?php echo isset($integrante->suesal) ? number_format($integrante->suesal,'2', '.', '')  : $suesal_propuesto; ?>" disabled>
														<input type="hidden" name="max_sueldo" id="max_sueldo" value="<?php echo $max_sueldo; ?>" />
														<input type="hidden" name="sueldo_original" id="sueldo_original" value="<?php echo (isset($integrante) && $integrante->suesal) ? $integrante->suesal : 0; ?>" disabled>
													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-md-3">Hora Base Trabajada</label>
													<div class="col-md-9">
														<input type="text" name="hora_base" id="hora_base" class="form-control" value="<?php echo (isset($integrante)) ? number_format($integrante->hora_base, '0') : ''; ?>" disabled>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<label  class="mt-checkbox mt-checkbox-outline"> 
															<input type="checkbox" name="marcar_reloj" id="marcar_reloj1"  <?php echo $marca_reloj; ?> disabled>
														</label>
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<label  class="mt-checkbox mt-checkbox-outline"> 
															<input type="checkbox" name="incapacidad" id="incapacidad1"  <?php echo $incapacidad; ?> disabled>
														</label>
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<label  class="mt-checkbox mt-checkbox-outline"> 
															<input type="checkbox" name="familiar_incapacidad" id="familiar_incapacidad1"  <?php echo $familiar_incapacidad; ?> disabled>
														</label>
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																<?php 
																	...
																	$res = $db->query($sql);
																?>
																<select name="codnivel<?php echo $i; ?>" id="codnivel<?php echo $i; ?>" class="form-control select2me" disabled>
																	<?php
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<input type="text" name="usuario_workflow" id="usuario_workflow" class="form-control" value="<?php echo (isset($integrante)) ? $integrante->usuario_workflow : ''; ?>" disabled>
													</div>
												</div>                                 
												<div class="form-group">
													<label class="col-md-3 control-label">Contraseña Workflow</label>
													<div class="col-md-9">
														<input type="password" name="usr_password" id="usr_password" class="form-control" value="<?php echo (isset($integrante)) ? $integrante->usr_password : ''; ?>" disabled>
													</div>
												</div>
                                                                                                <div class="form-group">
                                                                                                    <label class="col-md-3 control-label">Departamento (Workflow)</label>
                                                                                                    <div class="col-md-9">
                                                                                                            <select id="departamento_estructura" name="departamento_estructura" class="form-control select2me" disabled>
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                        ...
                                                                                                        <div class="col-md-3">
                                                                                                                <div class="radio-list">
                                                                                                                        <label class="radio-inline">
                                                                                                                        <input type="radio" name="aprueba_solicitud" id="apruebasolicitud_no" value="0" <?php echo $apruebasolicitud_no;?> disabled>No</label> 
                                                                                                                        <label class="radio-inline"> 
                                                                                                                        <input type="radio" name="aprueba_solicitud" id="apruebasolicitud_si" value="1" <?php echo $pruebasolicitud_si;?> disabled>Si</label>
