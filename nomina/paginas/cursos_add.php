...
$SQL="INSERT INTO menu_cursos(cod_curso, capitulo_curso, modulo_curso, area_curso, id_cliente_curso, fecha_curso, estrategia_curso,
 id_profesor_curso, duracion_curso, duracion_teorica_curso, duracion_practica_curso)
VALUES ('".$cod_curso."','".$capitulo_curso."','".$modulo_curso."','".$area_curso."','".$id_cliente_curso."','".$fecha_curso."',
