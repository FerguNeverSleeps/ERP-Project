...
function planilla_forma_pago()
{
	...
	var codtip = document.form1.codt.value; // PK nomtipos_nomina
        ...
        if(tipo_forma_pago==="00002")
        {
            location.href='../fpdf/reportes/planilla1_forma_pago_cheque_pdf.php?codnom='+codnom+'&codtip='+codtip; 
        }
        else if(tipo_forma_pago==="00003")
        {
            location.href='../fpdf/reportes/planilla1_forma_pago_ach_pdf.php?codnom='+codnom+'&codtip='+codtip; 
        }
        else
        {
				...
				<div class=" col-md-offset-2 col-md-8">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								Reporte Forma de Pago - Planilla 1
							</div>
							<div class="actions">
