...
if($_REQUEST["accion"]=="ajax"):
    ...
    $sql="select * from `federal_personal_bonos` WHERE $add ";
    $return=[];
    $return["aaData"]=[];
              ...
              <table class="table table-striped table-bordered table-hover" id="table_datatable">
                <thead>
                  ...
                  <tr role="row" class="filter" style="background: white;">
                    ...
                    <td><input type="text" class="form-control form-filter input-sm" id="buscar_NumeroPer"></td>
                    <td><input type="text" class="form-control form-filter input-sm" id="buscar_Ano"></td>
                    <td><input type="text" class="form-control form-filter input-sm" id="buscar_Periodo"></td>
                    <td><input type="text" class="form-control form-filter input-sm" id="buscar_CodigoSuc"></td>
                    <td><input type="text" class="form-control form-filter input-sm" id="buscar_Descripcion"></td>
