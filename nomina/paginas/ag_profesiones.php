...
<?php
$campo_clave='codorg';
$documento_list='maestro_profesion.php';
$documento_edit='ag_profesiones.php';
$nombre_modulo='profesiones';
?>
...
<?php 
	...
	if ($registro_id==0){ // Si el registro_id es 0 se va a agregar un registro nuevo
		...
		$query="insert into nomprofesiones
		(descrip)
		values ('$_POST[txtdescripcion]')";
		...
		$query="select * from nomprofesiones where $campo_clave=$registro_id";		
		$result=sql_ejecutar($query);	
				...
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							...
							<div class="actions">
								<a class="btn btn-sm blue"  onclick="javascript: window.location='situaciones.php'">
