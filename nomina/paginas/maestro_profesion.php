...
{	
	...
	activar_pagina("maestro_profesion.php"); // activar_pagina("profesiones.php");		 
}     
$strsql = "SELECT * FROM nomprofesiones ORDER BY descrip ASC";
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							...
							<div class="actions">
								<a class="btn btn-sm blue"  onclick="javascript: window.location='ag_profesiones.php'">
						...
						<div class="portlet-body">
							...
							<tr>
								...
								<th>Descripci&oacute;n de la profesi&oacute;n</th>
								<th>&nbsp;</th>
								<th>&nbsp;</th>
								<!-- <th>&nbsp;</th> -->
							</tr>
