...
function horizontal_nomina_xls()
{
	...
	if(codnom==''){
		...
		location.href='horizontal_nomina_xls_vacaciones.php?codnom='+codnom+'&codtip='+codtip;
	}
}
</script>
		...
		<td width="467" height="40"  valign="middle" align="left"  style="padding-left: 40px">Planilla:
			...
			<?php
				$query="SELECT codnom, descrip, codtip 
				        FROM   nom_nominas_pago WHERE codtip='".$_SESSION['codigo_nomina']."' and frecuencia = 8";				
