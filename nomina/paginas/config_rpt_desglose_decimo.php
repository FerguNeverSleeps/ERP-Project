...
function desglose()
{
	...
	location.href='rpt_desglose_decimo_billetes_monedas.php?codnom='+codnom+'&codtip='+codtip; 
}
</script>
								...
								<div class="col-md-12 text-center">
									...
									<?php
										$query="SELECT codnom, descrip, codtip 
										        FROM   nom_nominas_pago WHERE  frecuencia=7 AND codtip='".$_SESSION['codigo_nomina']."'";
