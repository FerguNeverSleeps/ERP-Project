...
if( isset($_POST['btn-guardar']) )
{
	...
	if($id==='')
		$sql = "INSERT INTO nomtipos_empresa (codigo, descripcion) VALUES ('{$codigo}','{$descripcion}')";
	else
	{
		$sql = "UPDATE nomtipos_empresa SET 
					   codigo  = '{$codigo}',
...
if($id!=='')
{
	$sql = "SELECT codigo, descripcion FROM nomtipos_empresa WHERE codigo='{$id}'";
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<?php echo ($id==='') ? 'Agregar' : 'Editar'; ?> Tipo de Empresa
							</div>
						</div>
							...
							<form class="form-horizontal" id="formPrincipal" name="formPrincipal" method="post" role="form" style="margin-bottom: 5px;">								
								<div class="form-body">
									...
									<button type="button" class="btn btn-sm default active" 
									        onclick="javascript: document.location.href='tipos_empresa.php'">Cancelar</button>
