									...
									<div class="form-group margin-top-20">
										...
										<div class="col-md-9">
											...
											$sql = "SELECT codnom, descrip, codtip 
													...
													WHERE  codtip = '{$_SESSION['codigo_nomina']}' AND frecuencia=2
...
$(document).ready(function(){
	...
	$("#codnom1").change(function(){
		var codnom1 = $(this).val();

		$("#codnom2").select2("val", "");

		$.ajax({
	        url:  "ajax_rpt_sipe_brentwood.php",
	        type: "post",
	        data: { codnom1: codnom1},
	...
	$("#btn-exportar").click(function(){
	    ...
	    $.get( "xls_reporte_sipe.php", { codnom1: codnom1, codnom2: codnom2 }, function(file) {
