        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue">
            <div class="portlet-title">
              <h4>Federal - Bonos y Contratos</h4>
            </div>
            <div class="portlet-body">
              <div class="row">

                <div class="col-md-3 text-center">
                  <a href="federal_tipos_contratos.php">
                ...
                <div class="col-md-3 text-center">
                  <a href="federal_bonos_categorias.php">
                    <div class="tile bg-blue">
                      <div class="tile-body">
                      <i class="fa fa-folder-open"></i>
                          <h5>Categorias de Bonos</h5>                            
                      </div>
                    </div>
                  </a>
                </div>
                ...
                <div class="col-md-3 text-center">
                  <a href="federal_bonos.php">
                    <div class="tile bg-blue">
                      <div class="tile-body">
                      <i class="fa fa-bars"></i>
                          <h5>Tipos de Bonos</h5>                            
                      </div>
                    </div>
                  </a>
                </div>
