										...
										<table class="table table-striped table-bordered table-hover" id="table_datatable">
											...
											<?php
												...
												while ($rows = fetch_array($resultado)) {
													...
													$id=$rows['id_personal'];
													$SQL = "SELECT a.id as personal_curso_id, c.apenom,b.id as curso_id , b.nombre_curso, c.cedula
													FROM nomcursos_personal AS A, nomcursos AS b, nompersonal AS c
													WHERE a.id_personal = c.personal_id
													AND a.id_curso = b.id AND a.id_personal=".$id;
													$res = query($SQL, $conexion);
