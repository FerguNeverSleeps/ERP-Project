				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							...
							<div class="actions">
								<a class="btn btn-sm blue"  onclick="javascript: window.location='grados_add.php'">
								...
								?>
									<tr class="odd gradeX">
										...
										<td style="text-align: center">
									      <a href="grados_add.php?edit&id=<?php echo $fila['id_grado']; ?>" title="Editar">
									      <img src="../../includes/imagenes/icons/pencil.png" width="16" height="16"></a>
										</td>
										<td style="text-align: center">
										      <a href="javascript:enviar(<?php echo(3); ?>,<?php echo($fila['id_grado']); ?>);" title="Eliminar">
