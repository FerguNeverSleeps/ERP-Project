...
function vista_dia($dia,$mes,$ano,$ficha)
{
	...
	?>
	<td onclick="javascript:alerta_personal_ajax('<?php echo $fecha; ?>','<?php echo $dia; ?>','<?php echo $ano; ?>','<?php echo $ficha; ?>');" id="<?php echo $fecha;?>" align="center" style="cursor : pointer; font-size : 12px;" title="<?php echo utf8_encode($fila['descripcion_dia_fiesta']);?>" bgcolor="<?php echo $color;?>"><?php echo $dia;?><div style=" font-size : 10px; valign:bottom; color: blue;"><?php echo $fila[descripcion];?></div></td>
	<?php
}
...
<table cellspacing="10" border="2"  cellpadding="2"> 
<tbody valign="top">
<tr>
<TD colspan="7" class="portlet box blue"  align="center">
<?php 
if($mes==1)
...
function cambioanos(fichas,turnoss) 
{
	...
	if (iframe === null)
	{
		...
		Ext.getCmp('tab-calendario').loader.url = "?ano="+anosx+"&ficha="+fichas+"&turnoss="+ turno;
		Ext.getCmp('tab-calendario').loader.load();
	}
	else
	{
		// console.log('iframe:');
		window.parent.document.getElementById("iframe_tab_2").src = "about:blank";
		window.parent.document.getElementById("iframe_tab_3").src = "about:blank";
		window.parent.document.getElementById("iframe_tab_4").src = "about:blank";

		iframe.src = "calendarios_personal_ajax.php?ano=" + anosx + "&ficha=" + fichas + "&turnoss=" + turno; 
	}
}
			...
			<div class="portlet box blue">
				...
				<div class="portlet-body">
                    	...
                    	<div class="row">
                      		...
                      		<div class="col-md-3"> 
								<select name="estado" id="estado_dia" class="form-control select2">
                    	...
                    	<div class="actions" align="right">
                    		<input type="submit" class="btn btn-sm blue" name="reiniciar"  value="Reiniciar Calendario">	
                    	</div>		
				</div>
			</div>
		</div>
