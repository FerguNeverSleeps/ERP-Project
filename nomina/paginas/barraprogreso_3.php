...
<html>
<head>
<title>Generando Accesos Manuales</title>
...
function Enviar(){
	...
	$.blockUI({ message: '<span><img src="../imagenes/loader.gif"></span><br><span>Generando Accesos Manuales...</b></span>' });
	...
	$("#progressBar").load("control_acceso_generacion_manual.php", {registro_id: registro_id, codigo_nomina: codigo_nomina},
		function(response, status, xhr){
			...
			if(status == "error"){
				...
				$('#boton-aceptar').hide();
				$("#progressBar").html('<div class="alert alert-success"><br><img src="../imagenes/ok.gif" align="absmiddle"> Se ha generado exitosamente los registros manuales</div>');
			}
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-122">
										Generando Accesos Manuales del Encabezado
									</div>
								</div>
							</div>
							<div class="portlet-body">
								<div class="row" id="mensaje_generar">
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
										Presione aceptar para generar los detalles
									</div>
								</div>
