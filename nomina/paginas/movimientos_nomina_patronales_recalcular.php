...
<html>
<head>
<title>Recalculando Patronales</title>
...
function Enviar(){
	...
	$.blockUI({ message: '<span><img src="../imagenes/loader.gif"></span><br><span>Recalculando Patronales...</b></span>' });
	...
	$("#progressBar").load("recalcular_movimientos_nomina_patronales.php", {registro_id: registro_id, codigo_nomina: codigo_nomina},
		function(response, status, xhr){
			...
			if(status == "error"){
				...
				$('#boton-aceptar').hide();
				$("#progressBar").html('<div class="alert alert-success"><br><img src="../imagenes/ok.gif" align="absmiddle"> Conceptos Patronales han sido recalculados exitosamente </div>');
			}
