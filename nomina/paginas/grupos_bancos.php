...
{ 
  ...
  $strsql = "SELECT * FROM nomgrupo_bancos ORDER BY cod_gban,des_ban";
        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue">
            <div class="portlet-title">
              ...
              <div class="actions">
                <a class="btn btn-sm blue"  onclick="javascript: window.location='ag_grupos_bancos.php'">
            ...
            <div class="portlet-body">
              ...
              <tr>
                <th>Grupo</th>
                <th>Descripci&oacute;n del Grupo</th>
                <th>&nbsp;</th>
                <th>&nbsp;</th>
              </tr>
              </thead>
              ...
              <?php
                ...
                ?>
                  <tr class="odd gradeX">
                    <td><?php echo $fila['cod_gban']; ?></td>
                    <td><?php echo $fila['des_ban']; ?></td>
                    <td style="text-align: center">
                        <a href="javascript:enviar(<?php echo(2); ?>,<?php echo($fila['cod_gban']); ?>);" title="Editar"><img src="../../includes/imagenes/icons/pencil.png" alt="Editar" width="16" height="16"></a>
                    </td>
                    <td style="text-align: center">
                        <a href="javascript:enviar(<?php echo(3); ?>,<?php echo($fila['cod_gban']); ?>);" title="Eliminar"><img src="../../includes/imagenes/icons/delete.png" alt="Eliminar" width="16" height="16"></a>
                    </td>
                  </tr>
                  <?php                 
                }
