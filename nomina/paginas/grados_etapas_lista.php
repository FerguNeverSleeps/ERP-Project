				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							...
							<div class="actions">
								<a class="btn btn-sm blue"  onclick="javascript: window.location='grados_etapas_add.php'">
						...
						<div class="portlet-body">
							...
							<?php
								...
								?>
									<tr class="odd gradeX">
										<td><?php echo $fila['id_grado_etapa']; ?></td>
                                                                                <td><?php echo $fila['desc_grado']; ?></td>
                                                                                <td><?php echo $fila['desc_etapa']; ?></td>
                                                                                <td><?php echo $fila['minimo']; echo " - "; echo $fila['maximo'];?></td>
                                                                                <td><?php echo $fila['monto']; ?></td>
                                                                                <td><?php  echo $fila['ajuste']; ?></td>
										<td style="text-align: center">
									      <a href="grados_etapas_add.php?edit&id=<?php echo $fila['id_grado_etapa']; ?>" title="Editar">
