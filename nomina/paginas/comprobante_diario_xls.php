...
$objPHPExcel->getProperties()->setCreator("Selectra")
							 ...
							 ->setTitle("Comprobante de diario")
...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('B13', 'NOMBRE DE CUENTA')
            ->setCellValue('I11', 'No.')
...
$sql2="SELECT np.codnivel1, nc.codcon, nc.descrip as concepto, SUM(nm.monto) as monto_total, nc.tipcon as tipo, nc.ctacon as cuenta_contable 
       ...
       WHERE  nm.codnom=".$codnom." AND nm.tipnom=".$codtip." AND np.codnivel1='".$codnivel1."'
...
header('Content-Disposition: attachment;filename="comprobante_diario.xls"');
