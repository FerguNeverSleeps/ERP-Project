				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							...
							<div class="actions">
								<a class="btn btn-sm blue"  onclick="javascript: window.location='salones_list_list.php'">
						...
						<div class="portlet-body">
							...
							<div class="row">
								<div class="form-group">
									<label class="col-md-3"><h4>Nombre Salón</h4></label>
									<div class="col-md-6">
										<input type="text" id="nombre_salon" class="form-control" placeholder="Salon...">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group">
									<label class="col-md-3"><h4>Capacidad</h4></label>
									<div class="col-md-6">
										<input type="text" id="capacidad_salon" class="form-control" placeholder="Capacidad...">
									</div>
								</div>
							</div>
  ...
  $("#sig1").on("click", function()
   {
   		...
   		var capacidad_salon=$("#capacidad_salon").val();
		...
		if(nombre_salon !='' && capacidad_salon !='')
		{
			location.href="salones_add.php?nombre_salon="+nombre_salon+"&capacidad_salon="+capacidad_salon;
