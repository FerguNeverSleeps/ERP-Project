...
#Control de egresado en una planilla 2015/01/21
 $valorfi  = $_POST['txtficha'] ;
$control = " select count(*) as Cant , (select  estado from nompersonal where ficha = '$valorfi') as sts from  nom_nominas_pago A where  (select  count(*) from nom_movimientos_nomina B where A.codnom = B.codnom and B.ficha = '$valorfi'  ) > 0  and `status` = 'A' and  A.tipnom  = (select  tipnom from nompersonal where ficha = '$valorfi') " ;
$resultc = sql_ejecutar($control); 
$filavalor = mysqli_fetch_array($resultc);
if($filavalor['Cant'] == 0 || $_POST['cbosituacion']  ==  $filavalor['sts'] )
{

 


            if ($_POST['txtficha'] != "" && $_POST['txtcedula'] != "" && $_POST['txtnombres'] != "" && $_POST['txtapellidos'] != "" && $_POST['txtFechaIngreso'] != "" && $_POST[txtmonto] != "" && $_POST[cboNivel1] != "" && $_POST['cbosituacion'] != "" && $_POST['optPresentacion'] != "") {
                ...
                if ($_POST['cbosituacion'] == 'Activo') {
                    $anexo = ", fecharetiro='0000-00-00'";
                }
	...
	fin_periodo='" . fecha_sql($_POST['fecha_fin_contrato']) . "'" . $anexo . ", antiguedadap='" . $_POST['antiguedadap'] . "', paso='$_POST[txtpaso]', turno_id = ".(($_POST["cboTurno"]=="")?"NULL":"'".$_POST["cboTurno"]."'").", seguro_social='" . $_POST['txtsegurosocial'] . "', hora_base='" . $_POST['txthorabase'] . "', segurosocial_sipe='" . $_POST['txtsegurosocialsipe'] . "',
	dv='" . $_POST['txtdv'] . "'
	WHERE cedula='" . $_POST['cedulah'] . "' and ficha='" . $_POST['txtficha'] . "'";
                ...
                } elseif ($_POST['txtFechaIngreso'] == "") {
                    mensaje("Debe introducir fecha de Ingreso");
                } elseif ($_POST[txtmonto] == "") {
                    mensaje("Debe introducir el salario");
                }  elseif ($_POST[cboNivel1] == "") {
                    mensaje("Debe introducir el departamento ");
                }  elseif ($_POST['cbosituacion'] == "") {
                    mensaje("Debe introducir el situacion ");
                }  elseif ($_POST['optPresentacion'] == "") {
                    mensaje("Debe elegir una Prestaciones ");
                }
            }
        }
...
echo "<script>alert('No se puede cambiar de status se encuentra en frecuencia activa') ;</script>" ;
activar_pagina("maestro_personal.php");
    ...
    <form action="ed_maestro_integrantes.php" method="post" name="frmAgregarIntegrantes" id="frmAgregarIntegrantes" enctype="multipart/form-data">
        ...
        <table align="left" width="700" border="0">
            <tbody>
                <tr><TD colspan="3" class="tb-tit" align="right"><? if ($bandera == 1)
            echo btn("back", "maestro_personal.php?bandera=1"); else
            echo btn("back", "maestro_personal.php"); ?></TD></tr>
                ...
                <tr>
                    <td><font size="2" face="Arial, Helvetica, sans-serif">No de Ficha: <font color ="#FF2D2D">(*)</font></font></td>
                    <td><font size="2" face="Arial, Helvetica, sans-serif">
                        <input name="txtficha2" type="text" id="txtficha2" size="10" value="<?php echo $fila['ficha'] ?>" maxlength="20">
                        <input name="txtficha" type="text" id="txtficha" value="<?php echo $fila['ficha'] ?>">
                    </td>
                </tr>
                <tr>
        ...
        <table align="left" width="700" border="0" class="">
            ...
            <tr >
                <td width="200"><font size="2" face="Arial, Helvetica, sans-serif">Apellidos: <font color ="#FF2D2D">(*)</font></font></td>
            ...
            <tr bgcolor="">
                <td ><font size="2" face="Arial, Helvetica, sans-serif">Nombres: <font color ="#FF2D2D">(*)</font></font>:</td>
            ...
            <tr >
                <td ><font size="2" face="Arial, Helvetica, sans-serif">C&eacute;dula: <font color ="#FF2D2D">(*)</font></font></td>
                <td ><font size="2" face="Arial, Helvetica, sans-serif">
                    <input name="txtcedula" type="text" id="txtcedula" style="width:100px" value="<?= $fila['cedula'] ?>" maxlength="20">
                    <input name="cedulah" type="hidden" id="cedulah" value="<?= $fila['cedula'] ?>">
                    </font></td>
            </tr>
            <tr>
...
<input name="optNacionalidad" type="radio" value=2"
                           <?php if ($fila[nacionalidad] == 2) { ?> checked= "true" <?php } ?>>
                    Nacionalizado</font> <font size="2" face="Arial, Helvetica, sans-serif">
...
while ($row = mysqli_fetch_array($result)) {
    ?>
            ...
            <tr bgcolor="">
                <td  ><font size="2" face="Arial, Helvetica, sans-serif">Situaci&oacute;n: <font color ="#FF2D2D">(*)</font></font></td>
                <td ><font size="2" face="Arial, Helvetica, sans-serif">
...
if (isset($_GET['estado'])) {
    ...
    <?php }
			...
			<tr bgcolor="">
                <td ><font size="2" face="Arial, Helvetica, sans-serif">DV:</font></td>
                <td ><font size="2" face="Arial, Helvetica, sans-serif">
                    <input name="txtdv" type="text" id="txtdv" style="width:200px"  value="<?php echo $fila['dv']; ?>" maxlength="40" >
                    </font></td>
            </tr>
            <tr bgcolor="">
                <td  ><font size="2" face="Arial, Helvetica, sans-serif">Fecha de Ingreso: <font color ="#FF2D2D">(*)</font></font></td>
                <td  ><font size="2" face="Arial, Helvetica, sans-serif">
            ...
            <tr bgcolor="">
                <td  ><font size="2" face="Arial, Helvetica, sans-serif">Prestaciones: <font color ="#FF2D2D">(*)</font></font><font color="#000000" size="2" face="Arial, Helvetica, sans-serif">:</font></td>
                <td  ><font size="2" face="Arial, Helvetica, sans-serif">
    ...
    if ($row[cod_ban] == $fila['codbancob']) {
        ?>
            ...
            <tr bgcolor="">
             ...
             <tr bgcolor="">
                <td  ><font size="2" face="Arial, Helvetica, sans-serif">Seguro Social:</font></td>
                <td  ><font size="2" face="Arial, Helvetica, sans-serif">
                    <input name="txtsegurosocial" type="text" id="txtsegurosocial" style="width:200px" value="<? echo $fila['seguro_social'] ?>" maxlength="20">
                    </font><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;</font><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>

            </tr>
             <tr bgcolor="">
                <td  ><font size="2" face="Arial, Helvetica, sans-serif">Hora Base:</font></td>
                <td  ><font size="2" face="Arial, Helvetica, sans-serif">
                    <input name="txthorabase" type="text" id="txthorabase" style="width:200px" value="<? echo $fila['hora_base'] ?>" maxlength="20">
                    </font><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;</font><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
            </tr>
            <tr bgcolor="">
                <td  ><font size="2" face="Arial, Helvetica, sans-serif">Codigo Seguro Social Sipe:</font></td>
                <td  ><font size="2" face="Arial, Helvetica, sans-serif">
                    <input name="txtsegurosocialsipe" type="text" id="txtsegurosocialsipe" style="width:200px" value="<? echo $fila['segurosocial_sipe'] ?>" maxlength="20">
                    </font><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;</font><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
            </tr>


            <tr bgcolor="">
                <td  ><font size="2" face="Arial, Helvetica, sans-serif"><? if ($termino != "Planilla") { ?>Banco Auxiliar.:<? } ?> </font></td>
 ...
 <option value="">Seleccione</option>
    ...
    while ($row = fetch_array($result)) {
        ...
        if ($row[cod_ban] == $fila['codbanlph']) {
            ...
            <tr bgcolor="">
                <td  ><font size="2" face="Arial, Helvetica, sans-serif"><? if ($termino != "Planilla") { ?>Cuenta Auxiliar:<? } ?></font></td>
                <td ><font size="2" face="Arial, Helvetica, sans-serif">
...
?>
         ...
         <tr bgcolor="">
          <td ><font size="2" face="Arial, Helvetica, sans-serif">Turno:</font></td>
          <td  ><font size="2" face="Arial, Helvetica, sans-serif">
           
 <select name="cboTurno" id="cboTurno" style="width:300px">
 <option value="">--Sin-Turno ------------------------------------------------------</option>
              <?php
	 	$query="select turno_id,descripcion, date_format(entrada,'%h:%i:%s %p') as entrada, date_format(salida,'%h:%i:%s %p') as salida from nomturnos";
		$result=sql_ejecutar($query);
	 	  //ciclo para mostrar los datos
  		...
  		{ 		
		// option de modificar, se selecciona la situacion del registro a modificar				
  		if ($row[turno_id]==$fila['turno_id']){ 
		?>
              <option selected value="<?php echo $row[turno_id];?>"><?php printf("%s: Entrada: %s / Salida: %s", $row[descripcion],$row[entrada],$row[salida] ) ?></option>
              <?php 
		}
		else // option de agregar
		{ 
		   ?>
              <option value="<?php echo $row[turno_id];?>" > <?php printf("%s: Entrada: %s / Salida: %s", $row[descripcion],$row[entrada],$row[salida] ) ?> </option>
              <?php 
		} 
		}//fin del ciclo while
		?>
...
</font><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;</font><font size="2" face="Arial, Helvetica, sans-serif"></font>
</hr>
</td>
        </tr>
<?
if ($bandera != 1) {
    ?>
                <tr bgcolor="">
                    <td ><font size="2" face="Arial, Helvetica, sans-serif">Sueldo: <font color ="#FF2D2D">(*)</font></font></td>
                    <td  ><font size="2" face="Arial, Helvetica, sans-serif">
...
?>
                ...
                <tr bgcolor="">
                    <td >
                            <?php echo $row_emp[nomniv1]; ?>: <font color ="#FF2D2D">(*)</font></td>
                    <td ><font size="2" face="Arial, Helvetica, sans-serif">
                        <select name="cboNivel1" id="select7" style="width:230px">
                            ...
                            while ($row = fetch_array($result)) {
                                ...
                                if ($row[codorg] == $fila['codnivel1']) {
                                    ?>
                                    <option value="<?php echo $row[codorg]; ?>" selected="true"> <?php echo $row[codorg] . " " . $row[descrip] . " " .$row[markar]; ?> </option><?php
                    } else {// option de agregar
                        ?><option value="<?php echo $row[codorg]; ?>"><?php echo $row[codorg] . " " . $row[descrip] . " " .$row[markar] ; ?></option><?php
                    }
                }//fin del ciclo while
                            ?>
                        </select>
                        ...
                        <select name="cboNivel4" id="select10" style="width:230px">
                            ...
                            while ($row = fetch_array($result)) {
                                ...
                                if ($row[codorg] == $fila['codnivel4']) {
                                    ?>
                                    <option value="<?php echo $row[codorg]; ?>" selected > <?php echo $row[codorg] . " " . $row[descrip] . " " .$row[markar]; ?> </option><?php
                    } else {// option de agregar
                                    ?><option value="<?php echo $row[codorg]; ?>"><?php echo $row[codorg] . " " . $row[descrip] . " " .$row[markar]; ?></option><?php
                    }
                }//fin del ciclo while
