...
$strsql = "SELECT * FROM nomdesempeno ORDER BY codigo, descripcion";
        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue">
            <div class="portlet-title">
              <div class="caption">
               &Aacute;rea de desempe&ntilde;o
              </div>
              <div class="actions">
                <a class="btn btn-sm blue"  onclick="javascript: window.location='ag_desempeno.php'">
            ...
            <div class="portlet-body">
              ...
              <tr>
                <th>C&oacute;digo</th>
                <th>Descripci&oacute;n del &aacute;rea de desempeño</th>
                <th>&nbsp;</th>
                <th>&nbsp;</th>
              </tr>
              </thead>
