...
$total_seguro_educativo2	= $objPHPExcel->getActiveSheet()->getCell('M'.$i)->getCalculatedValue();		

$total_segurosocial_salario2 = 	$objPHPExcel->getActiveSheet()->getCell('L'.$i)->getCalculatedValue();						  
...
$objPHPExcel->getActiveSheet()			
			...
			//->setCellValue('B1', '')
			->setCellValue('B3', strtoupper("Periodo ".$NOMINA." Del ".fecha($desde).' al '.fecha($hasta)))
			->setCellValue('J1', 'Ref:MM-703' )
			->setCellValue('J2', 'Formato Ejecutivo')
			->setCellValue('J3', $estatus_mov_nomina)								
			//->setCellValue('J2', PHPExcel_Shared_Date::FormattedPHPToExcel($anio, $mes_numero, $dia_fin) )
...
$objPHPExcel->getActiveSheet()
			...
			->setCellValue('E'.$r, $TotalRegular )
			->setCellValue('F'.$r, $TotalOtrosIngresos )
			->setCellValue('G'.$r, $TotalIngresos )
			->setCellValue('H'.$r, $ImpuestoRenta )
			->setCellValue('I'.$r, $SeguraSocial )
...
$objPHPExcel->getActiveSheet()
			->setCellValue('C'.$r,count($trabajadores).' Empleados')
...
$objPHPExcel->getActiveSheet()			
			...
			//->setCellValue('B1', '')																	
			->setCellValue('F'.$r, $ImpuestoRenta)
			->setCellValue('G'.$r, $total_segurosocial_salario2)
			->setCellValue('H'.$r, $total_seguro_educativo2)
			->setCellValue('I'.$r, '0')
			->setCellValue('J'.$r, $total_descuentos)
			->setCellValue('K'.$r, $TotalAPagar);			
...
$r++;
$objPHPExcel->getActiveSheet()			
			->setCellValue('D'.$r,count($trabajadores) )
			->setCellValue('E'.$r,0 )			
			//->setCellValue('B1', '')																	
			->setCellValue('F'.$r, 0)
			->setCellValue('G'.$r, count($trabajadores))
			->setCellValue('H'.$r, 0)
			->setCellValue('I'.$r, 0)
			->setCellValue('J'.$r, count($trabajadores))
			->setCellValue('K'.$r, count($trabajadores));	
