...
if ($seleccion==1){
	...
	$select=sql_ejecutar("select * from nomusuario_nomina where id_nomina=".$fila['codtip']." and id_usuario=".$_SESSION['cod_usuario']);
...
<input name="seleccion_nomina" type="hidden" value="0">
  ...
  <div align="center">
    <table width="100%" height="5" class="tb-tit" bgcolor="#FFE4AF">
      <tr class="" align="left">
      <td height="31"><font color="#000066"><strong>&nbsp;Seleccionar Tipo de Planilla</strong></font></td>
    </tr>
    <tr>
    </table>
    <br>
    <table width="500"  border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="500" height="49" colspan="2"><table width="500" border="0" id="lst" cellspacing="0" cellpadding="0">
          <tr>
            <td width="100%" height="21" class="tb-head"><div align="center"><STRONG>Nombre de Planilla</STRONG></font></div></td>
          </tr>
          <?php
