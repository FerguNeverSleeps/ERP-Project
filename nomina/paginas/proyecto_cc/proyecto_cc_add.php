				...
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							...
							<div class="actions">
								<a class="btn btn-sm blue" onclick="javascript: window.location='proyecto_cc.php?cedula=<?php echo $cedula; ?>'">
                              ...
                              ?>
								...
								<div class="row">
									...
									<div class="input-group date date-picker col-md-4" data-provide="datepicker" data-date-format="dd-mm-yyyy" data-date-start-date="<?php echo $fecha_ingreso; ?>">
                                        <input name="fecha-ini" type="text" id="fecha-ini"  class="form-control">
                                ...
                                <div class="row">
									...
									<div class="input-group date date-picker col-md-4" data-provide="datepicker" data-date-format="dd-mm-yyyy">
                                        <input name="fecha-fin" type="text" id="fecha-fin"  class="form-control">
                                        <span class="input-group-btn">
                                            <button class="btn default" type="button" style="height: 34px;"><i class="fa fa-calendar"></i></button>
                                        </span>
                                    </div>
								...
								<div class="row">
									<div class="col-md-4 text-right"><label for="descripcion">Porcentaje:</label></div>
									<div class="col-md-4"><input name="porcentaje" type="number" id="porcentaje"  class="form-control"></div>
								</div>
								<div class="row">
									&nbsp;
								</div>
...
<div class="row">&nbsp;</div>
								...
								<div class="row">
									<div style="margin-right:20px;" class="col-md-offset-4 col-md-1"><?php boton_metronic('ok','Enviar();',2) ?></div>
