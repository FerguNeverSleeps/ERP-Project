				...
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								Informe 03 v4, Formato a Diligencial
							</div>
							<div class="actions">
	...
	function desglose()
	{
		...
		{		
			if(fecha_fin=='')
			{
				...
				location.href ='rpt_anexo03_formato_diligencial.php?codtip='+codtip+'&mesano='+mesano+'&mesano1='+mesano1;

				$.get( "rpt_anexo03_formato_diligencial.php", { codtip:codtip, mesano:mesano, mesano1:mesano1 }, function(file) {
					console.log(file);
