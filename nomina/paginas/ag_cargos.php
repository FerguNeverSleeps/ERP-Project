						...
						<div class="portlet-body form">
							<form class="form-horizontal" id="formPrincipal" name="formPrincipal" method="post" role="form" style="margin-bottom: 5px;">
								...
								<div class="panel panel-default">
  								...
  								<div class="panel-body">	
									<div class="form-group">
										<label class="col-md-3 control-label">1) Código:</label>
										<div class="col-md-3">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">2) Descripción:</label>
										<div class="col-md-3">
									...
									<div class="form-group">
										...
										<div class="col-md-3">											
											<select name="gremio" id="gremio" class="select2 form-control">
												...
												<option value="0" <?php echo ($gremio=='0') ? 'selected' : ''; ?> >Obrero</option>
												<option value="1" <?php echo ($gremio=='1') ? 'selected' : ''; ?> >Empleado</option>
											</select>
										</div>
									</div>	
									<div class="form-group">
								...
								<div class="panel panel-default">
  								...
  								<div class="panel-body">
									<div class="form-group">
										<label class="col-md-3 control-label" for="sueldo_1">Salario Base:</label>
										<div class="col-md-3">
...
<!--									<div class="form-group">
									...
									<div class="form-group">
										<label class="col-md-3 control-label" for="sueldo_anual">9) Salario Anual:</label>
										<div class="col-md-3">
											<input type="number" class="form-control input-sm" 
...
<!--										<label class="col-md-2 control-label" for="mes_t">9.1) Total</label>
									...
									<div class="form-group">
										<label class="col-md-3 control-label" for="sueldo_propuesto">Salario Propuesto :</label>
										<div class="col-md-3">
											<input type="number" class="form-control input-sm" 
								...
								<div class="panel panel-default">
  								<div class="panel-heading">Sobresueldos:</div>
  								<div class="panel-body">
<!--									<div class="form-group">
...
<!--									<div class="form-group">
									...
									<div class="form-group">
										<label class="col-md-3 control-label" for="sobresueldo_otros_1">Otros (080) 1:</label>
										<div class="col-md-3">
											<input type="number" class="form-control input-sm" 
										       id="sobresueldo_otros_1" name="sobresueldo_otros_1" value="<?php echo $sobresueldo_otros_1; ?>" >
										</div>
										<label class="col-md-2 control-label" for="mes_ot_1">Meses:</label>
										<div class="col-md-1">
											<input type="number" class="form-control input-sm" 
									...
									<div class="form-group">
										<label class="col-md-3 control-label" for="sobresueldo_otros_2">Otros (080) 2:</label>
										<div class="col-md-3">
											<input type="number" class="form-control input-sm" 
										       id="sobresueldo_otros_2" name="sobresueldo_otros_2" value="<?php echo $sobresueldo_otros_2; ?>" >
										</div>
										<label class="col-md-2 control-label" for="mes_ot_2">Meses:</label>
										<div class="col-md-1">
											<input type="number" class="form-control input-sm" 
										...
										<div class="form-group">
										<label class="col-md-3 control-label" for="sueldo_propuesto_80"> Sueldo Propuesto (080):</label>
										<div class="col-md-3">
											<input type="number" class="form-control input-sm" 
...
<!--									<div class="form-group">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">Total de Cargos:</label>
										<div class="col-md-3">
									...
									?>
									<div class="form-group">
									<label class="col-md-3 control-label">¿Actualizar Sueldos a Posiciones?:</label>
										<div class="col-md-3">											
									...
									<div class="form-group">
									<label class="col-md-3 control-label">¿Actualizar Sueldos a Personal?:</label>
										<div class="col-md-3">											
