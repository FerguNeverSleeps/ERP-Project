				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<?php echo $_SESSION["nomina"].' '; ?> - COMPROBANTE CONTABLE DISTRIBUCIÓN OTROS BENEFICIOS (OPERATIVOS)
							</div>
							<div class="actions">
...
$(document).ready(function()
{
	...
	$("#btn-exportar").click(function(){
        ...
        location.href ="rpt_comprobante_distribucion_beneficios_centro_costo.php?anio="+anio+"&mes="+mes+"&fecha_inicio="+fecha_inicio+"&fecha_fin="+fecha_fin;
	});
