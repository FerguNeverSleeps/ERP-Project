...
$objPHPExcel->getActiveSheet()
            ...
            ->setCellValue('A3', 'LISTADO USUARIOS');
...
// $objPHPExcel->getActiveSheet()->getStyle('A8:B8')->getFont()->setSize(12);
...
// $objPHPExcel->getActiveSheet()->getStyle('A8:B8')->applyFromArray(allBordersThin());
...
//            ->setCellValue('A6', 'SALARIOS')
        ->setCellValue('A'.$n, 'USUARIO')
        ->setCellValue('B'.$n, 'NOMBRES');
...
//            ORDER  BY pry.descripcionLarga, np.ficha ASC, np.estado ASC"; 
 //$i=2;
 $sql2= "SELECT * FROM " . SELECTRA_CONF_PYME . ".nomusuarios"; 
    ...
    //     }  
        ...
        // $enc=true;
        // $ficha = $row2['ficha'];
        // $primer_nombre = utf8_encode($row2['descrip']);
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('A'.$i, utf8_encode($row2['login_usuario']));
        $objPHPExcel->getActiveSheet()->setCellValue('B'.$i, utf8_encode($row2['descrip']));
