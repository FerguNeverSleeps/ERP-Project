...
{ 
  $query  = "DELETE FROM nomsituaciones WHERE codigo=$registro_id";     
  $result = sql_ejecutar($query);
  activar_pagina('situaciones.php');     
}     
$strsql= "SELECT * FROM nomsituaciones ORDER BY codigo, situacion";
...
function enviar(op,id){
  ...
  if (op==1){   // Opcion de Agregar
    ...
    document.frmPrincipal.action="ag_situaciones.php";
          ...
          <div class="portlet box blue">
            ...
            <div class="portlet-body">
              ...
              ?>
                  ...
                  <input name="nombre_tabla" type="hidden" value="nomsituaciones">
