...
if($email3!=="" && $email3!==0)
{
    ...
    $encabezado = "UPDATE reloj_encabezado "
            . "SET fecha_despreaprobacion = NOW(), "
            . "usuario_despreaprobacion = '".$_SESSION['usuario']."',"
            . " status = 'Pendiente' "
            . "WHERE cod_enca='$reg'";
    $result   = query($encabezado,$conexion);
    
    $detalle = "UPDATE reloj_detalle SET status = 1 where id_encabezado='$reg'";
    $result   = query($encabezado,$conexion);
    ...
    $asunto="El Encabezado de Control de Asistencias Código <strong>".$reg."</strong><br> "
            ...
            . "Ha sido Des-Preparobado Satisfactoriamente por el usuario: <strong>".$_SESSION['usuario']."</strong><br>"
    ...
    $sql_log  = "INSERT INTO log_transacciones 
                ...
                VALUES 
                (NULL, 
                'Control de Asistencia - DesPreaprobación Exitosa', 
                now(), 
                'Control Acceso', 
                'control_acceso_despreaprobar.php',
                'despreaprobar',
                '{$reg}',"
                . "'".$_SESSION['usuario'] ."', "
                . "'".$host_ip."')";
    ...
    header("Location:control_acceso2.php?listo=4");
