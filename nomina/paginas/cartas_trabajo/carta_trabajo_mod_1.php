...
if(isset($_GET['ficha']) && isset($_GET['tipnom']))
{
	...
	$sql = "SELECT n.nombres, n.apellidos, n.cedula,n.seguro_social,n.fecing,n.fecharetiro, c.des_car as cargo,
	...
	$templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor('templates/carta_trabajo_sm_1.docx');
	...
	$num_seguro        = $trabajador->seguro_social;
	...
	$templateProcessor->setValue('fecha_inicio',$fecing);
	if ($fecharetiro == '0000-00-00'){$fecharetiro=date('Y-m-d');}
	...
	$templateProcessor->setValue('num_seguro',htmlspecialchars($num_seguro));
	...
	$filename = 'CartaTrabajo-sanmiguelito-mod1'.$ficha.'.docx';
