...
//        $inicio_periodo = formato_fecha($trabajador->inicio_periodo,3);
        ...
        $fecha = date("d/m/Y");
        //sumo 1 día
       $inicio_periodo= date("d/m/Y",strtotime($fecha_actual."+ 7 days")); 
    ...
    $templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor('templates/carta_terminacion_obra.docx');
	...
	$filename = 'carta_terminacion_obra_'.$trabajador->cedula.'.docx';
