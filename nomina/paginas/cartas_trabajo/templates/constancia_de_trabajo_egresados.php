...
date_default_timezone_set('America/Panama');
	...
	$sql = "SELECT a.apenom, a.cedula as ced_trabajador,a.sexo,a.sueldopro,a.estado_civil, a.seguro_social, a.lugarnac, a.fecnac,
	 ...
	 b.des_car,d.nombre AS provincia,e.descrip as donde,a.inicio_periodo as ini,a.fin_periodo as fin,a.fechaing as fechaing,a.fecharetiro as fecharetiro
    ...
    echo $ger_rrhh      = strtoupper($empresa ->ger_rrhh);exit;
	$sexo =$persona->sexo;
    $ini=$persona->ini;
    $fecharetiro=$persona->fecharetiro;
    $fechaing=$persona->fechaing;
	// if ($ini) {
	// 	$ini2=explode("-",$ini);
	...
	$templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor('plantillas/constancia_de_trabajo_egresados.docx');
    ...
    $templateProcessor->setValue('fechaing', htmlspecialchars($fechaing));
	...
	$filename = 'Constancia de trabajo egresados'.$ficha.'.docx';
