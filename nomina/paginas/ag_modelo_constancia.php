...
function Enviar(){							
	...
	{
		if(document.frmConfigurarConstancia.fileTemplate.value=='')
		{
...
<?php 
  if(isset($_POST['txtnombre']))
  {
    ...
    $query="INSERT INTO nomtipos_constancia (nombre, contenido2, titulo, configuracion, template, formula)
            VALUES ('".$txtnombre."','".$txtcontenido2."', '".$txttitulo."', '".$chkconfiguracion."', '".$txttemplate."','".$txtformula."')";
...
<form action="" method="post" name="frmConfigurarConstancia" id="frmConfigurarConstancia"  enctype="multipart/form-data">
  <table width="900" height="125" border="0" class="row-br">
    <tr>
      ...
      <font color="#000066">&nbsp;<strong>Agregar Modelo de Constancia</font>
      </td>
    </tr>
    <tr>
      ...
      <table width="900" border="0" bordercolor="#0066FF">
        <tr bgcolor="#FFFFFF">
          ...
          <td bgcolor="#FFFFFF" class="ewTableAltRow" >
            <input name="txtnombre" type="text" id="txtnombre"  style="width:95%" maxlength="60" value="">
          </td>
        </tr>
        <tr bgcolor="#FFFFFF">
          <td width="180" height="30" bgcolor="#FFFFFF" class="ewTableAltRow">&nbsp;
          ...
          <td bgcolor="#FFFFFF" class="ewTableAltRow" >
            <input name="txttitulo" type="text" id="txttitulo"  style="width:95%" maxlength="70" value="">
          </td>
        </tr>
	...
	-->
        <tr valign="middle" bgcolor="#FFFFFF">
          ...
          <td valign="middle" bgcolor="#FFFFFF" class="ewTableAltRow" ><br>
            <textarea cols="70" rows="12" name="txtcontenido2" id="txtcontenido2" style="width: 95%"></textarea><br>
          </td>
            <script>
	...
	-->
        <tr valign="middle" bgcolor="#FFFFFF">
          ...
          <td valign="middle" bgcolor="#FFFFFF" class="ewTableAltRow" >
                <input type="radio" name="chkconfiguracion" value="Header"    >Utilizar encabezado y pie de p&aacute;gina de la configuraci&oacute;n general<br>
                <input type="radio" name="chkconfiguracion" value="Template"  >Utilizar Template<br>
                <input type="radio" name="chkconfiguracion" value="Ninguno"  checked >Ninguno
          </td>
        </tr>
        ...
        <tr valign="middle" bgcolor="#FFFFFF">
          ...
          <td valign="middle" bgcolor="#FFFFFF" class="ewTableAltRow">
            <textarea cols="70" rows="12" name="txtformula" id="txtformula" style="width: 95%; resize:vertical;"></textarea>
          </td>
        </tr> 
