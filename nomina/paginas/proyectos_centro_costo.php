...
$strsql = "SELECT pc.*, c.Descrip
            FROM proyecto_cc pc
            INNER JOIN cwconcue c ON c.Cuenta = pc.cuenta_contable COLLATE utf8_general_ci";
$result = sql_ejecutar($strsql);     
?>
...
function enviar(op,id, cwconcue){
  
  if (op==1){   // Opcion de Agregar
    //document.frmAgregar.registro_id.value=id;
    document.frmPrincipal.op.value=op;
    document.frmPrincipal.action="proyectos_add.php";
    document.frmPrincipal.submit(); 
  }
  if (op==2){   // Opcion de Modificar
    //alert($op);   
    document.frmPrincipal.registro_id.value=id;   
    document.frmPrincipal.cwconcue.value=cwconcue;   
    document.frmPrincipal.op.value=op;
    document.frmPrincipal.action="proyectos_centro_costo_edit.php";
    document.frmPrincipal.submit();   
  }
  if (op==3){   // Opcion de Eliminar
    ...
    {         
      document.frmPrincipal.registro_id.value=id;
      document.frmPrincipal.op.value=op;
      document.frmPrincipal.action="proyectos_centro_costo_delete.php";
      document.frmPrincipal.submit();
    }   
  }
}
        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue">
            <div class="portlet-title">
              ...
              <div class="actions">
                <a class="btn btn-sm blue"  onclick="javascript: window.location='proyectos_centro_costo_add.php'">
            ...
            <div class="portlet-body">
              ...
              <?php
                ...
                ?>
                  <tr class="odd gradeX">
                    ...
                    <td><?php echo $fila['cuenta_contable'] . ' - ' . $fila['Descrip']; ?></td>
                    <td style="text-align: center">
                        <a href="javascript:enviar(<?php echo(2); ?>,'<?php echo($fila['id']); ?>', '<?php echo($fila['cuenta_contable']); ?>');" title="Editar"><img src="../../includes/imagenes/icons/pencil.png" width="16" height="16"></a>
                    </td>
                    <!-- <td style="text-align: center">
              ...
              ?>
                  ...
                  <input name="cwconcue" type="hidden" value="">
