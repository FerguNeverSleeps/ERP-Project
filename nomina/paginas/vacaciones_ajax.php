...
function enviar(op,id){
  ...
  if (op==1){
    ...
    document.frmPrincipal.action="vacaciones_ajax.php";
...
if ($op==3) {//Se presiono el boton de Eliminar     
  ...
  activar_pagina("vacaciones_ajax.php?cedula=$cedula&bandera=$bandera");     
  }     
elseif ($cadena <> ""){ // Condicion para filtrado
  ...
  $strsql= "select * from expediente as a, periodos_vacaciones as b  where a.cedula='$cedula' AND b.cod_expediente_det = a.cod_expediente_det and b.saldo>0";
                ...
                <table class="table table-striped table-bordered table-hover" id="table_datatable">
                  ...
                  <tbody>
                      <?php
                          ...
                          ?>
                            <tr style="cursor: pointer;" onclick="cargarDatos(<?=$fila['id_periodo_vacacion']?>)">
                            <td>
                                <?php
...
<div id="md_vacaciones" class="modal fade modal-scroll" tabindex="-1" data-replace="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                                    <h4 class="modal-title">Detalle de la vacación</h4>
                                                </div>
                                                <div class="modal-body" id="body_md_vacaciones">
...
<script type="text/javascript">
  ...
  function cargarDatos(id){
    ...
    var route = "vacaciones_ajax_detalles.php";
    $.get(route,{id:id},function(res){      
      $('#body_md_vacaciones').html(res);
      $('#md_vacaciones').modal('show');
    });
    //alert(id);
  }
</script>
