        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue">
            <div class="portlet-title">
              <div class="caption">
               <?php echo $_SESSION['termino'].' '; ?>Bisemanal
              </div>
			  <div class="actions">
            ...
            <div class="portlet-body">
                <form action="horizontal_nomina_xls_modelo4.php" method="get" name="frmPrincipal" id="frmPrincipal">
                                        
					<div class="form-group">
						<!--<div class="row">
							<label class="col-md-2 control-label" for="txtcodigo">Proyecto:</label>
							<div class="col-md-8">
								<div class="input-group">
									<span id="id_proyecto"></span>
								</div> 
							</div>
						</div>-->
...
{ 
    ...
    /*$.get("ajax/obtenerProyecto.php",function(res)
    {
        $("#id_proyecto").empty();
        $("#id_proyecto").append(res);
    });*/
