        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue">
            <div class="portlet-title">
              <h4>Formulación de Conceptos</h4>
            </div>
            <div class="portlet-body">
              <div class="row">

                <div class="col-md-3 text-center">
                  <a href="conceptos_nomina_pago.php">
                    <div class="tile bg-blue">
                      <div class="tile-body">
                      <i class="fa fa-list-alt"></i>
                          <h5>Conceptos de <?echo $termino?> de Pago</h5>                            
                      </div>
                    </div>
                  </a>
                </div>
                ...
                <div class="col-md-3 text-center">
                  <a href="constantes_personal.php">
                    <div class="tile bg-blue">
                      <div class="tile-body">
                      <i class="fa fa-folder-open"></i>
                          <h5>Campos Adicionales (Trabajador)</h5>                            
                      </div>
                    </div>
                  </a>
                </div>
                  ...
                  <a href="baremos.php">
                    <div class="tile bg-blue">
                      ...
                      <i class="fa fa-bars"></i>
                          <h5>Baremos (Tablas Escalares)</h5>                            
                      </div>
                    </div>
                  </a>
                </div>
