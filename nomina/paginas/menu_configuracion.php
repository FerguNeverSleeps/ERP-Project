   ...
   <!-- <tr>-->
      <!--<td><table width="100%" border="0">-->
        ...
        <tr>
          ...
          <td class="Estilo1"><div align="center" class="Estilo1">Calendarios</div></td>
        </tr>
        <tr>
          ...
          <td class="Estilo1"><div align="center"><a href="maestro_profesion.php"><img src="img_sis/icons/8.png" alt="Permite modificar el registro de profesiones"  height="32" border="0" align="absmiddle" class="icon" /></a></div></td>
        ...
        <tr>
          <td height="32" class="Estilo1"><div align="center" class="Estilo1">Categor&iacute;as</div></td>
	...
	<!--<td class="Estilo1"><div align="center"><a href="../configuracion/firmas_list.php"><img src="../img_sis/icons/37.png" alt="Permite modificar las firmas en los Reportes"  height="32" border="0" align="absmiddle" class="icon" /></a></div></td>-->
			<td class="Estilo1"><div align="center"><a href="tabulador_seguro_list.php"><img src="img_sis/icons/zuma.jpg" alt="Cargar Tabulador Seguro"  height="32" border="0" align="absmiddle" class="icon" /></a></div></td>
                        <td class="Estilo1"><div align="center"><a href="turnos.php"><img src="img_sis/icons/turno.jpg" alt="Cargar Turnos"  height="32" border="0" align="absmiddle" class="icon" /></a></div></td>
	   ...
	   <td height="32" class="Estilo1"><div align="center" class="Estilo1">Tabulador</div></td>
          <td height="32" class="Estilo1"><div align="center" class="Estilo1">Turnos</div></td>
           <!--<td class="Estilo1"><div align="center">Firmas Reportes</div></td>-->
          <td class="Estilo1"><div align="center">&nbsp;</div></td>
        </tr>

        <tr>
          <td  height="50" align="center" valign="middle" class="Estilo1">
            <?php
              if(isset($_SESSION['acce_editar_constancias']) && 
                 $_SESSION['acce_editar_constancias']==1){ ?>
                <div align="center"><a href="submenu_constancias.php"><img src="img_sis/icons/sin asignar/document.png"  height="32" border="0" align="absmiddle" class="icon" /></a></div>
              <?php
              } ?>
          </td>
          <td  align="center" valign="middle" ></td>
          <td  align="center" valign="middle" class="Estilo1"></td>
          <td  align="center" valign="middle" class="Estilo1"></td>
        </tr>
        <tr>
          <td class="Estilo1">
            <?php
              if(isset($_SESSION['acce_editar_constancias']) &&
                 $_SESSION['acce_editar_constancias']==1){?>
                <div align="center" class="Estilo1">Constancias&nbsp;&nbsp;&nbsp;</div>
              <?php
              } ?>
          </td>
