...
function enviar(op,id){
  ...
  if (op==2){   // Opcion de Modificar
    ...
    document.frmPrincipal.op.value=op;
    document.frmPrincipal.action="proyectos_edit.php";
    document.frmPrincipal.submit();   
  }
  if (op==3){   // Opcion de Eliminar
    ...
    {         
      document.frmPrincipal.registro_id.value=id;
      document.frmPrincipal.op.value=op;
      document.frmPrincipal.action="proyectos_delete.php";
      document.frmPrincipal.submit();
    }   
  }
}
        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue">
            <div class="portlet-title">
              ...
              <div class="actions">
                <a class="btn btn-sm blue"  onclick="javascript: window.location='proyectos_add.php'">
            ...
            <div class="portlet-body">
              ...
              <?php
                ...
                ?>
                  <tr class="odd gradeX">
                    <td><?php echo $fila['numProyecto']; ?></td>
                    <td><?php echo $fila['descripcionCorta']; ?></td>
                    <td><?php echo $fila['descripcionLarga']; ?></td>
                    <td><?php echo $fila['codigo']." - ".$fila['nombre']; ?></td>
                    <td style="text-align: center">
                        <a href="javascript:enviar(<?php echo(2); ?>,'<?php echo($fila['idProyecto']); ?>');" title="Editar"><img src="../../includes/imagenes/icons/pencil.png" width="16" height="16"></a>
                    </td>
                    <td style="text-align: center">
                        <a href="javascript:enviar(<?php echo(3); ?>,'<?php echo($fila['idProyecto']); ?>');" title="Eliminar"><img src="../../includes/imagenes/icons/delete.png" alt="Eliminar" width="16" height="16"></a>
                    </td>
                  </tr>
                  <?php                 
                }
