...
// Consulta para General la Compensacion
	...
	$fila_adicional=mysqli_fetch_array($resultado_adicionalg);
...
$consulta="select valor from nomcampos_adic_personal where ficha='".$fila['ficha']."' and id=8";
	...
	$fila_adicionalg=mysqli_fetch_array($resultado_adicionalp);
...
$consulta="select valor from nomcampos_adic_personal where ficha='".$fila['ficha']."' and id=9";
	...
	$fila_adicionalp=mysqli_fetch_array($resultado_adicional);
...
$fila_cargo=mysqli_fetch_array($resultado_cargo);
