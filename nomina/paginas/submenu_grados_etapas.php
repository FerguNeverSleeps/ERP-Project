...
function abrir_grados(){
  location.href='grados_lista.php';
}

function abrir_etapas(){
  location.href='etapas_lista.php';
}

function abrir_grados_etapas(){
  location.href='grados_etapas_lista.php';
}
</script>
            ...
            <div class="portlet-body">
              <div class="row">
                ...
                <div class="col-md-2 text-center">
                  <a href="javascript:abrir_grados();">
                ...
                <div class="col-md-2 text-center">
                  <a href="javascript:abrir_etapas();">
                    <div class="tile bg-blue">
                      <div class="tile-body">
                      <i class="fa fa-child"></i>
                          <h5>Etapas</h5>                            
                ...
                <div class="col-md-2 text-center">
                  <a href="javascript:abrir_grados_etapas();">
                    <div class="tile bg-blue">
                      <div class="tile-body">
                      <i class="fa fa-child"></i>
                          <h5>Grados / Etapas</h5>                            
