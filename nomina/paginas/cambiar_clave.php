...
if (isset($_POST['nueva'] )){
    $result = mysqli_query($conectar, "SELECT * FROM ".SELECTRA_CONF_PYME.".nomusuarios  WHERE coduser ='".$_SESSION['coduser'] ."' and clave='".hash("sha256",$_POST['actual'])."'"); 
    ...
    if($row[0]['coduser'] == ""){
      ...
      $result = mysqli_query($conectar, "update ".SELECTRA_CONF_PYME.".nomusuarios set clave = '".hash("sha256",$_POST['nueva'])."' WHERE coduser ='".$_SESSION['coduser'] ."'");       
      $invalido = 0;
    }    
}
?>
