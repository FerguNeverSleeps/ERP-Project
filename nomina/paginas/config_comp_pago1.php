...
function desglose()
{
    AbrirVentana('../fpdf/reportes/recibos_lote_csbpdf1.php?nomina_id='+document.form1.cboTipoNomina.value+'&codt='+document.form1.codt.value,660,800,0);
				...
				<div class=" col-md-offset-2 col-md-8">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								Reporte Comprobantes de Pago Planilla 1
							</div>
							<div class="actions">
						...
						<div class="portlet-body">
							...
							<div class="row">
		                        ...
		                        <div class="col-md-1">
                                	<div  class="btn blue button-next" onClick="javascript:desglose()">Todos</div>
		                        </div>
		                        <div class="col-md-1">
...
$(document).ready(function()
{
	...
	$("#buscar").on('click',function(){
		...
		{
			var url = "../fpdf/reportes/recibos_lote_csbpdf1.php?nomina_id="+document.form1.cboTipoNomina.value+"&codt="+document.form1.codt.value+"&ficha_buscar="+ficha_buscar;
			window.open(url);
		}
		else
		{
