...
function filtrar_campo($campo){
	$coon=conectar(DB_HOST,$_SESSION['bd'],3306,DB_USUARIO,DB_CLAVE);

	$resultado = mysqli_real_escape_string($coon, $campo);	
	return $resultado;
}
...
{ 
	$s = @mysqli_connect($host,   $usuario,  $pwd, $nombrebd) 
...
function sql_ejecutar($sentencia)
{
	...
	$resultado = mysqli_query($coon, $sentencia)  or die($sentencia." ".mysqli_error($coon)); 
		
	desconectar ( $coon);
	return $resultado;
}

function sql_ejecutar_utf8($sentencia){
	$coon=conectar(DB_HOST,$_SESSION['bd'],3306,DB_USUARIO,DB_CLAVE);		
	
	mysqli_query($coon, "SET NAMES 'utf8'");
	mysqli_query($coon, "SET CHARACTER SET utf8 ");
	$resultado = mysqli_query($coon, $sentencia)  or die($sentencia." ".mysqli_error($coon)); 
...
function EXEFNSQL($sentencia,$par1='',$par2='',$par3='',$par4='',$par5='',$par6='',$par7='')
{
	...
	$resultado = mysqli_query($coon,"SELECT $sentencia"); 
...
<table width="743" align="center">
  <tbody>
    <tr>
      ...
      <td width="143" align="left"><strong>Fecha:</strong> <?php echo date("d/m/Y"); ?></td>
    </tr>
    <tr>
      <td width="600" colspan="0" rowspan="0" align="left" valign="middle">S.A.A.E.Z.</td>
      <td width="143" align="left"><strong>Pag N&#176;:</strong> <?php echo $pagina; ?></td>
    </tr>
    <tr>
      <td width="600" colspan="0" rowspan="0" align="left" valign="middle">OFICINA DE RECURSOS HUMANOS-Dpto. N&oacute;mina</td>
      <td width="143" align="left"><strong>Hora:</strong> <?php echo date("h:i:s A"); ?></td>
    </tr>
  </tbody>
</table>
<br>
...
<table align="center">
  <tbody>
    <tr>
      <td align="center"><u>Reporte&nbsp;de&nbsp;N&oacute;mina&nbsp;<?php echo $_SESSION['nomina']; ?></u></td>
    </tr>
    <tr>
      <td align="center"><h2><strong><u><?php echo $titulo; ?></u></strong></h2></td>
    </tr>
    <tr>
      <td align="center"><u>PERIODO PROCESADO - DESDE:<?php echo fecha($fila2['periodo_ini']); ?> HASTA: <?php echo fecha($fila2['periodo_fin']); ?></u></td>
    </tr>
  </tbody>
</table>
<?php }?>
...
<table align="center">
  <tbody>
      <tr>
      <td align="center"><h2><strong><u><?php echo $nombre?></u></strong></h2></td>
    </tr>
