...
//                                    exit;
                        ...
                        $objPHPExcel->getActiveSheet()->getStyle('A'.$pos.':F'.$i)->applyFromArray(allBordersThin());
                        $objPHPExcel->getActiveSheet()->getStyle('A'.$pos.':F'.$i)->getFont()->setSize(8);
                        $objPHPExcel->getActiveSheet()->getStyle('E'.$pos.':F'.$i)->getNumberFormat()
                                                                        ->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_ACCOUNTING);
                    }
                    ...
                    {      
                        ...
                        if($frecuencia==16)
                        {
                            ...
                            $objPHPExcel->getActiveSheet()->setCellValueExplicit("A$i", $fechapago, PHPExcel_Cell_DataType::TYPE_STRING);
                            $objPHPExcel->getActiveSheet()->setCellValueExplicit("B$i", $cuenta_contable, PHPExcel_Cell_DataType::TYPE_STRING);
                            $objPHPExcel->getActiveSheet()->setCellValueExplicit("C$i", $descripcion, PHPExcel_Cell_DataType::TYPE_STRING);
...
//                            $objPHPExcel->getActiveSheet()->setCellValue('F'.$i, $totalD);
	...
	$filename = "comprobante_contable_grupo1_".$NOMINA."_Del_".fecha($desde).'_Hasta_'.fecha($hasta);
