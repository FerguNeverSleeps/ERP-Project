        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td width="200" height="60" background="img_sis/sup_33.png" align="center">
                    <img src="../img_sis/logo.png" width="170" height="60" border="0" onClick="javascript:principal()" style="cursor : pointer;">
                </td>
                <td valign="top">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table border="0" align="right" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td><img src="../img_sis/asys.png" width="70" height="32"></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                        ...
                        <tr>
                                                ...
                                                <tr>
                                                  <td class="sup-ico-c2" width="20" height="22"><!--<img src="../imagenes/azul/sub_c2.png" width="20" height="22">--></td>
                                                    <td class="sup-help-text"><span style="font-size:10px;">Usuario:
                                                            ...
                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo "Empresa: " . ($_SESSION["nombre_empresa_nomina"]); ?>
                                                        </span></td>
                                                </tr>
                                            </table></td>
                            ...
                            <td class="" width="20" height="22"><!--&nbsp;<img src="imagenes/stock_about.png" width="22" height="22" align="absmiddle">--></td>
                                                    ...
                                                    <td class="sup-ico-exit" width="20" height="22" onClick="javascript:parent.location.href='../../selectraerp/modulos/principal/index.php?logout=off'"></td>
