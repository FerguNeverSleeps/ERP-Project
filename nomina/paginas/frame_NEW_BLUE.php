...
<link href="../../includes/../../includes/assets/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
...
<link href="../../includes/assets/css/style-metronic.css" rel="stylesheet" type="text/css">
<link href="../../includes/assets/css/style2.css" rel="stylesheet" type="text/css">
<link href="../../includes/assets/css/style-responsive.css" rel="stylesheet" type="text/css">
<link href="../../includes/assets/css/plugins.css" rel="stylesheet" type="text/css">
...
<div class="header navbar navbar-fixed-top mega-menu">
	...
	<div class="header-inner">
		<!-- BEGIN LOGO -->
		<a class="navbar-brand" href="frame.php">
            <img src="../img_sis/logo.png" width="200" height="52" alt="logo" class="img-responsive"/>
		</a>
		<!-- END LOGO -->
                    ...
                    //if($select->num_rows!=0){
                        ...
                        {   
                            while ($row_rs = $result->fetch_assoc()){
                                ...
                                ?>
                                    <li  class="classic-menu-dropdown <?php if($_GET['menu'] == $row_rs['cod_modulo']){echo "start active";}?>" >
                                        <a data-toggle="dropdown" data-hover="dropdown" data-close-others="true" href="">
											<?php echo utf8_encode($row_rs['nom_menu']); ?> <i class="fa fa-angle-down"></i>
										</a>
                                        <!--a href="javascript:;">
