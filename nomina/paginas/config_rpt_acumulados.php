...
function desglose()
{
	...
	else
	{
		...
		if(fecha_fin=='')
		{
			...
			AbrirVentana('../../reportes/pdf/pdf_salarios_acumulados_planilla.php?fecha_inicio='+document.form1.fecha_inicio.value+'&fecha_fin='+document.form1.fecha_fin.value+'&tipo_planilla='+document.form1.tipo_planilla.value,660,800,0);
