...
function fondo_cesantia_trimestral_xls()
{
	...
	if(num_trimestre==''){
		alert('Por favor, seleccione un trimestre');
            ...
            if(num_trimestre=='1')
            {
		location.href='rpt_fondo_cesantia_trimestre1_xls.php?codtip='+codtip;
                //location.href='fondo_cesantia_xls.php?num_semestre='+num_semestre;
            }
            if(num_trimestre=='2')
            {
		location.href='rpt_fondo_cesantia_trimestre2_xls.php?codtip='+codtip;
                //location.href='fondo_cesantia_xls.php?num_semestre='+num_semestre;
            }
            if(num_trimestre=='3')
            {
		location.href='rpt_fondo_cesantia_trimestre3_xls.php?codtip='+codtip;
                //location.href='fondo_cesantia_xls.php?num_semestre='+num_semestre;
            }
            if(num_trimestre=='4')
            {
		location.href='rpt_fondo_cesantia_trimestre4_xls.php?codtip='+codtip;
                //location.href='fondo_cesantia_xls.php?num_semestre='+num_semestre;
            }
	}
}
