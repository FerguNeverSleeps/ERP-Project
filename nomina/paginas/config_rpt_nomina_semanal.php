...
function horizontal_nomina_xls()
{
	...
	if(codnom==''){
		...
		location.href='horizontal_nomina_semanal.php?codnom='+codnom+'&codtip='+codtip; 
	}
}
</script>
...
<table width="520" border="0">
	<tr>
		<td width="467" height="40"  valign="middle" align="left"  style="padding-left: 40px">Planilla:
			...
			<?php
				echo $query="SELECT codnom, descrip, codtip 
				        FROM   nom_nominas_pago WHERE codtip='".$_SESSION['codigo_nomina']."' AND frecuencia in (16,17)";
