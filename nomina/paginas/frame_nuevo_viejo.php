...
<link href="../../includes/assets/css/themes/purple.css" rel="stylesheet" type="text/css">
...
<div class="header navbar navbar-fixed-top">
    ...
    <div class="header-inner">
        ...
        <a class="navbar-brand logo" href="frame.php">
            <img src="../../includes/assets/img/logo-menu.png" width="183" height="25" alt="logo" class="img-responsive"/>
        </a>
        <!-- END LOGO -->
        ...
        <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown user">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <img alt="" width="25" src="{$foto_usuario}">
                            <span class="username">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="../../selectraerp/modulos/principal/index.php?logout=off'">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
                ...
                <a class="navbar-brand" href="#">
                    <img src="../../includes/imagenes/{$logo_empresa}" width="183" height="35" alt="logo"/>
                </a>
                <br></br>
                <br></br>
