...
if($_POST['opcion']==1)
{
	if($_POST['editar']!=1)
	{
		$consulta="INSERT INTO nomgradospasos VALUES ('$_POST[grado]','$_POST[p1]','$_POST[p2]','$_POST[p3]','$_POST[p4]','$_POST[p5]','$_POST[p6]','$_POST[p7]','$_POST[p8]','$_POST[p9]','$_POST[p10]','$_POST[p11]','$_POST[p12]','$_POST[p13]','$_POST[p14]','$_POST[p15]'),'$_POST[ajuste]'),'$_POST[periodo]')";
		$resultado=query($consulta,$conexion);
	}
	else
	{
		$consulta="UPDATE nomgradospasos set grado='$_POST[grado]', p1='$_POST[p1]', p2='$_POST[p2]', p3='$_POST[p3]', p4='$_POST[p4]', p5='$_POST[p5]', p6='$_POST[p6]', p7='$_POST[p7]', p8='$_POST[p8]', p9='$_POST[p9]', p10='$_POST[p10]', p11='$_POST[p11]', p12='$_POST[p12]', p13='$_POST[p13]', p14='$_POST[p14]', p15='$_POST[p15]', ajuste='$_POST[ajuste]', periodo='$_POST[periodo]' WHERE grado='$_POST[gradoi]'";
		$resultado=query($consulta,$conexion);
	}
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Periodo:&nbsp;&nbsp;<input type="text" name="periodo" id="periodo" maxlength="8" size="8" value="<? echo $fetch['periodo']?>"/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
Ajuste:&nbsp;&nbsp;<input type="text" name="ajuste" id="ajuste" maxlength="7" size="7" value="<? echo $fetch['ajuste']?>"/>
</td>
</TR>
</table>
