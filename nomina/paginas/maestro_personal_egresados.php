...
<p>
    ...
    if ($op == 3) { //Se presiono el boton de Eliminar
        ...
        $strsql = "select COUNT(*) from nomvis_integrantes where descrip='" . $_SESSION['nomina'] . "' and  estado='Egresado'";
        $result = sql_ejecutar($strsql);
        $fila = fetch_array($result);
        $num_total_registros = $fila[0];

        $strsql = "select * from nomvis_integrantes where descrip='" . $_SESSION['nomina'] . "' and  estado='Egresado' order by ficha,apellidos,nombres,cedula LIMIT $TAMANO_PAGINA  OFFSET $limit";
        $result = sql_ejecutar($strsql);
            ...
            if ($i % 2 == 0) {
                ...
                <td>
                    <div align="left">
                        ...
                        <?php if(strlen($fila['foto'])>=7)
										{
										?>
										<img src="<?php echo $fila['foto']?>" width="100" align="absmiddle" height="100"/>
										<?php										
										}                        
                ...
                <td>
                        <div align="center">
                            <font size="2" face="Arial, Helvetica, sans-serif">
                            <a href="calendarios_personal.php?ano=<? echo date('Y') ?>&ficha=<? echo $fila['ficha'] ?>">
                                <img src="img_sis/ico_reloj.gif" title="Editar" width="16" height="16" border="0" align="absmiddle">
                            </a>
                            <label></label>
                            </font>
                        </div>
            ...
            <td width="61%"><font size="2" face="Arial, Helvetica, sans-serif"><span class="Estilo1">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <?php } else { ?>
                                <td><a href="maestro_personal_egresados.php?pagina=1&criterio=<?php $criterio; ?>&bandera=<?php echo $bandera; ?>"><img src="images/first.gif" title="Primera" width="16" height="16" border="0"></a></td>
                            <?php } ?>
                            <!--previous page button-->
                            <?php if ($PrevStart == $inicio) { ?>
                                <td><img src="images/prevdisab.gif" title="Anterior" width="16" height="16" border="0"></td>
                            <?php } else { ?>
                                <td><a href="maestro_personal_egresados.php?pagina=<?php echo $pagina - 1; ?>&criterio=<?php $criterio; ?>&bandera=<?php echo $bandera; ?>"><img src="images/prev.gif" title="Anterior" width="16" height="16" border="0"></a></td>
                            <?php } ?>
                            <!--current page number-->
                            ...
                            <?php } else { ?>
                                <td><a href="maestro_personal_egresados.php?pagina=<?php echo $pagina + 1; ?>&criterio=<?php $criterio; ?>&bandera=<?php echo $bandera; ?>"><img src="images/next.gif" title="Siguiente" width="16" height="16" border="0"></a></td>
                            <?php } ?>
                            <!--last page button-->
                            <?php if ($NextStart == $inicio) { ?>
                                <td><img src="images/lastdisab.gif" title="Ultima" width="16" height="16" border="0"></td>
                            <?php } else { ?>
                                <td><a href="maestro_personal_egresados.php?pagina=<?php echo $LastStart; ?>&criterio=<?php $criterio; ?>&bandera=<?php echo $bandera; ?>"><img src="images/last.gif" title="Ultima" width="16" height="16" border="0"></a></td>
                            <?php } ?>
