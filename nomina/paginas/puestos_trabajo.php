...
{ 
  $query="DELETE FROM nompuestos WHERE codigo='{$registro_id}'"; 
    
  $result=sql_ejecutar($query);
  activar_pagina("puestos_trabajo.php");   
}   

$sql = "SELECT codigo, descripcion FROM nompuestos";
...
function enviar(op,id)
{
  if (op==2)
  {   
    document.frmPrincipal.action="ag_puestos.php?id="+id;
        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue">
            <div class="portlet-title">
              ...
              <div class="actions">
                <a class="btn btn-sm blue"  onclick="javascript: window.location='ag_puestos.php'">
