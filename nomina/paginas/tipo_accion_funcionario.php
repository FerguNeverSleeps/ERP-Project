...
$sql = "SELECT * FROM accion_funcionario_tipo";
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								Tipo Acción Funcionario
							</div>
							<div class="actions">
								<a class="btn btn-sm blue"  onclick="javascript: window.location='tipo_accion_funcionario_add.php'">
						...
						<div class="portlet-body">
							...
							<?php
								...
								?>
									<tr class="odd gradeX">
										<td><?php echo $fila['id_accion_funcionario_tipo']; ?></td>
                                                                                <td><?php echo utf8_encode($fila['nombre_accion']); ?></td>
                                                                                <td><?php echo $fila['correlativo']; ?></td>
                                                                                <td><?php echo $fila['id_expediente_tipo']; ?></td>
										<td style="text-align: center">
									      <a href="tipo_accion_funcionario_add.php?edit&id=<?php echo $fila['id_accion_funcionario_tipo']; ?>" title="Editar">
									      <img src="../../includes/imagenes/icons/pencil.png" width="16" height="16"></a>
										</td>
										<td style="text-align: center">
										      <a href="javascript:enviar(<?php echo(3); ?>,<?php echo($fila['id_accion_funcionario_tipo']); ?>);" title="Eliminar">
