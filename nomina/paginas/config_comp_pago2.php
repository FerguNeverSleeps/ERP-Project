...
function desglose()
{
    AbrirVentana('../fpdf/reportes/recibos_lote_csbpdf2.php?nomina_id='+document.form1.cboTipoNomina.value+'&codt='+document.form1.codt.value,660,800,0);
				...
				<div class=" col-md-offset-2 col-md-8">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								Reporte Comprobantes de Pago Planilla 2
							</div>
							<div class="actions">
						...
						<div class="portlet-body">
							<div class="row"><br>
		                        <div class="col-md-3 text-right">Planilla 2
		                        </div>   
