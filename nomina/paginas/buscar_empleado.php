...
$numpag  = isset($_GET['numpag'])        ? $_GET['numpag']        : '';
...
function aceptar(ficha, codnom, codt, pag)
{
  opener.document.location.href = "movimientos_nomina_liquidaciones.php?codigo_nomina=" + codnom + "&codt=" + codt + 
                                  "&pagina=" + 1 + "&ficha=" + ficha;
  cerrarVentana();
}
        ...
        <div class="col-md-12">
          <div class="portlet box blue">
            <div class="portlet-title">
              ...
              <div class="actions">
                <a class="btn btn-sm blue"  onclick="javascript: cerrarVentana();">
              ...
              <form method="post" name="frmPrincipal" id="frmPrincipal">
                  ...
                  <table class="table table-striped table-bordered table-hover" id="table_datatable">
                    ...
                    <?php
                      ...
                      {
                        ?>
                        <tr class="odd gradeX cursor-pointer" onclick="aceptar('<?php echo($fila['ficha']); ?>', '<?php echo $codnomm; ?>', '<?php echo $codigo_nomina; ?>', '<?php echo $numpag; ?>');">
