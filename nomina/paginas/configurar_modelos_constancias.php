...
{ 
  $query = "DELETE FROM nomtipos_constancia WHERE codigo=$codigo_id";     
  $result= sql_ejecutar($query);
  activar_pagina("configurar_modelos_constancias.php");     
}
  
$strsql = "SELECT * FROM nomtipos_constancia ORDER BY codigo";
...
{  
  if(opcion=='2')
  {
    document.frmPrincipal.codigo_id.value=id;  
    document.frmPrincipal.action="ed_modelo_constancia.php";
        ...
        <div class="col-md-12">
          ...
          <div class="portlet box blue">
            <div class="portlet-title">
              ...
              <div class="actions">
                <a class="btn btn-sm blue"  onclick="javascript: window.location='ag_modelo_constancia.php'">
                  <i class="fa fa-plus"></i>
                  Agregar
                </a>
                <a class="btn btn-sm blue"  onclick="javascript: window.location='submenu_constancias.php'">
            ...
            <div class="portlet-body">
              ...
              ?>
                  ...
                  <input type="hidden" id="codigo_id" name="codigo_id" value=""> 
              </form>
            </div>
          </div>
