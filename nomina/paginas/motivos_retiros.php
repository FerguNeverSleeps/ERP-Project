...
{ 
  $query  = "DELETE FROM nom_motivos_retiros WHERE codigo=$registro_id"; 
  $result = sql_ejecutar($query);
  activar_pagina('motivos_retiros.php');     
}     
$strsql = "SELECT * FROM nom_motivos_retiros ORDER BY codigo, descripcion";
...
function enviar(op,id){
  ...
  if (op==1){   // Opcion de Agregar
    ...
    document.frmPrincipal.action="ag_motivos_retiros.php";
          ...
          <div class="portlet box blue">
            ...
            <div class="portlet-body">
                ...
                ?>
                  <tr class="odd gradeX">
                    ...
                    <td style="text-align: center">
                        <a href="javascript:enviar(<?php echo(2); ?>,<?php echo($fila['codigo']); ?>);" title="Editar"><img src="../../includes/imagenes/icons/pencil.png" alt="Editar" width="16" height="16"></a>
                    </td>
                    <td style="text-align: center">
              ...
              ?>
                  ...
                  <input name="nombre_tabla" type="hidden" value="nom_motivos_retiros">
