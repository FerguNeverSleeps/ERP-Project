...
// require_once($_SERVER['DOCUMENT_ROOT'].'/selectra_planilla/generalp.config.inc.php');
   ...
   class MySQL
   {
      ...
      function ingresar_profesion($codorg,$descrip)
      {
         $sql = "insert into nomprofesiones (codorg,descrip) values ('".$codorg."','".$descrip."')";
      ...
      {
          $sql = "insert into ".$_SESSION['db']." (".$registros[0].") values (".$registros[1].")";
//echo $sql;         
...
//echo $sql;      
        ...
        function editar_profesion($codorg,$descrip)//Modifica un registro
      {
               $sql = "UPDATE nomprofesiones set 
                        descrip='".$descrip."' 
                         where codorg='".$codorg."'";//echo $sql;     
