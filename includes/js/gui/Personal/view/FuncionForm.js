...
Ext.define('Personal.view.FuncionForm', {
    //extend: 'Ext.container.Viewport',
    extend: 'Ext.container.Container',
    plugins: 'viewport',
    //controller: 'viewport',
    requires: [
        'Personal.view.FuncionFormController',
        'Personal.model.Funcion',
        'Ext.form.Panel'
    ],    
    controller: 'funcionform',
    style: 'padding:25px',
    layout: 'fit',
    xtype: 'funcion-form',
    items: [
                ...
                afterrender:function(thisComp,opts){
                    if(EDITAR_CONCUE == 1){
                        ...
                        form.load({
                            ...
                            params:{
                                output:'xml',
                                accion:"Accion/Maestro/Get_Funcion",
                                id:ACTUAL
                            },
            ...
            buttons: [
                { 
                    ...
                    handler: function() {
                        //'
                        //var form = ;
                        var form = Ext.getCmp("form-funcion").getForm();
                        if (form.isValid()) {
                            form.submit({
                                url: '../../includes/clases/controladores/ControladorApp.php',
                                ...
                                params:{
                                    accion:"Accion/Maestro/Save_Funcion",
                                    op:OPERACION
                                },
                                reset: true,
                                ...
                                success: function(form_instance, action){
                                    document.location.href = "maestro_funcion_form.php"+RELOAD_URL_ADD;
                                }
                            });
                        }
                        else{
                ...
                { 
                    text: 'Cancelar',
                    handler: function() {
                        document.location.href = "maestro_funcion.php";
                    } 
                }
            ]
       }
