...
date_default_timezone_set('America/Panama');
	...
	$templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor('plantillas/contrato_de_trabajo_administrativo.docx');
	...
	$filename = 'Contrato de Trabajo administartivo'.$ficha.'.docx';
