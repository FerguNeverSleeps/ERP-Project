...
//calculando la edad
	...
	$templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor('plantillas/contrato_de_trabajo_jefe_de_unidad.docx');
...
$templateProcessor->setValue('familiares', htmlspecialchars($familiares));
	$filename = 'Contrato de Trabajo jefe de unidad'.$ficha.'.docx';
