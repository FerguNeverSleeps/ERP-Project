...
<<<<<<< HEAD
	$sql = "SELECT a.apenom, a.cedula as ced_trabajador,a.sexo,a.sueldopro,a.estado_civil, a.seguro_social, a.lugarnac, a.fecnac,a.direccion,
=======
	$sql = "SELECT a.apenom, a.ficha,a.cedula as ced_trabajador,a.sexo,a.sueldopro,a.estado_civil, a.seguro_social, a.lugarnac, a.fecnac,
>>>>>>> d261ee5902086e29d251f772fce5c3a35b00a6a1
	 a.suesal,a.num_decreto,a.fecha_decreto,a.condicion,a.nomposicion_id, a.tipo_empleado, a.codcargo,
	 b.des_car,d.nombre AS provincia,a.inicio_periodo as ini,a.fin_periodo as fin
...
>>>>>>> d261ee5902086e29d251f772fce5c3a35b00a6a1
	...
	$templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor('plantillas/contrato_jefe_de_unidad_pjv.docx');
  ...
  $templateProcessor->setValue('familiares', htmlspecialchars($familiares));

	$filename = 'Contrato jefe de unidad pjv'.$ficha.'.docx';
