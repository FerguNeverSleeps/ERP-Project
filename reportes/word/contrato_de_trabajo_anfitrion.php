...
date_default_timezone_set('America/Panama');
	...
	$templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor('plantillas/contrato_de_trabajo_anfitrion.docx');
	...
	$filename = 'Contrato de Trabajo anfitrion'.$ficha.'.docx';
