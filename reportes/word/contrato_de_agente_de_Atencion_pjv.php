...
date_default_timezone_set('America/Panama');
	...
	$sql = "SELECT a.apenom, a.cedula as ced_trabajador,a.sexo,a.sueldopro,a.estado_civil, a.seguro_social, a.lugarnac, a.fecnac,
	 ...
	 b.des_car,d.nombre AS provincia,e.descrip as donde,a.direccion
...
$nombre_conyugue   = $familiaconyuge->nombre_conyugue;
	...
	$templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor('plantillas/contrato_de_agente_de_Atencion_pjv.docx');
...
$templateProcessor->setValue('familiares', utf8_decode($familiares));
	$filename = 'Contrato de agente de atencion pjv'.$ficha.'.docx';
