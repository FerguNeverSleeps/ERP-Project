...
date_default_timezone_set('America/Panama');
	...
	$sql = "SELECT a.apenom, a.cedula as ced_trabajador,a.sexo,a.sueldopro,a.estado_civil, a.seguro_social, a.lugarnac, a.fecnac,
	 ...
	 b.des_car,d.nombre AS provincia,a.direccion
...
//calculando la edad
	...
	$nombre_conyugue   = $familiac->nombre_conyugue;
	$apellido_conyugue   = $familiac->apellido_conyugue;
	$parentesco_conyugue   = $familiac->parentesco_conyugue;
	/*if (empty($parentesco_conyugue)) {
		$nombre_conyugue="N/A";
		$apellido_conyugue="N/A";
	}*/
	...
	$templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor('plantillas/contrato_de_trabajo_administrativo_pjv.docx');
 ...
 $templateProcessor->setValue('familiares', utf8_decode($familiares));
	$filename = 'Contrato de Trabajo trabajo administrativo pjv'.$ficha.'.docx';
