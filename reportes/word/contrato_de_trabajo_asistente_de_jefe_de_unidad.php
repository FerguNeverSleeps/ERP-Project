...
date_default_timezone_set('America/Panama');
	...
	$sql = "SELECT a.apenom, a.cedula as ced_trabajador,a.sexo,a.sueldopro,a.estado_civil, a.seguro_social, a.lugarnac, a.fecnac,
	 ...
	 b.des_car,d.nombre AS provincia
	...
	$templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor('plantillas/contrato_de_trabajo_asistente_de_jefe_de_unidad.docx');
	...
	$filename = 'Contrato de Trabajo asistente de jefe de unidad'.$ficha.'.docx';
