...
date_default_timezone_set('America/Panama');
	...
	$templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor('plantillas/contrato_de_trabajo_asesor_de_ventas.docx');
	...
	$filename = 'Contrato de Trabajo asesor de ventas'.$ficha.'.docx';
