...
where a.cedula is not null and a.codpar in (3) and a.vive=1 and b.estado <> 'Egresado' and b.sexo='Masculino'
group by b.ficha
...
while($row = fetch_array($result1)){
    ...
    $objPHPExcel->getActiveSheet()->SetCellValue('A'.$rowCount, utf8_decode($row['descrip']));
...
header('Content-Disposition: attachment;filename="listado_dia_padres.xlsx"');
