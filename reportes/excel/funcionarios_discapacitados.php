...
$objPHPExcel->getActiveSheet()->SetCellValue('B4', "SERVIDORES CON DISCAPACIDAD - FECHA: ".date('d-m-Y'));
...
$objPHPExcel->getActiveSheet()->setTitle('Funcionarios con Discapacidad');

header('Content-Type: application/vnd.openxmlformats-   officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment;filename="funcionarios_discapacitados.xlsx"');
