...
//--------------------------------------------------------------
//titulo de la tabla
$objPHPExcel->getActiveSheet()->SetCellValue('B1', " Acumulados por tipo de concepto");
...
while($row = mysqli_fetch_array($result))
{
    ...
    $objPHPExcel->getActiveSheet()->SetCellValue('B'.$rowCount, $row['cod_tac']);
...
$objPHPExcel->getActiveSheet()->setTitle('Lista de Acumulados por Tipo');
// clean the output buffer
ob_clean();
header('Content-Type: application/vnd.openxmlformats-   officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment;filename="lista_acumulados_tipo.xlsx"');
