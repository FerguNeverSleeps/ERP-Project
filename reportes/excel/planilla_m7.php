...
$objPHPExcel = PHPExcel_IOFactory::load("plantillas/planilla_m7.xlsx");
//------------------------------------------------------------
...
header('Content-Disposition: attachment;filename="resumen_planilla.xlsx"');
