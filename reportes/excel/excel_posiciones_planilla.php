...
//------------------------------------------------------------
$sql2 = "SELECT * FROM nomposicion WHERE SUBSTRING(`partida`,19,3)='{$_POST['tip']}' ORDER BY nomposicion_id ASC";
...
header('Content-Disposition: attachment;filename="lista_posiciones_planilla.xlsx"');
