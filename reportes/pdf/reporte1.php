...
$fecha_con                          	= ( isset($_GET['fecha_con']) )            ? $_GET['fecha_con']      : '' ;
...
$MiPDF->Multicell(210,5,'Decreto Numero '.$num_decreto.' de '.$anio,0,$alineacion='C',$fondo=false,$salto_de_linea=0,$x='0',$y='20',$reseth=true,$ajuste_horizontal=0,$ishtml=false,$autopadding=true,$maxh=20,$alineacion_vertical='T', $fitcell=false);
...
$MiPDF->Multicell(120,25,'',0,$alineacion='C',$fondo=false,$salto_de_linea=1,$x='0',$y='',$reseth=true,$ajuste_horizontal=0,$ishtml=false,$autopadding=true,$maxh=50,$alineacion_vertical='T', $fitcell=false);
$MiPDF->SetFont('times','B', 12);
$MiPDF->Multicell(90,5,$ministro,0,$alineacion='C',$fondo=false,$salto_de_linea=1,$x='',$y='',$reseth=true,$ajuste_horizontal=0,$ishtml=false,$autopadding=true,$maxh=50,$alineacion_vertical='T', $fitcell=false);
$MiPDF->SetFont('times','', 12);
$MiPDF->Multicell(90,5,'Ministro de Salud',0,$alineacion='C',$fondo=false,$salto_de_linea=1,$x='',$y='',$reseth=true,$ajuste_horizontal=0,$ishtml=false,$autopadding=true,$maxh=50,$alineacion_vertical='T', $fitcell=false);
