...
{   
    public function Header() 
    {
        ...
        $this->Multicell(210,10,'REPÚBLICA DE PANAMÁ',$border=0,$align='C',$fill=0,$ln=1,$x='0',$y='',$reseth=true,$stretch=0,$ishtml=false,$autopadding=true,$maxh=10,$valign='M',$fitcell=false);
        $this->Multicell(210,10,strtoupper($empresa),$border=0,$align='C',$fill=0,$ln=1,$x='0',$y='',$reseth=true,$stretch=0,$ishtml=false,$autopadding=true,$maxh=10,$valign='M',$fitcell=false); 
         $this->Multicell(210,10,'REGISTRO Y CONTROL',$border=0,$align='C',$fill=0,$ln=1,$x='0',$y='',$reseth=true,$stretch=0,$ishtml=false,$autopadding=true,$maxh=10,$valign='M',$fitcell=false); 
         $this->Multicell(210,20,'EXPEDIENTE DE FUNCIONARIO',$border=0,$align='C',$fill=0,$ln=1,$x='0',$y='',$reseth=true,$stretch=0,$ishtml=false,$autopadding=true,$maxh=10,$valign='M',$fitcell=false);
