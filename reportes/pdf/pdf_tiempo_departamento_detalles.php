...
$MiPDF->AddPage('L');
    ...
    $MiPDF->Multicell(205,5,'TIEMPO POR DEPARTAMENTO DETALLADO',0,$alineacion='C',$fondo=false,$salto_de_linea=0,$x='40',$y='20',$reseth=true,$ajuste_horizontal=0,$ishtml=false,$autopadding=true,$maxh=20,$alineacion_vertical='T', $fitcell=false);
    ...
    $MiPDF->Cell(190,8,"Posicion", $border='LTRB', $ln, $align='C', $fill,$link,$stretch,$ignore_min_height,$calign,$valign);
    $MiPDF->Cell(135,8,"Nombre del Empleados", $border='TRB', 1, $align='C', $fill,$link,$stretch,$ignore_min_height,$calign,$valign);
    $i=0;
    
    while ($data = fetch_array($res))
    {
        $MiPDF->Cell(190,8,$data['personal_id'], $border='LRB', $ln, $align='C', $fill,$link,$stretch,$ignore_min_height,$calign,$valign);
        $MiPDF->Cell(135,8,$data['apenom'], $border='RB', 1, $align='C', $fill,$link,$stretch,$ignore_min_height,$calign,$valign);
        $i=$i+1;
    }
    ...
    $MiPDF->Output('tiempo_departamento_detalles.pdf','I');
?>