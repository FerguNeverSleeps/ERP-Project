...
{   
    public function Header() 
    {
        ...
        $this->Multicell(210,5,'',$border=0,$align='C',$fill=0,$ln=1,$x='0',$y='',$reseth=true,$stretch=0,$ishtml=false,$autopadding=true,$maxh=5,$valign='M',$fitcell=false);
...
$MiPDF->SetAuthor('Hiram Loreto');
# el método SetTitle nos permite incluir un título
$MiPDF->SetTitle('Datos Personales');
...
$MiPDF->Image($foto1, $x=50, $y=8, $w=25,   $h=25, $type='', $link='', $align='C', $resize=false, $dpi=300, $palign='', $ismask=false, $imgmask=false, $border=0, $fitbox=false, $hidden=false, $fitonpage=false);
        $image_file = "/var/www/html/migracion_rrhh/nomina/imagenes/migracion.jpg";

//imágenes primera línea
$MiPDF->Image($image_file, $x=13, $y=8, $w=25,   $h=25, $type='', $link='', $align='C', $resize=false, $dpi=300, $palign='', $ismask=false, $imgmask=false, $border=0, $fitbox=false, $hidden=false, $fitonpage=false);

//CABECERA PRIMER RENGLON
$MiPDF->SetFont('times', 'B', 12);

$MiPDF->Multicell(185,10,'DATOS PERSONALES',0,$alineacion='L',$fondo=true,$salto_de_linea=1,$x='15',$y='35',$reseth=true,$ajuste_horizontal=0,$ishtml=false,$autopadding=true,$maxh=10,$alineacion_vertical='M', $fitcell=false);
...
//$MiPDF->Multicell(65,10,$foto,0,$alineacion='L',$fondo=false,$salto_de_linea=0,$x='120',$y='',$reseth=true,$ajuste_horizontal=0,$ishtml=false,$autopadding=true,$maxh=20,$alineacion_vertical='T', $fitcell=false);
...
$MiPDF->Multicell(65,10,$second_n,0,$alineacion='L',$fondo=false,$salto_de_linea=1,$x='120',$y='',$reseth=true,$ajuste_horizontal=0,$ishtml=false,$autopadding=true,$maxh=20,$alineacion_vertical='T', $fitcell=false);
//Segunda Línea
...
$MiPDF->Multicell(45,10,'Genero:',0,$alineacion='L',$fondo=false,$salto_de_linea=0,$x='100',$y='',$reseth=true,$ajuste_horizontal=0,$ishtml=false,$autopadding=true,$maxh=20,$alineacion_vertical='T', $fitcell=false);

$MiPDF->Multicell(65,10,$sexo,0,$alineacion='L',$fondo=false,$salto_de_linea=1,$x='145',$y='',$reseth=true,$ajuste_horizontal=0,$ishtml=false,$autopadding=true,$maxh=20,$alineacion_vertical='T', $fitcell=false);
...
$MiPDF->Multicell(160,10,$nomposicion_id,0,$alineacion='L',$fondo=false,$salto_de_linea=0,$x='55',$y='',$reseth=true,$ajuste_horizontal=0,$ishtml=false,$autopadding=true,$maxh=20,$alineacion_vertical='T', $fitcell=false);

$MiPDF->Multicell(40,10,'Departamento:',0,$alineacion='L',$fondo=false,$salto_de_linea=0,$x='100',$y='',$reseth=true,$ajuste_horizontal=0,$ishtml=false,$autopadding=true,$maxh=20,$alineacion_vertical='T', $fitcell=false);

$MiPDF->Multicell(160,10,$departamento,0,$alineacion='L',$fondo=false,$salto_de_linea=1,$x='130',$y='',$reseth=true,$ajuste_horizontal=0,$ishtml=false,$autopadding=true,$maxh=20,$alineacion_vertical='T', $fitcell=false);

$MiPDF->Multicell(45,10,'Cargo:',0,$alineacion='L',$fondo=false,$salto_de_linea=0,$x='15',$y='',$reseth=true,$ajuste_horizontal=0,$ishtml=false,$autopadding=true,$maxh=20,$alineacion_vertical='T', $fitcell=false);

$MiPDF->Multicell(65,10,$cargo,0,$alineacion='L',$fondo=false,$salto_de_linea=1,$x='55',$y='',$reseth=true,$ajuste_horizontal=0,$ishtml=false,$autopadding=true,$maxh=10,$alineacion_vertical='T', $fitcell=false);
...
if($res15->num_rows>0) 
{
    while ($sus = $res15->fetch_object())
    {
        ...
        $inisus            = $sus->fecha_inicio;
        $finsus            = $sus->fecha_fin;
...
$MiPDF->Multicell(160,10,'',0,$alineacion='L',$fondo=false,$salto_de_linea=1,$x='55',$y='',$reseth=true,$ajuste_horizontal=0,$ishtml=false,$autopadding=true,$maxh=20,$alineacion_vertical='T', $fitcell=false);
ob_end_clean();
$nombre_archivo = 'datos_personal_'.$cedula.'.pdf';
$MiPDF->Output($nombre_archivo,'I');
?>