...
$sql_emp = "SELECT * FROM `caa_registros` WHERE `ficha` ='$ficha' ORDER BY fecha DESC";
...
// ---------------------------------------------------------
$pdf->Cell(50, 6, 'Fecha', 1, 0, 'C', 0, '', 0);
$pdf->Cell(45, 6, 'Hora', 1, 0, 'C', 0, '', 0);
$pdf->Cell(45, 6, 'Tipo de Registro', 1, 0, 'C', 0, '', 0);
$pdf->Cell(45, 6, 'Dispositivo', 1, 1, 'C', 0, '', 0);

while ($empleados = mysqli_fetch_array($res_emp)) {

    $pdf->Cell(50, 6, fecha($empleados['fecha']), 1, 0, 'C', 0, '', 0);
    $pdf->Cell(45, 6, $empleados['hora'], 1, 0, 'C', 0, '', 0);
    $pdf->Cell(45, 6, $empleados['tipo_registro'], 1, 0, 'C', 0, '', 0);
    $pdf->Cell(45, 6, $empleados['dispositivo'], 1, 1, 'C', 0, '', 0);
