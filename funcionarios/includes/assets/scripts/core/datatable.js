            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    ...
                    "oLanguage": {  // language settings
                        "sProcessing": '<img src="../../../includes/assets/img/loading-spinner-grey.gif"/><span>&nbsp;&nbsp;Cargando...</span>',
                        "sLengthMenu": "<span class='seperator'>|</span>Ver _MENU_ registros",//"<span class='seperator'>|</span>View _MENU_ records",
                        "sInfo":"<span class='seperator'>|</span>Encontrados total _TOTAL_ registros",// "<span class='seperator'>|</span>Found total _TOTAL_ records",
                        "sInfoEmpty": "No hay registros para mostrar",//No records found to show",
                        "sGroupActions": "_TOTAL_ records selected:  ",
                        "sAjaxRequestGeneralError": "No se pudo completar la solicitud",//"Could not complete request. Please check your internet connection",
                        "sEmptyTable":  "No hay datos disponibles",//"No data available in table",
                        "sZeroRecords": "No se encontraron datos",//"No matching records found",
                        "oPaginate": {
                            "sPrevious": "Anterior",//"Prev",
