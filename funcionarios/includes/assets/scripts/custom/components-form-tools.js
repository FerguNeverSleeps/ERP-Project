var ComponentsFormTools = function () {
    ...
    var handleTwitterTypeahead = function() {
        ...
        var custom = new Bloodhound({
          ...
          remote:"../../../includes/clases/controladores/ControladorApp.php?accion=Accion/Item/Get_Referencias_Rebajas&db_connect="+DB_CONNECT+"&query=%QUERY"
        });
            ...
            suggestion: Handlebars.compile([
              '<div class="media">',
                    ...
                    '<div class="media-body">',
                        '<h4 class="media-heading">{{cod_item}}-{{referencia}}</h4>',
                        //'<p>{{desc}}</p>',
                    '</div>',
              '</div>',
            ].join(''))
