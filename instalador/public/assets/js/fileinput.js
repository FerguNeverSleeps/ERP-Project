...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgSizeTooLarge: 'Archivo "{name}" (<b>{size} KB</b>) excede tamaño maximo permitido<b>{maxSize} KB</b>.',
        msgFilesTooLess: 'Debe seleccionar al menos <b>{n}</b> {files} para subir.',
        msgFilesTooMany: 'Number of files selected for upload <b>({n})</b> exceeds maximum allowed limit of <b>{m}</b>.',
        msgFileNotFound: 'Archivo "{name}" no se encuentra!',
